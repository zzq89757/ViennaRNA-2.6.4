...
case $2 in
  --help)           /usr/bin/gengetopt --show-help --set-version=2.6.4 < $1.ggo | grep -v "in doubt" | grep -v "Comments should be sent";;
  --version)        echo 2.6.4;;
  --detailed-help)  /usr/bin/gengetopt --show-detailed-help --set-version=2.6.4 < $1.ggo | grep -v "in doubt" | grep -v "Comments should be sent";;
esac
