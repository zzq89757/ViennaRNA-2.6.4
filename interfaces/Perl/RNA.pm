...
*salt_loop = *RNAc::salt_loop;
*salt_loop_int = *RNAc::salt_loop_int;
*salt_stack = *RNAc::salt_stack;
*salt_ml = *RNAc::salt_ml;
*salt_duplex_init = *RNAc::salt_duplex_init;
...
*aln_consensus_sequence = *RNAc::aln_consensus_sequence;
*aln_consensus_mis = *RNAc::aln_consensus_mis;
*my_aln_consensus_sequence2 = *RNAc::my_aln_consensus_sequence2;
...
*sc_mod_read_from_jsonfile = *RNAc::sc_mod_read_from_jsonfile;
*sc_mod_read_from_json = *RNAc::sc_mod_read_from_json;
*sc_mod_parameters_free = *RNAc::sc_mod_parameters_free;
...
*file_RNAstrand_db_read_record = *RNAc::file_RNAstrand_db_read_record;
*file_connect_read_record = *RNAc::file_connect_read_record;
...
*type = *RNAc::varArrayUChar_type;
*size = *RNAc::varArrayUChar_size;
*__len__ = *RNAc::varArrayUChar___len__;
*get = *RNAc::varArrayUChar_get;
...
*type = *RNAc::varArrayChar_type;
*size = *RNAc::varArrayChar_size;
*__len__ = *RNAc::varArrayChar___len__;
*get = *RNAc::varArrayChar_get;
...
*type = *RNAc::varArrayShort_type;
*size = *RNAc::varArrayShort_size;
*__len__ = *RNAc::varArrayShort___len__;
*get = *RNAc::varArrayShort_get;
...
*type = *RNAc::varArrayUInt_type;
*size = *RNAc::varArrayUInt_size;
*__len__ = *RNAc::varArrayUInt___len__;
*get = *RNAc::varArrayUInt_get;
...
*type = *RNAc::varArrayInt_type;
*size = *RNAc::varArrayInt_size;
*__len__ = *RNAc::varArrayInt___len__;
*get = *RNAc::varArrayInt_get;
...
*type = *RNAc::varArrayFLTorDBL_type;
*size = *RNAc::varArrayFLTorDBL_size;
*__len__ = *RNAc::varArrayFLTorDBL___len__;
*get = *RNAc::varArrayFLTorDBL_get;
...
############# Class : RNA::varArrayMove ##############

package RNA::varArrayMove;
use vars qw(@ISA %OWNER %ITERATORS %BLESSEDMEMBERS);
@ISA = qw( RNA );
%OWNER = ();
%ITERATORS = ();
sub new {
    my $pkg = shift;
    my $self = RNAc::new_varArrayMove(@_);
    bless $self, $pkg if defined($self);
}
...
sub DESTROY {
    ...
    delete $ITERATORS{$self};
    if (exists $OWNER{$self}) {
        RNAc::delete_varArrayMove($self);
        delete $OWNER{$self};
    }
}

*type = *RNAc::varArrayMove_type;
*size = *RNAc::varArrayMove_size;
*__len__ = *RNAc::varArrayMove___len__;
*get = *RNAc::varArrayMove_get;
*__getitem__ = *RNAc::varArrayMove___getitem__;
*__setitem__ = *RNAc::varArrayMove___setitem__;
sub DISOWN {
    my $self = shift;
    my $ptr = tied(%$self);
    delete $OWNER{$ptr};
...
*swig_SaltStack_get = *RNAc::param_SaltStack_get;
*swig_SaltStack_set = *RNAc::param_SaltStack_set;
*swig_SaltLoop_get = *RNAc::param_SaltLoop_get;
*swig_SaltLoop_set = *RNAc::param_SaltLoop_set;
*swig_SaltLoopDbl_get = *RNAc::param_SaltLoopDbl_get;
*swig_SaltLoopDbl_set = *RNAc::param_SaltLoopDbl_set;
*swig_SaltMLbase_get = *RNAc::param_SaltMLbase_get;
*swig_SaltMLbase_set = *RNAc::param_SaltMLbase_set;
*swig_SaltMLintern_get = *RNAc::param_SaltMLintern_get;
*swig_SaltMLintern_set = *RNAc::param_SaltMLintern_set;
*swig_SaltMLclosing_get = *RNAc::param_SaltMLclosing_get;
*swig_SaltMLclosing_set = *RNAc::param_SaltMLclosing_set;
*swig_SaltDPXInit_get = *RNAc::param_SaltDPXInit_get;
*swig_SaltDPXInit_set = *RNAc::param_SaltDPXInit_set;
sub new {
    my $pkg = shift;
...
*swig_expSaltStack_get = *RNAc::exp_param_expSaltStack_get;
*swig_expSaltStack_set = *RNAc::exp_param_expSaltStack_set;
*swig_expSaltLoop_get = *RNAc::exp_param_expSaltLoop_get;
*swig_expSaltLoop_set = *RNAc::exp_param_expSaltLoop_set;
*swig_SaltLoopDbl_get = *RNAc::exp_param_SaltLoopDbl_get;
*swig_SaltLoopDbl_set = *RNAc::exp_param_SaltLoopDbl_set;
*swig_SaltMLbase_get = *RNAc::exp_param_SaltMLbase_get;
*swig_SaltMLbase_set = *RNAc::exp_param_SaltMLbase_set;
*swig_SaltMLintern_get = *RNAc::exp_param_SaltMLintern_get;
*swig_SaltMLintern_set = *RNAc::exp_param_SaltMLintern_set;
*swig_SaltMLclosing_get = *RNAc::exp_param_SaltMLclosing_get;
*swig_SaltMLclosing_set = *RNAc::exp_param_SaltMLclosing_set;
*swig_SaltDPXInit_get = *RNAc::exp_param_SaltDPXInit_get;
*swig_SaltDPXInit_set = *RNAc::exp_param_SaltDPXInit_set;
sub new {
    my $pkg = shift;
...
*swig_salt_get = *RNAc::md_salt_get;
*swig_salt_set = *RNAc::md_salt_set;
*swig_saltMLLower_get = *RNAc::md_saltMLLower_get;
*swig_saltMLLower_set = *RNAc::md_saltMLLower_set;
*swig_saltMLUpper_get = *RNAc::md_saltMLUpper_get;
*swig_saltMLUpper_set = *RNAc::md_saltMLUpper_set;
*swig_saltDPXInit_get = *RNAc::md_saltDPXInit_get;
*swig_saltDPXInit_set = *RNAc::md_saltDPXInit_set;
*swig_saltDPXInitFact_get = *RNAc::md_saltDPXInitFact_get;
*swig_saltDPXInitFact_set = *RNAc::md_saltDPXInitFact_set;
*swig_helical_rise_get = *RNAc::md_helical_rise_get;
*swig_helical_rise_set = *RNAc::md_helical_rise_set;
*swig_backbone_length_get = *RNAc::md_backbone_length_get;
*swig_backbone_length_set = *RNAc::md_backbone_length_set;
sub new {
    my $pkg = shift;
...
############# Class : RNA::sc_mod_param ##############

package RNA::sc_mod_param;
use vars qw(@ISA %OWNER %ITERATORS %BLESSEDMEMBERS);
@ISA = qw( RNA );
%OWNER = ();
%ITERATORS = ();
sub new {
    my $pkg = shift;
    my $self = RNAc::new_sc_mod_param(@_);
    bless $self, $pkg if defined($self);
}
...
*sc_mod_json = *RNAc::fold_compound_sc_mod_json;
*sc_mod_jsonfile = *RNAc::fold_compound_sc_mod_jsonfile;
*sc_mod = *RNAc::fold_compound_sc_mod;
*sc_mod_m6A = *RNAc::fold_compound_sc_mod_m6A;
*sc_mod_pseudouridine = *RNAc::fold_compound_sc_mod_pseudouridine;
*sc_mod_inosine = *RNAc::fold_compound_sc_mod_inosine;
*sc_mod_7DA = *RNAc::fold_compound_sc_mod_7DA;
*sc_mod_purine = *RNAc::fold_compound_sc_mod_purine;
*sc_mod_dihydrouridine = *RNAc::fold_compound_sc_mod_dihydrouridine;
...
sub MODEL_DEFAULT_TEMPERATURE () { $RNAc::MODEL_DEFAULT_TEMPERATURE }
sub MODEL_DEFAULT_PF_SCALE () { $RNAc::MODEL_DEFAULT_PF_SCALE }
sub MODEL_DEFAULT_BETA_SCALE () { $RNAc::MODEL_DEFAULT_BETA_SCALE }
sub MODEL_DEFAULT_DANGLES () { $RNAc::MODEL_DEFAULT_DANGLES }
sub MODEL_DEFAULT_SPECIAL_HP () { $RNAc::MODEL_DEFAULT_SPECIAL_HP }
sub MODEL_DEFAULT_NO_LP () { $RNAc::MODEL_DEFAULT_NO_LP }
sub MODEL_DEFAULT_NO_GU () { $RNAc::MODEL_DEFAULT_NO_GU }
sub MODEL_DEFAULT_NO_GU_CLOSURE () { $RNAc::MODEL_DEFAULT_NO_GU_CLOSURE }
sub MODEL_DEFAULT_CIRC () { $RNAc::MODEL_DEFAULT_CIRC }
sub MODEL_DEFAULT_GQUAD () { $RNAc::MODEL_DEFAULT_GQUAD }
sub MODEL_DEFAULT_UNIQ_ML () { $RNAc::MODEL_DEFAULT_UNIQ_ML }
sub MODEL_DEFAULT_ENERGY_SET () { $RNAc::MODEL_DEFAULT_ENERGY_SET }
sub MODEL_DEFAULT_BACKTRACK () { $RNAc::MODEL_DEFAULT_BACKTRACK }
sub MODEL_DEFAULT_BACKTRACK_TYPE () { $RNAc::MODEL_DEFAULT_BACKTRACK_TYPE }
sub MODEL_DEFAULT_COMPUTE_BPP () { $RNAc::MODEL_DEFAULT_COMPUTE_BPP }
sub MODEL_DEFAULT_MAX_BP_SPAN () { $RNAc::MODEL_DEFAULT_MAX_BP_SPAN }
sub MODEL_DEFAULT_WINDOW_SIZE () { $RNAc::MODEL_DEFAULT_WINDOW_SIZE }
sub MODEL_DEFAULT_LOG_ML () { $RNAc::MODEL_DEFAULT_LOG_ML }
sub MODEL_DEFAULT_ALI_OLD_EN () { $RNAc::MODEL_DEFAULT_ALI_OLD_EN }
sub MODEL_DEFAULT_ALI_RIBO () { $RNAc::MODEL_DEFAULT_ALI_RIBO }
sub MODEL_DEFAULT_ALI_CV_FACT () { $RNAc::MODEL_DEFAULT_ALI_CV_FACT }
sub MODEL_DEFAULT_ALI_NC_FACT () { $RNAc::MODEL_DEFAULT_ALI_NC_FACT }
sub MODEL_DEFAULT_PF_SMOOTH () { $RNAc::MODEL_DEFAULT_PF_SMOOTH }
sub MODEL_DEFAULT_SALT () { $RNAc::MODEL_DEFAULT_SALT }
sub MODEL_DEFAULT_SALT_MLLOWER () { $RNAc::MODEL_DEFAULT_SALT_MLLOWER }
sub MODEL_DEFAULT_SALT_MLUPPER () { $RNAc::MODEL_DEFAULT_SALT_MLUPPER }
sub MODEL_DEFAULT_SALT_DPXINIT () { $RNAc::MODEL_DEFAULT_SALT_DPXINIT }
sub MODEL_DEFAULT_SALT_DPXINIT_FACT () { $RNAc::MODEL_DEFAULT_SALT_DPXINIT_FACT }
sub MODEL_DEFAULT_HELICAL_RISE () { $RNAc::MODEL_DEFAULT_HELICAL_RISE }
sub MODEL_DEFAULT_BACKBONE_LENGTH () { $RNAc::MODEL_DEFAULT_BACKBONE_LENGTH }
sub MODEL_SALT_DPXINIT_FACT_RNA () { $RNAc::MODEL_SALT_DPXINIT_FACT_RNA }
sub MODEL_SALT_DPXINIT_FACT_DNA () { $RNAc::MODEL_SALT_DPXINIT_FACT_DNA }
sub MODEL_HELICAL_RISE_RNA () { $RNAc::MODEL_HELICAL_RISE_RNA }
sub MODEL_HELICAL_RISE_DNA () { $RNAc::MODEL_HELICAL_RISE_DNA }
sub MODEL_BACKBONE_LENGTH_RNA () { $RNAc::MODEL_BACKBONE_LENGTH_RNA }
sub MODEL_BACKBONE_LENGTH_DNA () { $RNAc::MODEL_BACKBONE_LENGTH_DNA }
...
sub SC_MOD_CHECK_FALLBACK () { $RNAc::SC_MOD_CHECK_FALLBACK }
sub SC_MOD_CHECK_UNMOD () { $RNAc::SC_MOD_CHECK_UNMOD }
sub SC_MOD_SILENT () { $RNAc::SC_MOD_SILENT }
sub SC_MOD_DEFAULT () { $RNAc::SC_MOD_DEFAULT }
...
*sfact = *RNAc::sfact;
*salt = *RNAc::salt;
*saltDPXInit = *RNAc::saltDPXInit;
*saltDPXInitFact = *RNAc::saltDPXInitFact;
...
*parameter_set_dna_mathews1999 = *RNAc::parameter_set_dna_mathews1999;
*parameter_set_dna_mathews2004 = *RNAc::parameter_set_dna_mathews2004;
*parameter_set_rna_andronescu2007 = *RNAc::parameter_set_rna_andronescu2007;
*parameter_set_rna_langdon2018 = *RNAc::parameter_set_rna_langdon2018;
*parameter_set_rna_misc_special_hairpins = *RNAc::parameter_set_rna_misc_special_hairpins;
*parameter_set_rna_turner1999 = *RNAc::parameter_set_rna_turner1999;
*parameter_set_rna_turner2004 = *RNAc::parameter_set_rna_turner2004;
*parameter_set_rna_mod_7DA_parameters = *RNAc::parameter_set_rna_mod_7DA_parameters;
*parameter_set_rna_mod_inosine_parameters = *RNAc::parameter_set_rna_mod_inosine_parameters;
*parameter_set_rna_mod_m6A_parameters = *RNAc::parameter_set_rna_mod_m6A_parameters;
*parameter_set_rna_mod_pseudouridine_parameters = *RNAc::parameter_set_rna_mod_pseudouridine_parameters;
*parameter_set_rna_mod_purine_parameters = *RNAc::parameter_set_rna_mod_purine_parameters;
*parameter_set_rna_mod_dihydrouridine_parameters = *RNAc::parameter_set_rna_mod_dihydrouridine_parameters;
