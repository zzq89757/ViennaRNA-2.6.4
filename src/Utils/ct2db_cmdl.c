/*
  ...
  gengetopt -i ct2db.ggo --file-name=ct2db_cmdl --unamed-opts --include-getopt --default-optional --func-name=ct2db_cmdline_parser --arg-struct-name=ct2db_args_info
...
const char *ct2db_args_info_purpose = "Produce dot bracket notation of an RNA secondary structure from Zuker's .ct\nfile";

const char *ct2db_args_info_usage = "Usage: ct2db [OPTIONS] [<input0.ct>] [<input1.ct>]...";

const char *ct2db_args_info_versiontext = "";

const char *ct2db_args_info_description = "This program converts connectivity table (.ct) files into extended FASTA format\nwith dot-bracket string.\n";

const char *ct2db_args_info_help[] = {
  "  -h, --help         Print help and exit",
  "  -V, --version      Print version and exit",
  "  -p, --no-pk        Remove pseudoknots from structure\n\n                         (default=off)",
  "  -m, --no-modified  Do not keep modified bases, i.e. replace all non-canonical\n                       nucleotides with N.\n\n                         (default=off)",
...
typedef enum {ARG_NO
  , ARG_FLAG
} ct2db_cmdline_parser_arg_type;

static
void clear_given (struct ct2db_args_info *args_info);
static
void clear_args (struct ct2db_args_info *args_info);

static int
ct2db_cmdline_parser_internal (int argc, char **argv, struct ct2db_args_info *args_info,
                        struct ct2db_cmdline_parser_params *params, const char *additional_error);
...
void clear_args (struct ct2db_args_info *args_info)
{
  ...
  args_info->no_modified_flag = 0;
  args_info->verbose_flag = 0;
  
}

static
void init_args_info(struct ct2db_args_info *args_info)
{


  args_info->help_help = ct2db_args_info_help[0] ;
  args_info->version_help = ct2db_args_info_help[1] ;
  args_info->no_pk_help = ct2db_args_info_help[2] ;
  args_info->no_modified_help = ct2db_args_info_help[3] ;
  args_info->verbose_help = ct2db_args_info_help[4] ;
  
}

void
ct2db_cmdline_parser_print_version (void)
{
  printf ("%s %s\n",
     (strlen(CT2DB_CMDLINE_PARSER_PACKAGE_NAME) ? CT2DB_CMDLINE_PARSER_PACKAGE_NAME : CT2DB_CMDLINE_PARSER_PACKAGE),
     CT2DB_CMDLINE_PARSER_VERSION);

  if (strlen(ct2db_args_info_versiontext) > 0)
    printf("\n%s\n", ct2db_args_info_versiontext);
}

static void print_help_common(void)
{
	size_t len_purpose = strlen(ct2db_args_info_purpose);
	size_t len_usage = strlen(ct2db_args_info_usage);

	if (len_usage > 0) {
		printf("%s\n", ct2db_args_info_usage);
	}
	if (len_purpose > 0) {
		printf("%s\n", ct2db_args_info_purpose);
	}
	...
	if (strlen(ct2db_args_info_description) > 0) {
		printf("%s\n\n", ct2db_args_info_description);
	}
}

void
ct2db_cmdline_parser_print_help (void)
{
  int i = 0;
  print_help_common();
  while (ct2db_args_info_help[i])
    printf("%s\n", ct2db_args_info_help[i++]);
}

void
ct2db_cmdline_parser_init (struct ct2db_args_info *args_info)
{
...
void
ct2db_cmdline_parser_params_init(struct ct2db_cmdline_parser_params *params)
{
  if (params)
    { 
      params->override = 0;
...
ct2db_cmdline_parser_params_create(void)
{
  struct ct2db_cmdline_parser_params *params = 
    (struct ct2db_cmdline_parser_params *)malloc(sizeof(struct ct2db_cmdline_parser_params));
  ct2db_cmdline_parser_params_init(params);  
  return params;
}
...
static void
ct2db_cmdline_parser_release (struct ct2db_args_info *args_info)
{
  unsigned int i;
...
int
ct2db_cmdline_parser_dump(FILE *outfile, struct ct2db_args_info *args_info)
{
  int i = 0;

  if (!outfile)
    {
      fprintf (stderr, "%s: cannot dump options to stream\n", CT2DB_CMDLINE_PARSER_PACKAGE);
      return EXIT_FAILURE;
    }
  ...
  if (args_info->no_modified_given)
    write_into_file(outfile, "no-modified", 0, 0 );
...
int
ct2db_cmdline_parser_file_save(const char *filename, struct ct2db_args_info *args_info)
{
  FILE *outfile;
  int i = 0;
  ...
  if (!outfile)
    {
      fprintf (stderr, "%s: cannot open file for writing: %s\n", CT2DB_CMDLINE_PARSER_PACKAGE, filename);
      return EXIT_FAILURE;
    }

  i = ct2db_cmdline_parser_dump(outfile, args_info);
  fclose (outfile);
...
void
ct2db_cmdline_parser_free (struct ct2db_args_info *args_info)
{
  ct2db_cmdline_parser_release (args_info);
}
...
int
ct2db_cmdline_parser (int argc, char **argv, struct ct2db_args_info *args_info)
{
  return ct2db_cmdline_parser2 (argc, argv, args_info, 0, 1, 1);
}

int
ct2db_cmdline_parser_ext (int argc, char **argv, struct ct2db_args_info *args_info,
                   struct ct2db_cmdline_parser_params *params)
{
  int result;
  result = ct2db_cmdline_parser_internal (argc, argv, args_info, params, 0);
...
int
ct2db_cmdline_parser2 (int argc, char **argv, struct ct2db_args_info *args_info, int override, int initialize, int check_required)
{
  int result;
  struct ct2db_cmdline_parser_params params;
...
int
ct2db_cmdline_parser_required (struct ct2db_args_info *args_info, const char *prog_name)
{
  FIX_UNUSED (args_info);
 ...
 * @param check_ambiguity @see ct2db_cmdline_parser_params.check_ambiguity
 * @param override @see ct2db_cmdline_parser_params.override
...
int update_arg(void *field, char **orig_field,
               ...
               ct2db_cmdline_parser_arg_type arg_type,
...
int
ct2db_cmdline_parser_internal (
  int argc, char **argv, struct ct2db_args_info *args_info,
                        struct ct2db_cmdline_parser_params *params, const char *additional_error)
{
  int c;	/* Character of the parsed option.  */

  int error_occurred = 0;
  struct ct2db_args_info local_args_info;
  ...
  if (initialize)
    ct2db_cmdline_parser_init (args_info);

  ct2db_cmdline_parser_init (&local_args_info);
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "hVpmv", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'h':	/* Print help and exit.  */
          ct2db_cmdline_parser_print_help ();
          ct2db_cmdline_parser_free (&local_args_info);
          exit (EXIT_SUCCESS);

        case 'V':	/* Print version and exit.  */
          ct2db_cmdline_parser_print_version ();
          ct2db_cmdline_parser_free (&local_args_info);
          exit (EXIT_SUCCESS);

        case 'p':	/* Remove pseudoknots from structure
...
.  */
          ...
          if (update_arg((void *)&(args_info->no_pk_flag), 0, &(args_info->no_pk_given),
              ...
              check_ambiguity, override, 1, 0, "no-pk", 'p',
              additional_error))
            goto failure;
        
          break;
        case 'm':	/* Do not keep modified bases, i.e. replace all non-canonical nucleotides with N.
        
.  */
        
        
          if (update_arg((void *)&(args_info->no_modified_flag), 0, &(args_info->no_modified_given),
              &(local_args_info.no_modified_given), optarg, 0, 0, ARG_FLAG,
              check_ambiguity, override, 1, 0, "no-modified", 'm',
              additional_error))
            goto failure;
...
.  */
        ...
        default:	/* bug: option not considered.  */
          fprintf (stderr, "%s: option unknown: %c%s\n", CT2DB_CMDLINE_PARSER_PACKAGE, c, (additional_error ? additional_error : ""));
          abort ();
        } /* switch */
    } /* while */
  ...
  ct2db_cmdline_parser_release (&local_args_info);
