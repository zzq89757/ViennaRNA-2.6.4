...
.  */
 ...
 help description.  */
  int span_arg;	/**< @brief Set the maximum distance between any two pairing nucleotides.
 (default='150').  */
  char * span_orig;	/**< @brief Set the maximum distance between any two pairing nucleotides.
 original value given at command line.  */
  const char *span_help; /**< @brief Set the maximum distance between any two pairing nucleotides.
 help description.  */
  double zscore_arg;	/**< @brief Limit the output to predictions with a Z-score below a threshold.
 (default='-2').  */
  char * zscore_orig;	/**< @brief Limit the output to predictions with a Z-score below a threshold.
 original value given at command line.  */
  const char *zscore_help; /**< @brief Limit the output to predictions with a Z-score below a threshold.
 help description.  */
  int zscore_pre_filter_flag;	/**< @brief Apply the z-score filtering in the forward recursions.
 (default=off).  */
  const char *zscore_pre_filter_help; /**< @brief Apply the z-score filtering in the forward recursions.
 help description.  */
  int zscore_report_subsumed_flag;	/**< @brief Report subsumed structures if their z-score is less than that of the enclosing structure.
 (default=off).  */
  const char *zscore_report_subsumed_help; /**< @brief Report subsumed structures if their z-score is less than that of the enclosing structure.
 help description.  */
  int backtrack_global_flag;	/**< @brief Backtrack a global MFE structure.
 (default=off).  */
  const char *backtrack_global_help; /**< @brief Backtrack a global MFE structure.
 help description.  */
...
.  */
 ...
 help description.  */
  ...
  unsigned int zscore_pre_filter_given ;	/**< @brief Whether zscore-pre-filter was given.  */
  unsigned int zscore_report_subsumed_given ;	/**< @brief Whether zscore-report-subsumed was given.  */
  unsigned int backtrack_global_given ;	/**< @brief Whether backtrack-global was given.  */
