/*
  ...
  /usr/bin/gengetopt -i RNApdist.ggo --file-name=RNApdist_cmdl --include-getopt --default-optional --func-name=RNApdist_cmdline_parser --arg-struct-name=RNApdist_args_info
...
const char *RNApdist_args_info_purpose = "Calculate distances between thermodynamic RNA secondary structures ensembles";

const char *RNApdist_args_info_usage = "Usage: RNApdist [OPTION]...";

const char *RNApdist_args_info_versiontext = "";

const char *RNApdist_args_info_description = "This program reads RNA sequences from stdin and calculates structure distances\nbetween the thermodynamic ensembles of their secondary structures.\n";

const char *RNApdist_args_info_detailed_help[] = {
...
{
  RNApdist_args_info_full_help[0] = RNApdist_args_info_detailed_help[0];
  RNApdist_args_info_full_help[1] = RNApdist_args_info_detailed_help[1];
  RNApdist_args_info_full_help[2] = RNApdist_args_info_detailed_help[2];
  RNApdist_args_info_full_help[3] = RNApdist_args_info_detailed_help[3];
  RNApdist_args_info_full_help[4] = RNApdist_args_info_detailed_help[4];
  RNApdist_args_info_full_help[5] = RNApdist_args_info_detailed_help[5];
  RNApdist_args_info_full_help[6] = RNApdist_args_info_detailed_help[6];
  RNApdist_args_info_full_help[7] = RNApdist_args_info_detailed_help[7];
  RNApdist_args_info_full_help[8] = RNApdist_args_info_detailed_help[8];
  RNApdist_args_info_full_help[9] = RNApdist_args_info_detailed_help[9];
  RNApdist_args_info_full_help[10] = RNApdist_args_info_detailed_help[11];
  RNApdist_args_info_full_help[11] = RNApdist_args_info_detailed_help[13];
  RNApdist_args_info_full_help[12] = RNApdist_args_info_detailed_help[14];
  RNApdist_args_info_full_help[13] = RNApdist_args_info_detailed_help[15];
  RNApdist_args_info_full_help[14] = RNApdist_args_info_detailed_help[16];
  RNApdist_args_info_full_help[15] = RNApdist_args_info_detailed_help[18];
  RNApdist_args_info_full_help[16] = RNApdist_args_info_detailed_help[20];
  RNApdist_args_info_full_help[17] = RNApdist_args_info_detailed_help[21];
  RNApdist_args_info_full_help[18] = RNApdist_args_info_detailed_help[22];
  RNApdist_args_info_full_help[19] = RNApdist_args_info_detailed_help[23];
  RNApdist_args_info_full_help[20] = RNApdist_args_info_detailed_help[24];
  RNApdist_args_info_full_help[21] = RNApdist_args_info_detailed_help[26];
  RNApdist_args_info_full_help[22] = RNApdist_args_info_detailed_help[27];
  RNApdist_args_info_full_help[23] = RNApdist_args_info_detailed_help[28];
  RNApdist_args_info_full_help[24] = RNApdist_args_info_detailed_help[30];
  RNApdist_args_info_full_help[25] = RNApdist_args_info_detailed_help[32];
  RNApdist_args_info_full_help[26] = RNApdist_args_info_detailed_help[34];
  RNApdist_args_info_full_help[27] = RNApdist_args_info_detailed_help[36];
  RNApdist_args_info_full_help[28] = 0; 
  
}

const char *RNApdist_args_info_full_help[29];

static void
init_help_array(void)
{
  RNApdist_args_info_help[0] = RNApdist_args_info_detailed_help[0];
  RNApdist_args_info_help[1] = RNApdist_args_info_detailed_help[1];
  RNApdist_args_info_help[2] = RNApdist_args_info_detailed_help[2];
  RNApdist_args_info_help[3] = RNApdist_args_info_detailed_help[3];
  RNApdist_args_info_help[4] = RNApdist_args_info_detailed_help[4];
  RNApdist_args_info_help[5] = RNApdist_args_info_detailed_help[5];
  RNApdist_args_info_help[6] = RNApdist_args_info_detailed_help[6];
  RNApdist_args_info_help[7] = RNApdist_args_info_detailed_help[7];
  RNApdist_args_info_help[8] = RNApdist_args_info_detailed_help[8];
  RNApdist_args_info_help[9] = RNApdist_args_info_detailed_help[9];
  RNApdist_args_info_help[10] = RNApdist_args_info_detailed_help[11];
  RNApdist_args_info_help[11] = RNApdist_args_info_detailed_help[13];
  RNApdist_args_info_help[12] = RNApdist_args_info_detailed_help[14];
  RNApdist_args_info_help[13] = RNApdist_args_info_detailed_help[15];
  RNApdist_args_info_help[14] = RNApdist_args_info_detailed_help[16];
  RNApdist_args_info_help[15] = RNApdist_args_info_detailed_help[20];
  RNApdist_args_info_help[16] = RNApdist_args_info_detailed_help[21];
  RNApdist_args_info_help[17] = RNApdist_args_info_detailed_help[22];
  RNApdist_args_info_help[18] = RNApdist_args_info_detailed_help[23];
  RNApdist_args_info_help[19] = RNApdist_args_info_detailed_help[24];
  RNApdist_args_info_help[20] = RNApdist_args_info_detailed_help[36];
  RNApdist_args_info_help[21] = 0; 
  
}

const char *RNApdist_args_info_help[22];
...
typedef enum {ARG_NO
  ...
  , ARG_FLOAT
  , ARG_DOUBLE
} RNApdist_cmdline_parser_arg_type;

static
void clear_given (struct RNApdist_args_info *args_info);
static
void clear_args (struct RNApdist_args_info *args_info);

static int
RNApdist_cmdline_parser_internal (int argc, char **argv, struct RNApdist_args_info *args_info,
                        struct RNApdist_cmdline_parser_params *params, const char *additional_error);


const char *RNApdist_cmdline_parser_dangles_values[] = {"0", "2", 0}; /*< Possible values for dangles. */
...
void clear_given (struct RNApdist_args_info *args_info)
{
  ...
  args_info->compare_given = 0 ;
  args_info->backtrack_given = 0 ;
...
void clear_args (struct RNApdist_args_info *args_info)
{
  ...
  args_info->compare_arg = gengetopt_strdup ("p");
  args_info->compare_orig = NULL;
  args_info->backtrack_arg = gengetopt_strdup ("none");
  args_info->backtrack_orig = NULL;
...
static
void init_args_info(struct RNApdist_args_info *args_info)
{
  init_full_help_array(); 
  init_help_array(); 
  args_info->help_help = RNApdist_args_info_detailed_help[0] ;
  args_info->detailed_help_help = RNApdist_args_info_detailed_help[1] ;
  args_info->full_help_help = RNApdist_args_info_detailed_help[2] ;
  args_info->version_help = RNApdist_args_info_detailed_help[3] ;
  args_info->noconv_help = RNApdist_args_info_detailed_help[6] ;
  args_info->compare_help = RNApdist_args_info_detailed_help[9] ;
  args_info->backtrack_help = RNApdist_args_info_detailed_help[11] ;
  args_info->temp_help = RNApdist_args_info_detailed_help[15] ;
  args_info->paramFile_help = RNApdist_args_info_detailed_help[16] ;
  args_info->noTetra_help = RNApdist_args_info_detailed_help[18] ;
  args_info->salt_help = RNApdist_args_info_detailed_help[20] ;
  args_info->dangles_help = RNApdist_args_info_detailed_help[23] ;
  args_info->noLP_help = RNApdist_args_info_detailed_help[24] ;
  args_info->noGU_help = RNApdist_args_info_detailed_help[26] ;
  args_info->noClosingGU_help = RNApdist_args_info_detailed_help[27] ;
  args_info->nsp_help = RNApdist_args_info_detailed_help[28] ;
  args_info->energyModel_help = RNApdist_args_info_detailed_help[30] ;
  args_info->helical_rise_help = RNApdist_args_info_detailed_help[32] ;
  args_info->backbone_length_help = RNApdist_args_info_detailed_help[34] ;
  
}

void
RNApdist_cmdline_parser_print_version (void)
{
  printf ("%s %s\n",
     (strlen(RNAPDIST_CMDLINE_PARSER_PACKAGE_NAME) ? RNAPDIST_CMDLINE_PARSER_PACKAGE_NAME : RNAPDIST_CMDLINE_PARSER_PACKAGE),
     RNAPDIST_CMDLINE_PARSER_VERSION);

  if (strlen(RNApdist_args_info_versiontext) > 0)
    printf("\n%s\n", RNApdist_args_info_versiontext);
}

static void print_help_common(void)
{
	size_t len_purpose = strlen(RNApdist_args_info_purpose);
	size_t len_usage = strlen(RNApdist_args_info_usage);
	...
	if (strlen(RNApdist_args_info_description) > 0) {
		printf("%s\n\n", RNApdist_args_info_description);
	}
}

void
RNApdist_cmdline_parser_print_help (void)
{
  int i = 0;
  print_help_common();
  while (RNApdist_args_info_help[i])
    printf("%s\n", RNApdist_args_info_help[i++]);
}

void
RNApdist_cmdline_parser_print_full_help (void)
{
  int i = 0;
  print_help_common();
  while (RNApdist_args_info_full_help[i])
    printf("%s\n", RNApdist_args_info_full_help[i++]);
}

void
RNApdist_cmdline_parser_print_detailed_help (void)
{
  int i = 0;
  print_help_common();
  while (RNApdist_args_info_detailed_help[i])
    printf("%s\n", RNApdist_args_info_detailed_help[i++]);
}

void
RNApdist_cmdline_parser_init (struct RNApdist_args_info *args_info)
{
...
void
RNApdist_cmdline_parser_params_init(struct RNApdist_cmdline_parser_params *params)
{
  if (params)
    { 
      params->override = 0;
...
struct RNApdist_cmdline_parser_params *
RNApdist_cmdline_parser_params_create(void)
{
  struct RNApdist_cmdline_parser_params *params = 
    (struct RNApdist_cmdline_parser_params *)malloc(sizeof(struct RNApdist_cmdline_parser_params));
  RNApdist_cmdline_parser_params_init(params);  
  return params;
}
...
static void
RNApdist_cmdline_parser_release (struct RNApdist_args_info *args_info)
{

  free_string_field (&(args_info->compare_arg));
  free_string_field (&(args_info->compare_orig));
  free_string_field (&(args_info->backtrack_arg));
  free_string_field (&(args_info->backtrack_orig));
...
int
RNApdist_cmdline_parser_dump(FILE *outfile, struct RNApdist_args_info *args_info)
{
  int i = 0;
  ...
  if (args_info->compare_given)
    write_into_file(outfile, "compare", args_info->compare_orig, 0);
  if (args_info->backtrack_given)
    write_into_file(outfile, "backtrack", args_info->backtrack_orig, 0);
  ...
  if (args_info->dangles_given)
    write_into_file(outfile, "dangles", args_info->dangles_orig, RNApdist_cmdline_parser_dangles_values);
...
int
RNApdist_cmdline_parser_file_save(const char *filename, struct RNApdist_args_info *args_info)
{
  FILE *outfile;
  int i = 0;
  ...
  i = RNApdist_cmdline_parser_dump(outfile, args_info);
  fclose (outfile);
...
void
RNApdist_cmdline_parser_free (struct RNApdist_args_info *args_info)
{
  RNApdist_cmdline_parser_release (args_info);
}
...
int
RNApdist_cmdline_parser (int argc, char **argv, struct RNApdist_args_info *args_info)
{
  return RNApdist_cmdline_parser2 (argc, argv, args_info, 0, 1, 1);
}

int
RNApdist_cmdline_parser_ext (int argc, char **argv, struct RNApdist_args_info *args_info,
                   struct RNApdist_cmdline_parser_params *params)
{
  int result;
  result = RNApdist_cmdline_parser_internal (argc, argv, args_info, params, 0);
...
int
RNApdist_cmdline_parser2 (int argc, char **argv, struct RNApdist_args_info *args_info, int override, int initialize, int check_required)
{
  int result;
  struct RNApdist_cmdline_parser_params params;
...
int
RNApdist_cmdline_parser_required (struct RNApdist_args_info *args_info, const char *prog_name)
{
  FIX_UNUSED (args_info);
 ...
 * @param check_ambiguity @see RNApdist_cmdline_parser_params.check_ambiguity
 * @param override @see RNApdist_cmdline_parser_params.override
...
int update_arg(void *field, char **orig_field,
               ...
               RNApdist_cmdline_parser_arg_type arg_type,
...
int
RNApdist_cmdline_parser_internal (
  int argc, char **argv, struct RNApdist_args_info *args_info,
                        struct RNApdist_cmdline_parser_params *params, const char *additional_error)
{
  int c;	/* Character of the parsed option.  */

  int error_occurred = 0;
  struct RNApdist_args_info local_args_info;
  ...
  if (initialize)
    RNApdist_cmdline_parser_init (args_info);

  RNApdist_cmdline_parser_init (&local_args_info);
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "hVX:B::T:P:4d:e:", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'h':	/* Print help and exit.  */
          ...
          RNApdist_cmdline_parser_free (&local_args_info);
          exit (EXIT_SUCCESS);

        case 'V':	/* Print version and exit.  */
          RNApdist_cmdline_parser_print_version ();
          RNApdist_cmdline_parser_free (&local_args_info);
          exit (EXIT_SUCCESS);

        case 'X':	/* Specify the comparison directive.
.  */
        
        
          if (update_arg( (void *)&(args_info->compare_arg), 
               &(args_info->compare_orig), &(args_info->compare_given),
              &(local_args_info.compare_given), optarg, 0, "p", ARG_STRING,
          ...
          break;
        case 'B':	/* Print an \"alignment\" with gaps of the profiles. The aligned structures are written to <filename>, if specified.
.  */
        
        
          if (update_arg( (void *)&(args_info->backtrack_arg), 
               &(args_info->backtrack_orig), &(args_info->backtrack_given),
              &(local_args_info.backtrack_given), optarg, 0, "none", ARG_STRING,
              check_ambiguity, override, 0, 0,
              "backtrack", 'B',
              additional_error))
            goto failure;
...
.  */
          ...
          break;
        case 'd':	/* set energy model for treatment of dangling bases.
...
.  */
          ...
          if (update_arg( (void *)&(args_info->dangles_arg), 
              ...
              &(local_args_info.dangles_given), optarg, RNApdist_cmdline_parser_dangles_values, "2", ARG_INT,
              check_ambiguity, override, 0, 0,
              "dangles", 'd',
              additional_error))
            goto failure;
...
.  */
        ...
        case 0:	/* Long option with no short option */
          if (strcmp (long_options[option_index].name, "detailed-help") == 0) {
            RNApdist_cmdline_parser_print_detailed_help ();
            RNApdist_cmdline_parser_free (&local_args_info);
            exit (EXIT_SUCCESS);
          }

          if (strcmp (long_options[option_index].name, "full-help") == 0) {
            RNApdist_cmdline_parser_print_full_help ();
            RNApdist_cmdline_parser_free (&local_args_info);
            exit (EXIT_SUCCESS);
          }
...
.  */
  ...
  RNApdist_cmdline_parser_release (&local_args_info);
