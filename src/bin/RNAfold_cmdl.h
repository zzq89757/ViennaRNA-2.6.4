...
.  */
 ...
 help description.  */
  char * motif_arg;	/**< @brief Specify stabilizing energy of a ligand binding to a particular sequence/structure motif.
.  */
  char * motif_orig;	/**< @brief Specify stabilizing energy of a ligand binding to a particular sequence/structure motif.
 original value given at command line.  */
  const char *motif_help; /**< @brief Specify stabilizing energy of a ligand binding to a particular sequence/structure motif.
 help description.  */
