...
init_full_help_array(void)
{
  ...
  RNAcofold_args_info_full_help[11] = RNAcofold_args_info_detailed_help[14];
  RNAcofold_args_info_full_help[12] = RNAcofold_args_info_detailed_help[16];
  ...
  RNAcofold_args_info_full_help[23] = RNAcofold_args_info_detailed_help[35];
  RNAcofold_args_info_full_help[24] = RNAcofold_args_info_detailed_help[37];
  RNAcofold_args_info_full_help[25] = RNAcofold_args_info_detailed_help[39];
  RNAcofold_args_info_full_help[26] = RNAcofold_args_info_detailed_help[41];
  RNAcofold_args_info_full_help[27] = RNAcofold_args_info_detailed_help[43];
  RNAcofold_args_info_full_help[28] = RNAcofold_args_info_detailed_help[45];
  RNAcofold_args_info_full_help[29] = RNAcofold_args_info_detailed_help[47];
  RNAcofold_args_info_full_help[30] = RNAcofold_args_info_detailed_help[49];
  RNAcofold_args_info_full_help[31] = RNAcofold_args_info_detailed_help[51];
  RNAcofold_args_info_full_help[32] = RNAcofold_args_info_detailed_help[52];
  RNAcofold_args_info_full_help[33] = RNAcofold_args_info_detailed_help[53];
  RNAcofold_args_info_full_help[34] = RNAcofold_args_info_detailed_help[54];
  RNAcofold_args_info_full_help[35] = RNAcofold_args_info_detailed_help[55];
  RNAcofold_args_info_full_help[36] = RNAcofold_args_info_detailed_help[57];
  RNAcofold_args_info_full_help[37] = RNAcofold_args_info_detailed_help[59];
  RNAcofold_args_info_full_help[38] = RNAcofold_args_info_detailed_help[60];
  RNAcofold_args_info_full_help[39] = RNAcofold_args_info_detailed_help[61];
  ...
  RNAcofold_args_info_full_help[43] = RNAcofold_args_info_detailed_help[68];
  RNAcofold_args_info_full_help[44] = RNAcofold_args_info_detailed_help[69];
  RNAcofold_args_info_full_help[45] = RNAcofold_args_info_detailed_help[70];
  ...
  RNAcofold_args_info_full_help[52] = RNAcofold_args_info_detailed_help[80];
  RNAcofold_args_info_full_help[53] = RNAcofold_args_info_detailed_help[81];
  RNAcofold_args_info_full_help[54] = RNAcofold_args_info_detailed_help[82];
  RNAcofold_args_info_full_help[55] = RNAcofold_args_info_detailed_help[84];
  RNAcofold_args_info_full_help[56] = RNAcofold_args_info_detailed_help[86];
  RNAcofold_args_info_full_help[57] = RNAcofold_args_info_detailed_help[87];
  RNAcofold_args_info_full_help[58] = RNAcofold_args_info_detailed_help[88];
  RNAcofold_args_info_full_help[59] = RNAcofold_args_info_detailed_help[90];
  RNAcofold_args_info_full_help[60] = RNAcofold_args_info_detailed_help[92];
  RNAcofold_args_info_full_help[61] = RNAcofold_args_info_detailed_help[94];
  RNAcofold_args_info_full_help[62] = RNAcofold_args_info_detailed_help[96];
  RNAcofold_args_info_full_help[63] = RNAcofold_args_info_detailed_help[97];
  RNAcofold_args_info_full_help[64] = RNAcofold_args_info_detailed_help[98];
  RNAcofold_args_info_full_help[65] = RNAcofold_args_info_detailed_help[99];
  RNAcofold_args_info_full_help[66] = 0; 
  
}

const char *RNAcofold_args_info_full_help[67];
...
init_help_array(void)
{
  ...
  RNAcofold_args_info_help[7] = RNAcofold_args_info_detailed_help[12];
  RNAcofold_args_info_help[8] = RNAcofold_args_info_detailed_help[16];
  RNAcofold_args_info_help[9] = RNAcofold_args_info_detailed_help[17];
  RNAcofold_args_info_help[10] = RNAcofold_args_info_detailed_help[19];
  RNAcofold_args_info_help[11] = RNAcofold_args_info_detailed_help[31];
  ...
  RNAcofold_args_info_help[14] = RNAcofold_args_info_detailed_help[35];
  RNAcofold_args_info_help[15] = RNAcofold_args_info_detailed_help[41];
  RNAcofold_args_info_help[16] = RNAcofold_args_info_detailed_help[43];
  RNAcofold_args_info_help[17] = RNAcofold_args_info_detailed_help[45];
  RNAcofold_args_info_help[18] = RNAcofold_args_info_detailed_help[47];
  RNAcofold_args_info_help[19] = RNAcofold_args_info_detailed_help[51];
  RNAcofold_args_info_help[20] = RNAcofold_args_info_detailed_help[52];
  RNAcofold_args_info_help[21] = RNAcofold_args_info_detailed_help[53];
  RNAcofold_args_info_help[22] = RNAcofold_args_info_detailed_help[54];
  RNAcofold_args_info_help[23] = RNAcofold_args_info_detailed_help[55];
  RNAcofold_args_info_help[24] = RNAcofold_args_info_detailed_help[60];
  RNAcofold_args_info_help[25] = RNAcofold_args_info_detailed_help[61];
  RNAcofold_args_info_help[26] = RNAcofold_args_info_detailed_help[64];
  RNAcofold_args_info_help[27] = RNAcofold_args_info_detailed_help[68];
  RNAcofold_args_info_help[28] = RNAcofold_args_info_detailed_help[69];
  RNAcofold_args_info_help[29] = RNAcofold_args_info_detailed_help[70];
  RNAcofold_args_info_help[30] = RNAcofold_args_info_detailed_help[71];
  RNAcofold_args_info_help[31] = RNAcofold_args_info_detailed_help[75];
  RNAcofold_args_info_help[32] = RNAcofold_args_info_detailed_help[77];
  RNAcofold_args_info_help[33] = RNAcofold_args_info_detailed_help[79];
  RNAcofold_args_info_help[34] = RNAcofold_args_info_detailed_help[80];
  RNAcofold_args_info_help[35] = RNAcofold_args_info_detailed_help[81];
  RNAcofold_args_info_help[36] = RNAcofold_args_info_detailed_help[82];
  RNAcofold_args_info_help[37] = RNAcofold_args_info_detailed_help[84];
  RNAcofold_args_info_help[38] = RNAcofold_args_info_detailed_help[96];
  RNAcofold_args_info_help[39] = RNAcofold_args_info_detailed_help[97];
  RNAcofold_args_info_help[40] = RNAcofold_args_info_detailed_help[98];
  RNAcofold_args_info_help[41] = RNAcofold_args_info_detailed_help[99];
  RNAcofold_args_info_help[42] = 0; 
  
}

const char *RNAcofold_args_info_help[43];
...
void init_args_info(struct RNAcofold_args_info *args_info)
{
  ...
  args_info->verbose_help = RNAcofold_args_info_detailed_help[4] ;
  args_info->output_format_help = RNAcofold_args_info_detailed_help[7] ;
  args_info->csv_delim_help = RNAcofold_args_info_detailed_help[9] ;
  args_info->csv_noheader_help = RNAcofold_args_info_detailed_help[11] ;
  args_info->jobs_help = RNAcofold_args_info_detailed_help[12] ;
  args_info->unordered_help = RNAcofold_args_info_detailed_help[14] ;
  args_info->noconv_help = RNAcofold_args_info_detailed_help[16] ;
  args_info->auto_id_help = RNAcofold_args_info_detailed_help[17] ;
  args_info->id_prefix_help = RNAcofold_args_info_detailed_help[19] ;
  args_info->id_delim_help = RNAcofold_args_info_detailed_help[21] ;
  args_info->id_digits_help = RNAcofold_args_info_detailed_help[23] ;
  args_info->id_start_help = RNAcofold_args_info_detailed_help[25] ;
  args_info->filename_delim_help = RNAcofold_args_info_detailed_help[27] ;
  args_info->filename_full_help = RNAcofold_args_info_detailed_help[29] ;
  args_info->partfunc_help = RNAcofold_args_info_detailed_help[33] ;
  args_info->all_pf_help = RNAcofold_args_info_detailed_help[35] ;
  args_info->betaScale_help = RNAcofold_args_info_detailed_help[37] ;
  args_info->pfScale_help = RNAcofold_args_info_detailed_help[39] ;
  args_info->concentrations_help = RNAcofold_args_info_detailed_help[41] ;
  args_info->concfile_help = RNAcofold_args_info_detailed_help[43] ;
  args_info->centroid_help = RNAcofold_args_info_detailed_help[45] ;
  args_info->MEA_help = RNAcofold_args_info_detailed_help[47] ;
  args_info->bppmThreshold_help = RNAcofold_args_info_detailed_help[49] ;
  args_info->gquad_help = RNAcofold_args_info_detailed_help[51] ;
  args_info->maxBPspan_help = RNAcofold_args_info_detailed_help[54] ;
  args_info->constraint_help = RNAcofold_args_info_detailed_help[55] ;
  args_info->batch_help = RNAcofold_args_info_detailed_help[57] ;
  args_info->canonicalBPonly_help = RNAcofold_args_info_detailed_help[59] ;
  args_info->enforceConstraint_help = RNAcofold_args_info_detailed_help[60] ;
  args_info->shape_help = RNAcofold_args_info_detailed_help[61] ;
  args_info->shapeMethod_help = RNAcofold_args_info_detailed_help[62] ;
  args_info->shapeConversion_help = RNAcofold_args_info_detailed_help[64] ;
  args_info->commands_help = RNAcofold_args_info_detailed_help[66] ;
  args_info->temp_help = RNAcofold_args_info_detailed_help[70] ;
  args_info->paramFile_help = RNAcofold_args_info_detailed_help[71] ;
  args_info->noTetra_help = RNAcofold_args_info_detailed_help[73] ;
  args_info->salt_help = RNAcofold_args_info_detailed_help[75] ;
  args_info->saltInit_help = RNAcofold_args_info_detailed_help[76] ;
  args_info->modifications_help = RNAcofold_args_info_detailed_help[77] ;
  args_info->mod_file_help = RNAcofold_args_info_detailed_help[79] ;
  args_info->mod_file_min = 0;
  args_info->mod_file_max = 0;
  args_info->dangles_help = RNAcofold_args_info_detailed_help[82] ;
  args_info->noLP_help = RNAcofold_args_info_detailed_help[84] ;
  args_info->noGU_help = RNAcofold_args_info_detailed_help[86] ;
  args_info->noClosingGU_help = RNAcofold_args_info_detailed_help[87] ;
  args_info->nsp_help = RNAcofold_args_info_detailed_help[88] ;
  args_info->energyModel_help = RNAcofold_args_info_detailed_help[90] ;
  args_info->helical_rise_help = RNAcofold_args_info_detailed_help[92] ;
  args_info->backbone_length_help = RNAcofold_args_info_detailed_help[94] ;
  args_info->noPS_help = RNAcofold_args_info_detailed_help[98] ;
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "hVvj::p::a::S:cf:gC::T:P:4m::d:e:", long_options, &option_index);
