...
#ifndef RNAMULTIFOLD_CMDL_H
#define RNAMULTIFOLD_CMDL_H
...
#ifndef RNAMULTIFOLD_CMDLINE_PARSER_PACKAGE
/** @brief the program name (used for printing errors) */
#define RNAMULTIFOLD_CMDLINE_PARSER_PACKAGE "RNAmultifold"
#endif

#ifndef RNAMULTIFOLD_CMDLINE_PARSER_PACKAGE_NAME
/** @brief the complete program name (used for help and version) */
#define RNAMULTIFOLD_CMDLINE_PARSER_PACKAGE_NAME "RNAmultifold"
#endif

#ifndef RNAMULTIFOLD_CMDLINE_PARSER_VERSION
/** @brief the program version */
#define RNAMULTIFOLD_CMDLINE_PARSER_VERSION VERSION
#endif

/** @brief Where the command line options are stored */
struct RNAmultifold_args_info
{
 ...
 help description.  */
  int all_pf_arg;	/**< @brief Compute the partition function and free energies not only for the complex formed by the input sequences (the \"ABC... mutimer\"), but also of all complexes formed by the input sequences up to the number of input sequences, e.g. AAA, AAB, ABB, BBB, etc.
 (default='1').  */
  char * all_pf_orig;	/**< @brief Compute the partition function and free energies not only for the complex formed by the input sequences (the \"ABC... mutimer\"), but also of all complexes formed by the input sequences up to the number of input sequences, e.g. AAA, AAB, ABB, BBB, etc.
 original value given at command line.  */
  const char *all_pf_help; /**< @brief Compute the partition function and free energies not only for the complex formed by the input sequences (the \"ABC... mutimer\"), but also of all complexes formed by the input sequences up to the number of input sequences, e.g. AAA, AAB, ABB, BBB, etc.
 help description.  */
  int concentrations_flag;	/**< @brief In addition to everything listed under the -a option, read in initial monomer concentrations and compute the expected equilibrium concentrations of all possible species (A, B, AA, BB, AB, etc).
 (default=off).  */
  const char *concentrations_help; /**< @brief In addition to everything listed under the -a option, read in initial monomer concentrations and compute the expected equilibrium concentrations of all possible species (A, B, AA, BB, AB, etc).
 help description.  */
  char * concfile_arg;	/**< @brief Specify a file with initial concentrations for the input sequences..  */
  char * concfile_orig;	/**< @brief Specify a file with initial concentrations for the input sequences. original value given at command line.  */
  const char *concfile_help; /**< @brief Specify a file with initial concentrations for the input sequences. help description.  */
  int absolute_concentrations_flag;	/**< @brief Report absolute instead of relative concentrations
  
 (default=off).  */
  const char *absolute_concentrations_help; /**< @brief Report absolute instead of relative concentrations
 ...
 help description.  */
  double bppmThreshold_arg;	/**< @brief Set the threshold/cutoff for base pair probabilities included in the postscript output.
  
 (default='1e-5').  */
  char * bppmThreshold_orig;	/**< @brief Set the threshold/cutoff for base pair probabilities included in the postscript output.
  
 original value given at command line.  */
  const char *bppmThreshold_help; /**< @brief Set the threshold/cutoff for base pair probabilities included in the postscript output.
...
.  */
 ...
 help description.  */
  ...
  unsigned int absolute_concentrations_given ;	/**< @brief Whether absolute-concentrations was given.  */
...
struct RNAmultifold_cmdline_parser_params
{
  ...
  int initialize; /**< @brief whether to initialize the option structure RNAmultifold_args_info (default 1) */
  int check_required; /**< @brief whether to check that all required options were provided (default 1) */
  int check_ambiguity; /**< @brief whether to check for options already specified in the option structure RNAmultifold_args_info (default 0) */
  int print_errors; /**< @brief whether getopt_long should print an error message for a bad option (default 1) */
} ;

/** @brief the purpose string of the program */
extern const char *RNAmultifold_args_info_purpose;
/** @brief the usage string of the program */
extern const char *RNAmultifold_args_info_usage;
/** @brief the description string of the program */
extern const char *RNAmultifold_args_info_description;
/** @brief all the lines making the help output */
extern const char *RNAmultifold_args_info_help[];
/** @brief all the lines making the full help output (including hidden options) */
extern const char *RNAmultifold_args_info_full_help[];
/** @brief all the lines making the detailed help output (including hidden options and details) */
extern const char *RNAmultifold_args_info_detailed_help[];
 ...
 */
int RNAmultifold_cmdline_parser (int argc, char **argv,
 ...
 * @return 0 if everything went fine, NON 0 if an error took place
 * @deprecated use RNAmultifold_cmdline_parser_ext() instead
 */
int RNAmultifold_cmdline_parser2 (int argc, char **argv,
  struct RNAmultifold_args_info *args_info,
 ...
 * @return 0 if everything went fine, NON 0 if an error took place
 */
int RNAmultifold_cmdline_parser_ext (int argc, char **argv,
  struct RNAmultifold_args_info *args_info,
 ...
 * @return 0 if everything went fine, NON 0 if an error took place
 */
int RNAmultifold_cmdline_parser_dump(FILE *outfile,
  struct RNAmultifold_args_info *args_info);
 ...
 * @return 0 if everything went fine, NON 0 if an error took place
 */
int RNAmultifold_cmdline_parser_file_save(const char *filename,
  struct RNAmultifold_args_info *args_info);

/**
 * Print the help
 */
void RNAmultifold_cmdline_parser_print_help(void);
/**
 * Print the full help (including hidden options)
 */
void RNAmultifold_cmdline_parser_print_full_help(void);
/**
 * Print the detailed help (including hidden options and details)
 */
void RNAmultifold_cmdline_parser_print_detailed_help(void);
/**
 * Print the version
 */
void RNAmultifold_cmdline_parser_print_version(void);

/**
 * Initializes all the fields a RNAmultifold_cmdline_parser_params structure 
 * to their default values
 * @param params the structure to initialize
 */
void RNAmultifold_cmdline_parser_params_init(struct RNAmultifold_cmdline_parser_params *params);

/**
 * Allocates dynamically a RNAmultifold_cmdline_parser_params structure and initializes
 * all its fields to their default values
 * @return the created and initialized RNAmultifold_cmdline_parser_params structure
 */
struct RNAmultifold_cmdline_parser_params *RNAmultifold_cmdline_parser_params_create(void);

/**
 * Initializes the passed RNAmultifold_args_info structure's fields
 * (also set default values for options that have a default)
 * @param args_info the structure to initialize
 */
void RNAmultifold_cmdline_parser_init (struct RNAmultifold_args_info *args_info);
/**
 * Deallocates the string fields of the RNAmultifold_args_info structure
 * (but does not deallocate the structure itself)
 * @param args_info the structure to deallocate
 */
void RNAmultifold_cmdline_parser_free (struct RNAmultifold_args_info *args_info);
 ...
 * @return
 */
int RNAmultifold_cmdline_parser_required (struct RNAmultifold_args_info *args_info,
