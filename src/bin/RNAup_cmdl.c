...
init_full_help_array(void)
{
  ...
  RNAup_args_info_full_help[7] = RNAup_args_info_detailed_help[7];
  RNAup_args_info_full_help[8] = RNAup_args_info_detailed_help[8];
  RNAup_args_info_full_help[9] = RNAup_args_info_detailed_help[9];
  RNAup_args_info_full_help[10] = RNAup_args_info_detailed_help[10];
  RNAup_args_info_full_help[11] = RNAup_args_info_detailed_help[11];
  RNAup_args_info_full_help[12] = RNAup_args_info_detailed_help[13];
  RNAup_args_info_full_help[13] = RNAup_args_info_detailed_help[15];
  RNAup_args_info_full_help[14] = RNAup_args_info_detailed_help[16];
  RNAup_args_info_full_help[15] = RNAup_args_info_detailed_help[17];
  ...
  RNAup_args_info_full_help[21] = RNAup_args_info_detailed_help[29];
  RNAup_args_info_full_help[22] = RNAup_args_info_detailed_help[30];
  RNAup_args_info_full_help[23] = RNAup_args_info_detailed_help[31];
  RNAup_args_info_full_help[24] = RNAup_args_info_detailed_help[33];
  RNAup_args_info_full_help[25] = RNAup_args_info_detailed_help[34];
  ...
  RNAup_args_info_full_help[28] = RNAup_args_info_detailed_help[38];
  RNAup_args_info_full_help[29] = RNAup_args_info_detailed_help[40];
  ...
  RNAup_args_info_full_help[32] = RNAup_args_info_detailed_help[43];
  RNAup_args_info_full_help[33] = RNAup_args_info_detailed_help[44];
  RNAup_args_info_full_help[34] = RNAup_args_info_detailed_help[46];
  RNAup_args_info_full_help[35] = RNAup_args_info_detailed_help[48];
  RNAup_args_info_full_help[36] = RNAup_args_info_detailed_help[49];
  RNAup_args_info_full_help[37] = RNAup_args_info_detailed_help[50];
  RNAup_args_info_full_help[38] = RNAup_args_info_detailed_help[52];
  RNAup_args_info_full_help[39] = RNAup_args_info_detailed_help[54];
  RNAup_args_info_full_help[40] = RNAup_args_info_detailed_help[56];
  RNAup_args_info_full_help[41] = RNAup_args_info_detailed_help[58];
  RNAup_args_info_full_help[42] = 0; 
  
}

const char *RNAup_args_info_full_help[43];
...
init_help_array(void)
{
  ...
  RNAup_args_info_help[7] = RNAup_args_info_detailed_help[7];
  RNAup_args_info_help[8] = RNAup_args_info_detailed_help[8];
  RNAup_args_info_help[9] = RNAup_args_info_detailed_help[9];
  RNAup_args_info_help[10] = RNAup_args_info_detailed_help[10];
  RNAup_args_info_help[11] = RNAup_args_info_detailed_help[11];
  RNAup_args_info_help[12] = RNAup_args_info_detailed_help[13];
  RNAup_args_info_help[13] = RNAup_args_info_detailed_help[15];
  RNAup_args_info_help[14] = RNAup_args_info_detailed_help[16];
  RNAup_args_info_help[15] = RNAup_args_info_detailed_help[17];
  ...
  RNAup_args_info_help[20] = RNAup_args_info_detailed_help[29];
  RNAup_args_info_help[21] = RNAup_args_info_detailed_help[30];
  RNAup_args_info_help[22] = RNAup_args_info_detailed_help[31];
  RNAup_args_info_help[23] = RNAup_args_info_detailed_help[33];
  RNAup_args_info_help[24] = RNAup_args_info_detailed_help[34];
  RNAup_args_info_help[25] = RNAup_args_info_detailed_help[35];
  RNAup_args_info_help[26] = RNAup_args_info_detailed_help[36];
  RNAup_args_info_help[27] = RNAup_args_info_detailed_help[40];
  RNAup_args_info_help[28] = RNAup_args_info_detailed_help[42];
  RNAup_args_info_help[29] = RNAup_args_info_detailed_help[43];
  RNAup_args_info_help[30] = RNAup_args_info_detailed_help[44];
  RNAup_args_info_help[31] = RNAup_args_info_detailed_help[46];
  RNAup_args_info_help[32] = RNAup_args_info_detailed_help[58];
  RNAup_args_info_help[33] = 0; 
  
}

const char *RNAup_args_info_help[34];
...
void init_args_info(struct RNAup_args_info *args_info)
{
  ...
  args_info->no_output_file_help = RNAup_args_info_detailed_help[6] ;
  args_info->no_header_help = RNAup_args_info_detailed_help[7] ;
  args_info->noconv_help = RNAup_args_info_detailed_help[8] ;
  args_info->ulength_help = RNAup_args_info_detailed_help[11] ;
  args_info->ulength_min = 0;
  args_info->ulength_max = 0;
  args_info->contributions_help = RNAup_args_info_detailed_help[13] ;
  args_info->window_help = RNAup_args_info_detailed_help[16] ;
  args_info->include_both_help = RNAup_args_info_detailed_help[17] ;
  ...
  args_info->pfScale_help = RNAup_args_info_detailed_help[27] ;
  args_info->constraint_help = RNAup_args_info_detailed_help[31] ;
  args_info->temp_help = RNAup_args_info_detailed_help[35] ;
  args_info->paramFile_help = RNAup_args_info_detailed_help[36] ;
  args_info->noTetra_help = RNAup_args_info_detailed_help[38] ;
  args_info->salt_help = RNAup_args_info_detailed_help[40] ;
  args_info->saltInit_help = RNAup_args_info_detailed_help[41] ;
  args_info->dangles_help = RNAup_args_info_detailed_help[44] ;
  args_info->noLP_help = RNAup_args_info_detailed_help[46] ;
  args_info->noGU_help = RNAup_args_info_detailed_help[48] ;
  args_info->noClosingGU_help = RNAup_args_info_detailed_help[49] ;
  args_info->nsp_help = RNAup_args_info_detailed_help[50] ;
  args_info->energyModel_help = RNAup_args_info_detailed_help[52] ;
  args_info->helical_rise_help = RNAup_args_info_detailed_help[54] ;
  args_info->backbone_length_help = RNAup_args_info_detailed_help[56] ;
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "hVou:c:w:b5:3:S:CT:P:4d:e:", long_options, &option_index);
...
.  */
          ...
          break;
        case 'u':	/* Specify the length of the unstructured region in the output.
.  */
...
.  */
          ...
          break;
        case 'w':	/* Set the maximal length of the region of interaction.
...
.  */
          ...
          break;
        case 'b':	/* Include the probability of unpaired regions in both (b) RNAs.
.  */
