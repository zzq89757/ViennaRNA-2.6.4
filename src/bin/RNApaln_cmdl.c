/*
  ...
  /usr/bin/gengetopt -i RNApaln.ggo --file-name=RNApaln_cmdl --include-getopt --default-optional --func-name=RNApaln_cmdline_parser --arg-struct-name=RNApaln_args_info
...
{
  RNApaln_args_info_full_help[0] = RNApaln_args_info_detailed_help[0];
  RNApaln_args_info_full_help[1] = RNApaln_args_info_detailed_help[1];
  RNApaln_args_info_full_help[2] = RNApaln_args_info_detailed_help[2];
  RNApaln_args_info_full_help[3] = RNApaln_args_info_detailed_help[3];
  RNApaln_args_info_full_help[4] = RNApaln_args_info_detailed_help[4];
  RNApaln_args_info_full_help[5] = RNApaln_args_info_detailed_help[5];
  RNApaln_args_info_full_help[6] = RNApaln_args_info_detailed_help[6];
  RNApaln_args_info_full_help[7] = RNApaln_args_info_detailed_help[8];
  RNApaln_args_info_full_help[8] = RNApaln_args_info_detailed_help[9];
  RNApaln_args_info_full_help[9] = RNApaln_args_info_detailed_help[10];
  RNApaln_args_info_full_help[10] = RNApaln_args_info_detailed_help[11];
  RNApaln_args_info_full_help[11] = RNApaln_args_info_detailed_help[13];
  RNApaln_args_info_full_help[12] = RNApaln_args_info_detailed_help[14];
  RNApaln_args_info_full_help[13] = RNApaln_args_info_detailed_help[15];
  RNApaln_args_info_full_help[14] = RNApaln_args_info_detailed_help[16];
  RNApaln_args_info_full_help[15] = RNApaln_args_info_detailed_help[17];
  RNApaln_args_info_full_help[16] = RNApaln_args_info_detailed_help[18];
  RNApaln_args_info_full_help[17] = RNApaln_args_info_detailed_help[19];
  RNApaln_args_info_full_help[18] = RNApaln_args_info_detailed_help[20];
  RNApaln_args_info_full_help[19] = RNApaln_args_info_detailed_help[22];
  RNApaln_args_info_full_help[20] = RNApaln_args_info_detailed_help[24];
  RNApaln_args_info_full_help[21] = RNApaln_args_info_detailed_help[25];
  RNApaln_args_info_full_help[22] = RNApaln_args_info_detailed_help[26];
  RNApaln_args_info_full_help[23] = RNApaln_args_info_detailed_help[27];
  RNApaln_args_info_full_help[24] = RNApaln_args_info_detailed_help[29];
  RNApaln_args_info_full_help[25] = RNApaln_args_info_detailed_help[31];
  RNApaln_args_info_full_help[26] = RNApaln_args_info_detailed_help[32];
  RNApaln_args_info_full_help[27] = RNApaln_args_info_detailed_help[33];
  RNApaln_args_info_full_help[28] = RNApaln_args_info_detailed_help[35];
  RNApaln_args_info_full_help[29] = RNApaln_args_info_detailed_help[37];
  RNApaln_args_info_full_help[30] = RNApaln_args_info_detailed_help[39];
  RNApaln_args_info_full_help[31] = RNApaln_args_info_detailed_help[41];
  RNApaln_args_info_full_help[32] = 0; 
  
}

const char *RNApaln_args_info_full_help[33];

static void
init_help_array(void)
{
  RNApaln_args_info_help[0] = RNApaln_args_info_detailed_help[0];
  RNApaln_args_info_help[1] = RNApaln_args_info_detailed_help[1];
  RNApaln_args_info_help[2] = RNApaln_args_info_detailed_help[2];
  RNApaln_args_info_help[3] = RNApaln_args_info_detailed_help[3];
  RNApaln_args_info_help[4] = RNApaln_args_info_detailed_help[4];
  RNApaln_args_info_help[5] = RNApaln_args_info_detailed_help[5];
  RNApaln_args_info_help[6] = RNApaln_args_info_detailed_help[6];
  RNApaln_args_info_help[7] = RNApaln_args_info_detailed_help[8];
  RNApaln_args_info_help[8] = RNApaln_args_info_detailed_help[9];
  RNApaln_args_info_help[9] = RNApaln_args_info_detailed_help[10];
  RNApaln_args_info_help[10] = RNApaln_args_info_detailed_help[11];
  RNApaln_args_info_help[11] = RNApaln_args_info_detailed_help[13];
  RNApaln_args_info_help[12] = RNApaln_args_info_detailed_help[14];
  RNApaln_args_info_help[13] = RNApaln_args_info_detailed_help[15];
  RNApaln_args_info_help[14] = RNApaln_args_info_detailed_help[16];
  RNApaln_args_info_help[15] = RNApaln_args_info_detailed_help[17];
  RNApaln_args_info_help[16] = RNApaln_args_info_detailed_help[18];
  RNApaln_args_info_help[17] = RNApaln_args_info_detailed_help[19];
  RNApaln_args_info_help[18] = RNApaln_args_info_detailed_help[20];
  RNApaln_args_info_help[19] = RNApaln_args_info_detailed_help[24];
  RNApaln_args_info_help[20] = RNApaln_args_info_detailed_help[25];
  RNApaln_args_info_help[21] = RNApaln_args_info_detailed_help[26];
  RNApaln_args_info_help[22] = RNApaln_args_info_detailed_help[27];
  RNApaln_args_info_help[23] = RNApaln_args_info_detailed_help[29];
  RNApaln_args_info_help[24] = RNApaln_args_info_detailed_help[41];
  RNApaln_args_info_help[25] = 0; 
  
}

const char *RNApaln_args_info_help[26];
...
typedef enum {ARG_NO
  ...
  , ARG_FLOAT
  , ARG_DOUBLE
} RNApaln_cmdline_parser_arg_type;

static
void clear_given (struct RNApaln_args_info *args_info);
static
void clear_args (struct RNApaln_args_info *args_info);

static int
RNApaln_cmdline_parser_internal (int argc, char **argv, struct RNApaln_args_info *args_info,
                        struct RNApaln_cmdline_parser_params *params, const char *additional_error);
...
void clear_given (struct RNApaln_args_info *args_info)
{
  ...
  args_info->printAlignment_given = 0 ;
  args_info->noconv_given = 0 ;
  args_info->mode_given = 0 ;
  args_info->gapo_given = 0 ;
  args_info->gape_given = 0 ;
  args_info->seqw_given = 0 ;
...
void clear_args (struct RNApaln_args_info *args_info)
{
  ...
  args_info->printAlignment_arg = gengetopt_strdup ("stdout");
  args_info->printAlignment_orig = NULL;
  args_info->noconv_flag = 0;
  args_info->mode_arg = NULL;
  args_info->mode_orig = NULL;
  args_info->gapo_orig = NULL;
  args_info->gape_orig = NULL;
  args_info->seqw_orig = NULL;
...
static
void init_args_info(struct RNApaln_args_info *args_info)
{
  init_full_help_array(); 
  init_help_array(); 
  args_info->help_help = RNApaln_args_info_detailed_help[0] ;
  args_info->detailed_help_help = RNApaln_args_info_detailed_help[1] ;
  args_info->full_help_help = RNApaln_args_info_detailed_help[2] ;
  args_info->version_help = RNApaln_args_info_detailed_help[3] ;
  args_info->printAlignment_help = RNApaln_args_info_detailed_help[6] ;
  args_info->noconv_help = RNApaln_args_info_detailed_help[8] ;
  args_info->mode_help = RNApaln_args_info_detailed_help[11] ;
  args_info->gapo_help = RNApaln_args_info_detailed_help[13] ;
  args_info->gape_help = RNApaln_args_info_detailed_help[14] ;
  args_info->seqw_help = RNApaln_args_info_detailed_help[15] ;
  args_info->endgaps_help = RNApaln_args_info_detailed_help[16] ;
  args_info->temp_help = RNApaln_args_info_detailed_help[19] ;
  args_info->paramFile_help = RNApaln_args_info_detailed_help[20] ;
  args_info->noTetra_help = RNApaln_args_info_detailed_help[22] ;
  args_info->salt_help = RNApaln_args_info_detailed_help[24] ;
  args_info->dangles_help = RNApaln_args_info_detailed_help[27] ;
  args_info->noLP_help = RNApaln_args_info_detailed_help[29] ;
  args_info->noGU_help = RNApaln_args_info_detailed_help[31] ;
  args_info->noClosingGU_help = RNApaln_args_info_detailed_help[32] ;
  args_info->nsp_help = RNApaln_args_info_detailed_help[33] ;
  args_info->energyModel_help = RNApaln_args_info_detailed_help[35] ;
  args_info->helical_rise_help = RNApaln_args_info_detailed_help[37] ;
  args_info->backbone_length_help = RNApaln_args_info_detailed_help[39] ;
  
}

void
RNApaln_cmdline_parser_print_version (void)
{
  printf ("%s %s\n",
     (strlen(RNAPALN_CMDLINE_PARSER_PACKAGE_NAME) ? RNAPALN_CMDLINE_PARSER_PACKAGE_NAME : RNAPALN_CMDLINE_PARSER_PACKAGE),
     RNAPALN_CMDLINE_PARSER_VERSION);

  if (strlen(RNApaln_args_info_versiontext) > 0)
    printf("\n%s\n", RNApaln_args_info_versiontext);
}

static void print_help_common(void)
{
	size_t len_purpose = strlen(RNApaln_args_info_purpose);
	size_t len_usage = strlen(RNApaln_args_info_usage);
	...
	if (strlen(RNApaln_args_info_description) > 0) {
		printf("%s\n\n", RNApaln_args_info_description);
	}
}

void
RNApaln_cmdline_parser_print_help (void)
{
  int i = 0;
  print_help_common();
  while (RNApaln_args_info_help[i])
    printf("%s\n", RNApaln_args_info_help[i++]);
}

void
RNApaln_cmdline_parser_print_full_help (void)
{
  int i = 0;
  print_help_common();
  while (RNApaln_args_info_full_help[i])
    printf("%s\n", RNApaln_args_info_full_help[i++]);
}

void
RNApaln_cmdline_parser_print_detailed_help (void)
{
  int i = 0;
  print_help_common();
  while (RNApaln_args_info_detailed_help[i])
    printf("%s\n", RNApaln_args_info_detailed_help[i++]);
}

void
RNApaln_cmdline_parser_init (struct RNApaln_args_info *args_info)
{
...
void
RNApaln_cmdline_parser_params_init(struct RNApaln_cmdline_parser_params *params)
{
  if (params)
    { 
      params->override = 0;
...
RNApaln_cmdline_parser_params_create(void)
{
  struct RNApaln_cmdline_parser_params *params = 
    (struct RNApaln_cmdline_parser_params *)malloc(sizeof(struct RNApaln_cmdline_parser_params));
  RNApaln_cmdline_parser_params_init(params);  
  return params;
}
...
static void
RNApaln_cmdline_parser_release (struct RNApaln_args_info *args_info)
{

  free_string_field (&(args_info->printAlignment_arg));
  free_string_field (&(args_info->printAlignment_orig));
  free_string_field (&(args_info->mode_arg));
  free_string_field (&(args_info->mode_orig));
  free_string_field (&(args_info->gapo_orig));
  free_string_field (&(args_info->gape_orig));
  free_string_field (&(args_info->seqw_orig));
...
int
RNApaln_cmdline_parser_dump(FILE *outfile, struct RNApaln_args_info *args_info)
{
  int i = 0;
  ...
  if (args_info->printAlignment_given)
    write_into_file(outfile, "printAlignment", args_info->printAlignment_orig, 0);
  ...
  if (args_info->gapo_given)
    write_into_file(outfile, "gapo", args_info->gapo_orig, 0);
  if (args_info->gape_given)
    write_into_file(outfile, "gape", args_info->gape_orig, 0);
  if (args_info->seqw_given)
    write_into_file(outfile, "seqw", args_info->seqw_orig, 0);
...
int
RNApaln_cmdline_parser_file_save(const char *filename, struct RNApaln_args_info *args_info)
{
  FILE *outfile;
  int i = 0;
  ...
  i = RNApaln_cmdline_parser_dump(outfile, args_info);
  fclose (outfile);
...
void
RNApaln_cmdline_parser_free (struct RNApaln_args_info *args_info)
{
  RNApaln_cmdline_parser_release (args_info);
}
...
int
RNApaln_cmdline_parser (int argc, char **argv, struct RNApaln_args_info *args_info)
{
  return RNApaln_cmdline_parser2 (argc, argv, args_info, 0, 1, 1);
}

int
RNApaln_cmdline_parser_ext (int argc, char **argv, struct RNApaln_args_info *args_info,
                   struct RNApaln_cmdline_parser_params *params)
{
  int result;
  result = RNApaln_cmdline_parser_internal (argc, argv, args_info, params, 0);
...
int
RNApaln_cmdline_parser2 (int argc, char **argv, struct RNApaln_args_info *args_info, int override, int initialize, int check_required)
{
  int result;
  struct RNApaln_cmdline_parser_params params;
...
int
RNApaln_cmdline_parser_required (struct RNApaln_args_info *args_info, const char *prog_name)
{
  FIX_UNUSED (args_info);
 ...
 * @param check_ambiguity @see RNApaln_cmdline_parser_params.check_ambiguity
 * @param override @see RNApaln_cmdline_parser_params.override
...
int update_arg(void *field, char **orig_field,
               ...
               RNApaln_cmdline_parser_arg_type arg_type,
...
int
RNApaln_cmdline_parser_internal (
  int argc, char **argv, struct RNApaln_args_info *args_info,
                        struct RNApaln_cmdline_parser_params *params, const char *additional_error)
{
  int c;	/* Character of the parsed option.  */

  int error_occurred = 0;
  struct RNApaln_args_info local_args_info;
  ...
  if (initialize)
    RNApaln_cmdline_parser_init (args_info);

  RNApaln_cmdline_parser_init (&local_args_info);
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "hVB::X:T:P:4d:e:", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'h':	/* Print help and exit.  */
          ...
          RNApaln_cmdline_parser_free (&local_args_info);
          exit (EXIT_SUCCESS);

        case 'V':	/* Print version and exit.  */
          RNApaln_cmdline_parser_print_version ();
          RNApaln_cmdline_parser_free (&local_args_info);
          exit (EXIT_SUCCESS);

        case 'B':	/* Print an \"alignment\" with gaps of the profiles
...
.  */
          ...
          if (update_arg( (void *)&(args_info->printAlignment_arg), 
               &(args_info->printAlignment_orig), &(args_info->printAlignment_given),
              &(local_args_info.printAlignment_given), optarg, 0, "stdout", ARG_STRING,
          ...
          break;
        case 'X':	/* Set the alignment mode to be used.
.  */
...
.  */
        ...
        case 0:	/* Long option with no short option */
          if (strcmp (long_options[option_index].name, "detailed-help") == 0) {
            RNApaln_cmdline_parser_print_detailed_help ();
            RNApaln_cmdline_parser_free (&local_args_info);
            exit (EXIT_SUCCESS);
          }

          if (strcmp (long_options[option_index].name, "full-help") == 0) {
            RNApaln_cmdline_parser_print_full_help ();
            RNApaln_cmdline_parser_free (&local_args_info);
            exit (EXIT_SUCCESS);
          }
...
.  */
          else if (strcmp (long_options[option_index].name, "gapo") == 0)
          {
            ...
            if (update_arg( (void *)&(args_info->gapo_arg), 
                 &(args_info->gapo_orig), &(args_info->gapo_given),
                &(local_args_info.gapo_given), optarg, 0, 0, ARG_FLOAT,
                check_ambiguity, override, 0, 0,
                "gapo", '-',
                additional_error))
              goto failure;
...
.  */
          else if (strcmp (long_options[option_index].name, "gape") == 0)
          {
            ...
            if (update_arg( (void *)&(args_info->gape_arg), 
                 &(args_info->gape_orig), &(args_info->gape_given),
                &(local_args_info.gape_given), optarg, 0, 0, ARG_FLOAT,
                check_ambiguity, override, 0, 0,
                "gape", '-',
                additional_error))
              goto failure;
...
.  */
          else if (strcmp (long_options[option_index].name, "seqw") == 0)
          {
          
          
            if (update_arg( (void *)&(args_info->seqw_arg), 
                 &(args_info->seqw_orig), &(args_info->seqw_given),
                &(local_args_info.seqw_given), optarg, 0, 0, ARG_FLOAT,
                check_ambiguity, override, 0, 0,
                "seqw", '-',
                additional_error))
              goto failure;
...
.  */
  ...
  RNApaln_cmdline_parser_release (&local_args_info);
