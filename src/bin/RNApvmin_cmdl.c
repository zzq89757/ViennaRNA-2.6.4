...
init_full_help_array(void)
{
  ...
  RNApvmin_args_info_full_help[8] = RNApvmin_args_info_detailed_help[8];
  RNApvmin_args_info_full_help[9] = RNApvmin_args_info_detailed_help[9];
  RNApvmin_args_info_full_help[10] = RNApvmin_args_info_detailed_help[11];
  RNApvmin_args_info_full_help[11] = RNApvmin_args_info_detailed_help[13];
  RNApvmin_args_info_full_help[12] = RNApvmin_args_info_detailed_help[14];
  RNApvmin_args_info_full_help[13] = RNApvmin_args_info_detailed_help[16];
  RNApvmin_args_info_full_help[14] = RNApvmin_args_info_detailed_help[17];
  RNApvmin_args_info_full_help[15] = RNApvmin_args_info_detailed_help[19];
  RNApvmin_args_info_full_help[16] = RNApvmin_args_info_detailed_help[21];
  ...
  RNApvmin_args_info_full_help[21] = RNApvmin_args_info_detailed_help[27];
  RNApvmin_args_info_full_help[22] = RNApvmin_args_info_detailed_help[29];
  RNApvmin_args_info_full_help[23] = RNApvmin_args_info_detailed_help[30];
  RNApvmin_args_info_full_help[24] = RNApvmin_args_info_detailed_help[31];
  RNApvmin_args_info_full_help[25] = RNApvmin_args_info_detailed_help[32];
  RNApvmin_args_info_full_help[26] = RNApvmin_args_info_detailed_help[33];
  RNApvmin_args_info_full_help[27] = RNApvmin_args_info_detailed_help[34];
  RNApvmin_args_info_full_help[28] = RNApvmin_args_info_detailed_help[35];
  RNApvmin_args_info_full_help[29] = RNApvmin_args_info_detailed_help[37];
  RNApvmin_args_info_full_help[30] = RNApvmin_args_info_detailed_help[39];
  RNApvmin_args_info_full_help[31] = RNApvmin_args_info_detailed_help[40];
  RNApvmin_args_info_full_help[32] = RNApvmin_args_info_detailed_help[41];
  RNApvmin_args_info_full_help[33] = RNApvmin_args_info_detailed_help[42];
  RNApvmin_args_info_full_help[34] = RNApvmin_args_info_detailed_help[44];
  RNApvmin_args_info_full_help[35] = RNApvmin_args_info_detailed_help[46];
  RNApvmin_args_info_full_help[36] = RNApvmin_args_info_detailed_help[47];
  RNApvmin_args_info_full_help[37] = RNApvmin_args_info_detailed_help[48];
  RNApvmin_args_info_full_help[38] = RNApvmin_args_info_detailed_help[50];
  RNApvmin_args_info_full_help[39] = RNApvmin_args_info_detailed_help[52];
  RNApvmin_args_info_full_help[40] = RNApvmin_args_info_detailed_help[54];
  RNApvmin_args_info_full_help[41] = RNApvmin_args_info_detailed_help[56];
  RNApvmin_args_info_full_help[42] = 0; 
  
}

const char *RNApvmin_args_info_full_help[43];
...
init_help_array(void)
{
  ...
  RNApvmin_args_info_help[8] = RNApvmin_args_info_detailed_help[8];
  RNApvmin_args_info_help[9] = RNApvmin_args_info_detailed_help[9];
  RNApvmin_args_info_help[10] = RNApvmin_args_info_detailed_help[11];
  RNApvmin_args_info_help[11] = RNApvmin_args_info_detailed_help[13];
  RNApvmin_args_info_help[12] = RNApvmin_args_info_detailed_help[14];
  RNApvmin_args_info_help[13] = RNApvmin_args_info_detailed_help[16];
  RNApvmin_args_info_help[14] = RNApvmin_args_info_detailed_help[17];
  RNApvmin_args_info_help[15] = RNApvmin_args_info_detailed_help[19];
  RNApvmin_args_info_help[16] = RNApvmin_args_info_detailed_help[21];
  RNApvmin_args_info_help[17] = RNApvmin_args_info_detailed_help[29];
  RNApvmin_args_info_help[18] = RNApvmin_args_info_detailed_help[30];
  RNApvmin_args_info_help[19] = RNApvmin_args_info_detailed_help[31];
  RNApvmin_args_info_help[20] = RNApvmin_args_info_detailed_help[32];
  RNApvmin_args_info_help[21] = RNApvmin_args_info_detailed_help[33];
  RNApvmin_args_info_help[22] = RNApvmin_args_info_detailed_help[34];
  RNApvmin_args_info_help[23] = RNApvmin_args_info_detailed_help[35];
  RNApvmin_args_info_help[24] = RNApvmin_args_info_detailed_help[39];
  RNApvmin_args_info_help[25] = RNApvmin_args_info_detailed_help[40];
  RNApvmin_args_info_help[26] = RNApvmin_args_info_detailed_help[41];
  RNApvmin_args_info_help[27] = RNApvmin_args_info_detailed_help[42];
  RNApvmin_args_info_help[28] = RNApvmin_args_info_detailed_help[44];
  RNApvmin_args_info_help[29] = RNApvmin_args_info_detailed_help[56];
  RNApvmin_args_info_help[30] = 0; 
  
}

const char *RNApvmin_args_info_help[31];
...
void init_args_info(struct RNApvmin_args_info *args_info)
{
  ...
  args_info->shapeConversion_help = RNApvmin_args_info_detailed_help[9] ;
  args_info->tauSigmaRatio_help = RNApvmin_args_info_detailed_help[11] ;
  args_info->objectiveFunction_help = RNApvmin_args_info_detailed_help[13] ;
  args_info->sampleSize_help = RNApvmin_args_info_detailed_help[14] ;
  args_info->nonRedundant_help = RNApvmin_args_info_detailed_help[16] ;
  args_info->intermediatePath_help = RNApvmin_args_info_detailed_help[17] ;
  args_info->initialVector_help = RNApvmin_args_info_detailed_help[19] ;
  args_info->minimizer_help = RNApvmin_args_info_detailed_help[21] ;
  args_info->initialStepSize_help = RNApvmin_args_info_detailed_help[23] ;
  args_info->minStepSize_help = RNApvmin_args_info_detailed_help[24] ;
  args_info->minImprovement_help = RNApvmin_args_info_detailed_help[25] ;
  args_info->minimizerTolerance_help = RNApvmin_args_info_detailed_help[26] ;
  args_info->pfScale_help = RNApvmin_args_info_detailed_help[27] ;
  args_info->maxBPspan_help = RNApvmin_args_info_detailed_help[31] ;
  args_info->temp_help = RNApvmin_args_info_detailed_help[34] ;
  args_info->paramFile_help = RNApvmin_args_info_detailed_help[35] ;
  args_info->noTetra_help = RNApvmin_args_info_detailed_help[37] ;
  args_info->salt_help = RNApvmin_args_info_detailed_help[39] ;
  args_info->dangles_help = RNApvmin_args_info_detailed_help[42] ;
  args_info->noLP_help = RNApvmin_args_info_detailed_help[44] ;
  args_info->noGU_help = RNApvmin_args_info_detailed_help[46] ;
  args_info->noClosingGU_help = RNApvmin_args_info_detailed_help[47] ;
  args_info->nsp_help = RNApvmin_args_info_detailed_help[48] ;
  args_info->energyModel_help = RNApvmin_args_info_detailed_help[50] ;
  args_info->helical_rise_help = RNApvmin_args_info_detailed_help[52] ;
  args_info->backbone_length_help = RNApvmin_args_info_detailed_help[54] ;
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "hVj:NS:T:P:4d:e:", long_options, &option_index);
