...
.  */
  char * numThreads_orig;	/**< @brief Set the number of threads used for calculations.
  
 original value given at command line.  */
  const char *numThreads_help; /**< @brief Set the number of threads used for calculations.
 ...
 help description.  */
  int sampleSize_arg;	/**< @brief The iterative minimization process requires to evaluate the gradient of the objective function.
 (default='1000').  */
  char * sampleSize_orig;	/**< @brief The iterative minimization process requires to evaluate the gradient of the objective function.
 original value given at command line.  */
  const char *sampleSize_help; /**< @brief The iterative minimization process requires to evaluate the gradient of the objective function.
 help description.  */
...
.  */
  char * intermediatePath_orig;	/**< @brief Write an output file for each iteration of the minimization process.
 original value given at command line.  */
  const char *intermediatePath_help; /**< @brief Write an output file for each iteration of the minimization process.
 help description.  */
  double initialVector_arg;	/**< @brief Specify the vector of initial pertubations.
 (default='0').  */
  char * initialVector_orig;	/**< @brief Specify the vector of initial pertubations.
 original value given at command line.  */
  const char *initialVector_help; /**< @brief Specify the vector of initial pertubations.
 help description.  */
  enum enum_minimizer minimizer_arg;	/**< @brief Set the minimizing algorithm used for finding an appropriate perturbation vector.
 (default='default').  */
  char * minimizer_orig;	/**< @brief Set the minimizing algorithm used for finding an appropriate perturbation vector.
 original value given at command line.  */
  const char *minimizer_help; /**< @brief Set the minimizing algorithm used for finding an appropriate perturbation vector.
 help description.  */
