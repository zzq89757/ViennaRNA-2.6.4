...
init_full_help_array(void)
{
  ...
  RNAheat_args_info_full_help[7] = RNAheat_args_info_detailed_help[8];
  RNAheat_args_info_full_help[8] = RNAheat_args_info_detailed_help[10];
  RNAheat_args_info_full_help[9] = RNAheat_args_info_detailed_help[12];
  RNAheat_args_info_full_help[10] = RNAheat_args_info_detailed_help[13];
  RNAheat_args_info_full_help[11] = RNAheat_args_info_detailed_help[15];
  RNAheat_args_info_full_help[12] = RNAheat_args_info_detailed_help[17];
  RNAheat_args_info_full_help[13] = RNAheat_args_info_detailed_help[19];
  RNAheat_args_info_full_help[14] = RNAheat_args_info_detailed_help[21];
  RNAheat_args_info_full_help[15] = RNAheat_args_info_detailed_help[23];
  RNAheat_args_info_full_help[16] = RNAheat_args_info_detailed_help[24];
  RNAheat_args_info_full_help[17] = RNAheat_args_info_detailed_help[25];
  RNAheat_args_info_full_help[18] = RNAheat_args_info_detailed_help[26];
  ...
  RNAheat_args_info_full_help[25] = RNAheat_args_info_detailed_help[33];
  RNAheat_args_info_full_help[26] = RNAheat_args_info_detailed_help[34];
  RNAheat_args_info_full_help[27] = RNAheat_args_info_detailed_help[35];
  RNAheat_args_info_full_help[28] = RNAheat_args_info_detailed_help[36];
  RNAheat_args_info_full_help[29] = RNAheat_args_info_detailed_help[38];
  RNAheat_args_info_full_help[30] = RNAheat_args_info_detailed_help[40];
  RNAheat_args_info_full_help[31] = RNAheat_args_info_detailed_help[41];
  RNAheat_args_info_full_help[32] = RNAheat_args_info_detailed_help[42];
  RNAheat_args_info_full_help[33] = RNAheat_args_info_detailed_help[43];
  RNAheat_args_info_full_help[34] = RNAheat_args_info_detailed_help[45];
  RNAheat_args_info_full_help[35] = RNAheat_args_info_detailed_help[47];
  RNAheat_args_info_full_help[36] = RNAheat_args_info_detailed_help[48];
  RNAheat_args_info_full_help[37] = RNAheat_args_info_detailed_help[49];
  RNAheat_args_info_full_help[38] = RNAheat_args_info_detailed_help[51];
  RNAheat_args_info_full_help[39] = RNAheat_args_info_detailed_help[53];
  RNAheat_args_info_full_help[40] = RNAheat_args_info_detailed_help[55];
  RNAheat_args_info_full_help[41] = RNAheat_args_info_detailed_help[57];
  RNAheat_args_info_full_help[42] = 0; 
  
}

const char *RNAheat_args_info_full_help[43];
...
init_help_array(void)
{
  ...
  RNAheat_args_info_help[7] = RNAheat_args_info_detailed_help[8];
  RNAheat_args_info_help[8] = RNAheat_args_info_detailed_help[12];
  RNAheat_args_info_help[9] = RNAheat_args_info_detailed_help[13];
  RNAheat_args_info_help[10] = RNAheat_args_info_detailed_help[15];
  RNAheat_args_info_help[11] = RNAheat_args_info_detailed_help[23];
  RNAheat_args_info_help[12] = RNAheat_args_info_detailed_help[24];
  RNAheat_args_info_help[13] = RNAheat_args_info_detailed_help[25];
  RNAheat_args_info_help[14] = RNAheat_args_info_detailed_help[26];
  ...
  RNAheat_args_info_help[21] = RNAheat_args_info_detailed_help[33];
  RNAheat_args_info_help[22] = RNAheat_args_info_detailed_help[34];
  RNAheat_args_info_help[23] = RNAheat_args_info_detailed_help[35];
  RNAheat_args_info_help[24] = RNAheat_args_info_detailed_help[36];
  RNAheat_args_info_help[25] = RNAheat_args_info_detailed_help[40];
  RNAheat_args_info_help[26] = RNAheat_args_info_detailed_help[41];
  RNAheat_args_info_help[27] = RNAheat_args_info_detailed_help[42];
  RNAheat_args_info_help[28] = RNAheat_args_info_detailed_help[43];
  RNAheat_args_info_help[29] = RNAheat_args_info_detailed_help[45];
  RNAheat_args_info_help[30] = RNAheat_args_info_detailed_help[57];
  RNAheat_args_info_help[31] = 0; 
  
}

const char *RNAheat_args_info_help[32];
...
void init_args_info(struct RNAheat_args_info *args_info)
{
  ...
  args_info->infile_help = RNAheat_args_info_detailed_help[6] ;
  args_info->infile_min = 0;
  args_info->infile_max = 0;
  args_info->jobs_help = RNAheat_args_info_detailed_help[8] ;
  args_info->unordered_help = RNAheat_args_info_detailed_help[10] ;
  args_info->noconv_help = RNAheat_args_info_detailed_help[12] ;
  args_info->auto_id_help = RNAheat_args_info_detailed_help[13] ;
  args_info->id_prefix_help = RNAheat_args_info_detailed_help[15] ;
  args_info->id_delim_help = RNAheat_args_info_detailed_help[17] ;
  args_info->id_digits_help = RNAheat_args_info_detailed_help[19] ;
  args_info->id_start_help = RNAheat_args_info_detailed_help[21] ;
  args_info->Tmin_help = RNAheat_args_info_detailed_help[25] ;
  args_info->Tmax_help = RNAheat_args_info_detailed_help[26] ;
  args_info->stepsize_help = RNAheat_args_info_detailed_help[27] ;
  args_info->ipoints_help = RNAheat_args_info_detailed_help[28] ;
  args_info->circ_help = RNAheat_args_info_detailed_help[29] ;
  args_info->gquad_help = RNAheat_args_info_detailed_help[30] ;
  args_info->maxBPspan_help = RNAheat_args_info_detailed_help[33] ;
  args_info->paramFile_help = RNAheat_args_info_detailed_help[36] ;
  args_info->noTetra_help = RNAheat_args_info_detailed_help[38] ;
  args_info->salt_help = RNAheat_args_info_detailed_help[40] ;
  args_info->dangles_help = RNAheat_args_info_detailed_help[43] ;
  args_info->noLP_help = RNAheat_args_info_detailed_help[45] ;
  args_info->noGU_help = RNAheat_args_info_detailed_help[47] ;
  args_info->noClosingGU_help = RNAheat_args_info_detailed_help[48] ;
  args_info->nsp_help = RNAheat_args_info_detailed_help[49] ;
  args_info->energyModel_help = RNAheat_args_info_detailed_help[51] ;
  args_info->helical_rise_help = RNAheat_args_info_detailed_help[53] ;
  args_info->backbone_length_help = RNAheat_args_info_detailed_help[55] ;
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "hVi:j::m:cgP:4d:e:", long_options, &option_index);
...
.  */
          else if (strcmp (long_options[option_index].name, "Tmin") == 0)
          {
