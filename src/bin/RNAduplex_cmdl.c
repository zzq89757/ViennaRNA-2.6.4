/*
  ...
  /usr/bin/gengetopt -i RNAduplex.ggo --file-name=RNAduplex_cmdl --include-getopt --default-optional --func-name=RNAduplex_cmdline_parser --arg-struct-name=RNAduplex_args_info
...
const char *RNAduplex_args_info_usage = "Usage: RNAduplex [OPTION]...";

const char *RNAduplex_args_info_versiontext = "";
...
init_full_help_array(void)
{
  ...
  RNAduplex_args_info_full_help[19] = RNAduplex_args_info_detailed_help[21];
  RNAduplex_args_info_full_help[20] = RNAduplex_args_info_detailed_help[22];
  RNAduplex_args_info_full_help[21] = RNAduplex_args_info_detailed_help[24];
  RNAduplex_args_info_full_help[22] = RNAduplex_args_info_detailed_help[26];
  RNAduplex_args_info_full_help[23] = RNAduplex_args_info_detailed_help[27];
  RNAduplex_args_info_full_help[24] = RNAduplex_args_info_detailed_help[28];
  RNAduplex_args_info_full_help[25] = RNAduplex_args_info_detailed_help[30];
  RNAduplex_args_info_full_help[26] = RNAduplex_args_info_detailed_help[32];
  RNAduplex_args_info_full_help[27] = RNAduplex_args_info_detailed_help[34];
  RNAduplex_args_info_full_help[28] = 0; 
  
}

const char *RNAduplex_args_info_full_help[29];
...
init_help_array(void)
{
  ...
  RNAduplex_args_info_help[15] = RNAduplex_args_info_detailed_help[18];
  RNAduplex_args_info_help[16] = RNAduplex_args_info_detailed_help[20];
  RNAduplex_args_info_help[17] = RNAduplex_args_info_detailed_help[21];
  RNAduplex_args_info_help[18] = RNAduplex_args_info_detailed_help[22];
  RNAduplex_args_info_help[19] = RNAduplex_args_info_detailed_help[24];
  RNAduplex_args_info_help[20] = RNAduplex_args_info_detailed_help[34];
  RNAduplex_args_info_help[21] = 0; 
  
}

const char *RNAduplex_args_info_help[22];
...
void init_args_info(struct RNAduplex_args_info *args_info)
{
  ...
  args_info->temp_help = RNAduplex_args_info_detailed_help[13] ;
  args_info->paramFile_help = RNAduplex_args_info_detailed_help[14] ;
  args_info->noTetra_help = RNAduplex_args_info_detailed_help[16] ;
  args_info->salt_help = RNAduplex_args_info_detailed_help[18] ;
  args_info->saltInit_help = RNAduplex_args_info_detailed_help[19] ;
  args_info->dangles_help = RNAduplex_args_info_detailed_help[22] ;
  args_info->noLP_help = RNAduplex_args_info_detailed_help[24] ;
  args_info->noGU_help = RNAduplex_args_info_detailed_help[26] ;
  args_info->noClosingGU_help = RNAduplex_args_info_detailed_help[27] ;
  args_info->nsp_help = RNAduplex_args_info_detailed_help[28] ;
  args_info->helical_rise_help = RNAduplex_args_info_detailed_help[30] ;
  args_info->backbone_length_help = RNAduplex_args_info_detailed_help[32] ;
...
RNAduplex_cmdline_parser_print_version (void)
{
  ...
  if (strlen(RNAduplex_args_info_versiontext) > 0)
    printf("\n%s\n", RNAduplex_args_info_versiontext);
}

static void print_help_common(void)
{
	size_t len_purpose = strlen(RNAduplex_args_info_purpose);
	size_t len_usage = strlen(RNAduplex_args_info_usage);
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "hVse:T:P:4d:", long_options, &option_index);
