/*
  ...
  /usr/bin/gengetopt -i RNAeval.ggo --file-name=RNAeval_cmdl --include-getopt --default-optional --unamed-opts --func-name=RNAeval_cmdline_parser --arg-struct-name=RNAeval_args_info
...
init_full_help_array(void)
{
  ...
  RNAeval_args_info_full_help[8] = RNAeval_args_info_detailed_help[9];
  RNAeval_args_info_full_help[9] = RNAeval_args_info_detailed_help[11];
  ...
  RNAeval_args_info_full_help[13] = RNAeval_args_info_detailed_help[17];
  RNAeval_args_info_full_help[14] = RNAeval_args_info_detailed_help[19];
  RNAeval_args_info_full_help[15] = RNAeval_args_info_detailed_help[21];
  RNAeval_args_info_full_help[16] = RNAeval_args_info_detailed_help[23];
  RNAeval_args_info_full_help[17] = RNAeval_args_info_detailed_help[25];
  RNAeval_args_info_full_help[18] = RNAeval_args_info_detailed_help[27];
  RNAeval_args_info_full_help[19] = RNAeval_args_info_detailed_help[28];
  RNAeval_args_info_full_help[20] = RNAeval_args_info_detailed_help[29];
  RNAeval_args_info_full_help[21] = RNAeval_args_info_detailed_help[30];
  RNAeval_args_info_full_help[22] = RNAeval_args_info_detailed_help[31];
  ...
  RNAeval_args_info_full_help[25] = RNAeval_args_info_detailed_help[34];
  RNAeval_args_info_full_help[26] = RNAeval_args_info_detailed_help[36];
  RNAeval_args_info_full_help[27] = RNAeval_args_info_detailed_help[38];
  RNAeval_args_info_full_help[28] = RNAeval_args_info_detailed_help[39];
  RNAeval_args_info_full_help[29] = RNAeval_args_info_detailed_help[40];
  RNAeval_args_info_full_help[30] = RNAeval_args_info_detailed_help[41];
  RNAeval_args_info_full_help[31] = RNAeval_args_info_detailed_help[43];
  RNAeval_args_info_full_help[32] = RNAeval_args_info_detailed_help[45];
  RNAeval_args_info_full_help[33] = RNAeval_args_info_detailed_help[46];
  RNAeval_args_info_full_help[34] = RNAeval_args_info_detailed_help[47];
  RNAeval_args_info_full_help[35] = RNAeval_args_info_detailed_help[48];
  RNAeval_args_info_full_help[36] = RNAeval_args_info_detailed_help[50];
  RNAeval_args_info_full_help[37] = RNAeval_args_info_detailed_help[52];
  RNAeval_args_info_full_help[38] = RNAeval_args_info_detailed_help[54];
  RNAeval_args_info_full_help[39] = RNAeval_args_info_detailed_help[56];
  RNAeval_args_info_full_help[40] = RNAeval_args_info_detailed_help[57];
  RNAeval_args_info_full_help[41] = RNAeval_args_info_detailed_help[58];
  RNAeval_args_info_full_help[42] = RNAeval_args_info_detailed_help[60];
  RNAeval_args_info_full_help[43] = RNAeval_args_info_detailed_help[62];
  RNAeval_args_info_full_help[44] = RNAeval_args_info_detailed_help[63];
  RNAeval_args_info_full_help[45] = RNAeval_args_info_detailed_help[65];
  RNAeval_args_info_full_help[46] = RNAeval_args_info_detailed_help[67];
  RNAeval_args_info_full_help[47] = 0; 
  
}

const char *RNAeval_args_info_full_help[48];
...
init_help_array(void)
{
  ...
  RNAeval_args_info_help[8] = RNAeval_args_info_detailed_help[9];
  RNAeval_args_info_help[9] = RNAeval_args_info_detailed_help[11];
  RNAeval_args_info_help[10] = RNAeval_args_info_detailed_help[12];
  RNAeval_args_info_help[11] = RNAeval_args_info_detailed_help[16];
  RNAeval_args_info_help[12] = RNAeval_args_info_detailed_help[17];
  RNAeval_args_info_help[13] = RNAeval_args_info_detailed_help[19];
  RNAeval_args_info_help[14] = RNAeval_args_info_detailed_help[27];
  RNAeval_args_info_help[15] = RNAeval_args_info_detailed_help[28];
  RNAeval_args_info_help[16] = RNAeval_args_info_detailed_help[29];
  RNAeval_args_info_help[17] = RNAeval_args_info_detailed_help[30];
  RNAeval_args_info_help[18] = RNAeval_args_info_detailed_help[31];
  RNAeval_args_info_help[19] = RNAeval_args_info_detailed_help[32];
  RNAeval_args_info_help[20] = RNAeval_args_info_detailed_help[33];
  RNAeval_args_info_help[21] = RNAeval_args_info_detailed_help[36];
  RNAeval_args_info_help[22] = RNAeval_args_info_detailed_help[38];
  RNAeval_args_info_help[23] = RNAeval_args_info_detailed_help[39];
  RNAeval_args_info_help[24] = RNAeval_args_info_detailed_help[40];
  RNAeval_args_info_help[25] = RNAeval_args_info_detailed_help[41];
  RNAeval_args_info_help[26] = RNAeval_args_info_detailed_help[45];
  RNAeval_args_info_help[27] = RNAeval_args_info_detailed_help[46];
  RNAeval_args_info_help[28] = RNAeval_args_info_detailed_help[47];
  RNAeval_args_info_help[29] = RNAeval_args_info_detailed_help[48];
  RNAeval_args_info_help[30] = RNAeval_args_info_detailed_help[54];
  RNAeval_args_info_help[31] = RNAeval_args_info_detailed_help[56];
  RNAeval_args_info_help[32] = RNAeval_args_info_detailed_help[57];
  RNAeval_args_info_help[33] = RNAeval_args_info_detailed_help[58];
  RNAeval_args_info_help[34] = RNAeval_args_info_detailed_help[60];
  RNAeval_args_info_help[35] = RNAeval_args_info_detailed_help[62];
  RNAeval_args_info_help[36] = RNAeval_args_info_detailed_help[67];
  RNAeval_args_info_help[37] = 0; 
  
}

const char *RNAeval_args_info_help[38];
...
void init_args_info(struct RNAeval_args_info *args_info)
{
  ...
  args_info->verbose_help = RNAeval_args_info_detailed_help[4] ;
  args_info->infile_help = RNAeval_args_info_detailed_help[7] ;
  args_info->infile_min = 0;
  args_info->infile_max = 0;
  args_info->msa_help = RNAeval_args_info_detailed_help[9] ;
  args_info->mis_help = RNAeval_args_info_detailed_help[11] ;
  args_info->jobs_help = RNAeval_args_info_detailed_help[12] ;
  args_info->unordered_help = RNAeval_args_info_detailed_help[14] ;
  args_info->noconv_help = RNAeval_args_info_detailed_help[16] ;
  args_info->auto_id_help = RNAeval_args_info_detailed_help[17] ;
  args_info->id_prefix_help = RNAeval_args_info_detailed_help[19] ;
  args_info->id_delim_help = RNAeval_args_info_detailed_help[21] ;
  args_info->id_digits_help = RNAeval_args_info_detailed_help[23] ;
  args_info->id_start_help = RNAeval_args_info_detailed_help[25] ;
  args_info->circ_help = RNAeval_args_info_detailed_help[29] ;
  args_info->gquad_help = RNAeval_args_info_detailed_help[30] ;
  args_info->shape_help = RNAeval_args_info_detailed_help[33] ;
  args_info->shapeMethod_help = RNAeval_args_info_detailed_help[34] ;
  args_info->shapeConversion_help = RNAeval_args_info_detailed_help[36] ;
  args_info->temp_help = RNAeval_args_info_detailed_help[40] ;
  args_info->paramFile_help = RNAeval_args_info_detailed_help[41] ;
  args_info->noTetra_help = RNAeval_args_info_detailed_help[43] ;
  args_info->salt_help = RNAeval_args_info_detailed_help[45] ;
  args_info->dangles_help = RNAeval_args_info_detailed_help[48] ;
  args_info->nsp_help = RNAeval_args_info_detailed_help[50] ;
  args_info->energyModel_help = RNAeval_args_info_detailed_help[52] ;
  args_info->logML_help = RNAeval_args_info_detailed_help[54] ;
  args_info->cfactor_help = RNAeval_args_info_detailed_help[56] ;
  args_info->nfactor_help = RNAeval_args_info_detailed_help[57] ;
  args_info->ribosum_file_help = RNAeval_args_info_detailed_help[58] ;
  args_info->ribosum_scoring_help = RNAeval_args_info_detailed_help[60] ;
  args_info->old_help = RNAeval_args_info_detailed_help[62] ;
  args_info->helical_rise_help = RNAeval_args_info_detailed_help[63] ;
  args_info->backbone_length_help = RNAeval_args_info_detailed_help[65] ;
...
{
	size_t len_purpose = strlen(RNAeval_args_info_purpose);
	size_t len_usage = strlen(RNAeval_args_info_usage);
...
RNAeval_cmdline_parser_required2 (struct RNAeval_args_info *args_info, const char *prog_name, const char *additional_error)
{
  ...
  if (args_info->cfactor_given && ! args_info->msa_given)
    {
      fprintf (stderr, "%s: '--cfactor' option depends on option 'msa'%s\n", prog_name, (additional_error ? additional_error : ""));
      error_occurred = 1;
    }
  if (args_info->nfactor_given && ! args_info->msa_given)
    {
      fprintf (stderr, "%s: '--nfactor' option depends on option 'msa'%s\n", prog_name, (additional_error ? additional_error : ""));
      error_occurred = 1;
    }
  if (args_info->ribosum_file_given && ! args_info->msa_given)
    {
      fprintf (stderr, "%s: '--ribosum_file' ('-R') option depends on option 'msa'%s\n", prog_name, (additional_error ? additional_error : ""));
      error_occurred = 1;
    }
  if (args_info->ribosum_scoring_given && ! args_info->msa_given)
    {
      fprintf (stderr, "%s: '--ribosum_scoring' ('-r') option depends on option 'msa'%s\n", prog_name, (additional_error ? additional_error : ""));
      error_occurred = 1;
    }
  if (args_info->old_given && ! args_info->msa_given)
    {
      fprintf (stderr, "%s: '--old' option depends on option 'msa'%s\n", prog_name, (additional_error ? additional_error : ""));
      error_occurred = 1;
    }
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "hVvi:aj::cgT:P:4d:e:R:r", long_options, &option_index);
