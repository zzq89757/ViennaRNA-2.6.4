/*
  ...
  /usr/bin/gengetopt -i RNAsnoop.ggo --file-name=RNAsnoop_cmdl --include-getopt --default-optional --func-name=RNAsnoop_cmdline_parser --arg-struct-name=RNAsnoop_args_info
...
init_help_array(void)
{
  ...
  RNAsnoop_args_info_help[6] = RNAsnoop_args_info_detailed_help[7];
  RNAsnoop_args_info_help[7] = RNAsnoop_args_info_detailed_help[9];
  RNAsnoop_args_info_help[8] = RNAsnoop_args_info_detailed_help[10];
  RNAsnoop_args_info_help[9] = RNAsnoop_args_info_detailed_help[11];
  RNAsnoop_args_info_help[10] = RNAsnoop_args_info_detailed_help[12];
  RNAsnoop_args_info_help[11] = RNAsnoop_args_info_detailed_help[13];
  RNAsnoop_args_info_help[12] = RNAsnoop_args_info_detailed_help[14];
  RNAsnoop_args_info_help[13] = RNAsnoop_args_info_detailed_help[15];
  RNAsnoop_args_info_help[14] = RNAsnoop_args_info_detailed_help[16];
  RNAsnoop_args_info_help[15] = RNAsnoop_args_info_detailed_help[18];
  RNAsnoop_args_info_help[16] = RNAsnoop_args_info_detailed_help[20];
  RNAsnoop_args_info_help[17] = RNAsnoop_args_info_detailed_help[22];
  RNAsnoop_args_info_help[18] = RNAsnoop_args_info_detailed_help[23];
  ...
  RNAsnoop_args_info_help[21] = RNAsnoop_args_info_detailed_help[27];
  ...
  RNAsnoop_args_info_help[36] = RNAsnoop_args_info_detailed_help[43];
  RNAsnoop_args_info_help[37] = RNAsnoop_args_info_detailed_help[44];
  RNAsnoop_args_info_help[38] = RNAsnoop_args_info_detailed_help[46];
  RNAsnoop_args_info_help[39] = RNAsnoop_args_info_detailed_help[47];
  RNAsnoop_args_info_help[40] = RNAsnoop_args_info_detailed_help[48];
  RNAsnoop_args_info_help[41] = RNAsnoop_args_info_detailed_help[50];
  RNAsnoop_args_info_help[42] = RNAsnoop_args_info_detailed_help[51];
  RNAsnoop_args_info_help[43] = 0; 
  
}

const char *RNAsnoop_args_info_help[44];
...
void init_args_info(struct RNAsnoop_args_info *args_info)
{
  ...
  args_info->query_help = RNAsnoop_args_info_detailed_help[5] ;
  args_info->target_help = RNAsnoop_args_info_detailed_help[7] ;
  args_info->suffix_help = RNAsnoop_args_info_detailed_help[9] ;
  args_info->from_RNAplfold_help = RNAsnoop_args_info_detailed_help[10] ;
  args_info->from_RNAup_help = RNAsnoop_args_info_detailed_help[11] ;
  args_info->output_directory_help = RNAsnoop_args_info_detailed_help[12] ;
  args_info->alignment_mode_help = RNAsnoop_args_info_detailed_help[15] ;
  args_info->fast_folding_help = RNAsnoop_args_info_detailed_help[16] ;
  args_info->extension_cost_help = RNAsnoop_args_info_detailed_help[18] ;
  args_info->energy_threshold_help = RNAsnoop_args_info_detailed_help[20] ;
  args_info->minimal_right_duplex_help = RNAsnoop_args_info_detailed_help[22] ;
  args_info->minimal_loop_energy_help = RNAsnoop_args_info_detailed_help[23] ;
  args_info->minimal_left_duplex_help = RNAsnoop_args_info_detailed_help[25] ;
  args_info->minimal_duplex_help = RNAsnoop_args_info_detailed_help[26] ;
  args_info->duplex_distance_help = RNAsnoop_args_info_detailed_help[27] ;
  args_info->minimal_stem_length_help = RNAsnoop_args_info_detailed_help[29] ;
  args_info->maximal_stem_length_help = RNAsnoop_args_info_detailed_help[30] ;
  args_info->minimal_duplex_box_length_help = RNAsnoop_args_info_detailed_help[31] ;
  args_info->maximal_duplex_box_length_help = RNAsnoop_args_info_detailed_help[32] ;
  args_info->minimal_snoRNA_stem_loop_length_help = RNAsnoop_args_info_detailed_help[33] ;
  args_info->maximal_snoRNA_stem_loop_length_help = RNAsnoop_args_info_detailed_help[34] ;
  args_info->minimal_snoRNA_duplex_length_help = RNAsnoop_args_info_detailed_help[35] ;
  args_info->maximal_snoRNA_duplex_length_help = RNAsnoop_args_info_detailed_help[36] ;
  args_info->minimal_duplex_stem_energy_help = RNAsnoop_args_info_detailed_help[37] ;
  args_info->minimal_total_energy_help = RNAsnoop_args_info_detailed_help[38] ;
  args_info->maximal_stem_asymmetry_help = RNAsnoop_args_info_detailed_help[39] ;
  args_info->minimal_lower_stem_energy_help = RNAsnoop_args_info_detailed_help[40] ;
  args_info->alignmentLength_help = RNAsnoop_args_info_detailed_help[41] ;
  args_info->constraint_help = RNAsnoop_args_info_detailed_help[44] ;
  args_info->produce_ps_help = RNAsnoop_args_info_detailed_help[48] ;
  args_info->direct_redraw_help = RNAsnoop_args_info_detailed_help[50] ;
...
{
	size_t len_purpose = strlen(RNAsnoop_args_info_purpose);
	size_t len_usage = strlen(RNAsnoop_args_info_usage);
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "Vs:t:S:P:U:O:Af:c:e:o:l:p:q:d:h:i:j:k:m:n:v:w:x:y:a:b:L:CIN", long_options, &option_index);
