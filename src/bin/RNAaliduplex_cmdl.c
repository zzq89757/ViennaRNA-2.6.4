/*
  ...
  /usr/bin/gengetopt -i RNAaliduplex.ggo --file-name=RNAaliduplex_cmdl --include-getopt --default-optional --unamed-opts --func-name=RNAaliduplex_cmdline_parser --arg-struct-name=RNAaliduplex_args_info
...
const char *RNAaliduplex_args_info_detailed_help[] = {
  ...
  "      --saltInit=DOUBLE        Provide salt correction for duplex\n                                 initialization (in kcal/mol).\n\n",
  "\nModel Details:",
...
{
  RNAaliduplex_args_info_full_help[0] = RNAaliduplex_args_info_detailed_help[0];
  RNAaliduplex_args_info_full_help[1] = RNAaliduplex_args_info_detailed_help[1];
  RNAaliduplex_args_info_full_help[2] = RNAaliduplex_args_info_detailed_help[2];
  RNAaliduplex_args_info_full_help[3] = RNAaliduplex_args_info_detailed_help[3];
  RNAaliduplex_args_info_full_help[4] = RNAaliduplex_args_info_detailed_help[4];
  RNAaliduplex_args_info_full_help[5] = RNAaliduplex_args_info_detailed_help[5];
  RNAaliduplex_args_info_full_help[6] = RNAaliduplex_args_info_detailed_help[6];
  RNAaliduplex_args_info_full_help[7] = RNAaliduplex_args_info_detailed_help[7];
  RNAaliduplex_args_info_full_help[8] = RNAaliduplex_args_info_detailed_help[8];
  RNAaliduplex_args_info_full_help[9] = RNAaliduplex_args_info_detailed_help[9];
  RNAaliduplex_args_info_full_help[10] = RNAaliduplex_args_info_detailed_help[10];
  RNAaliduplex_args_info_full_help[11] = RNAaliduplex_args_info_detailed_help[11];
  RNAaliduplex_args_info_full_help[12] = RNAaliduplex_args_info_detailed_help[13];
  RNAaliduplex_args_info_full_help[13] = RNAaliduplex_args_info_detailed_help[15];
  RNAaliduplex_args_info_full_help[14] = RNAaliduplex_args_info_detailed_help[16];
  RNAaliduplex_args_info_full_help[15] = RNAaliduplex_args_info_detailed_help[17];
  RNAaliduplex_args_info_full_help[16] = RNAaliduplex_args_info_detailed_help[18];
  RNAaliduplex_args_info_full_help[17] = RNAaliduplex_args_info_detailed_help[19];
  RNAaliduplex_args_info_full_help[18] = RNAaliduplex_args_info_detailed_help[21];
  RNAaliduplex_args_info_full_help[19] = RNAaliduplex_args_info_detailed_help[23];
  RNAaliduplex_args_info_full_help[20] = RNAaliduplex_args_info_detailed_help[24];
  RNAaliduplex_args_info_full_help[21] = RNAaliduplex_args_info_detailed_help[25];
  RNAaliduplex_args_info_full_help[22] = RNAaliduplex_args_info_detailed_help[27];
  RNAaliduplex_args_info_full_help[23] = RNAaliduplex_args_info_detailed_help[29];
  RNAaliduplex_args_info_full_help[24] = RNAaliduplex_args_info_detailed_help[31];
  RNAaliduplex_args_info_full_help[25] = 0; 
  
}

const char *RNAaliduplex_args_info_full_help[26];

static void
init_help_array(void)
{
  RNAaliduplex_args_info_help[0] = RNAaliduplex_args_info_detailed_help[0];
  RNAaliduplex_args_info_help[1] = RNAaliduplex_args_info_detailed_help[1];
  RNAaliduplex_args_info_help[2] = RNAaliduplex_args_info_detailed_help[2];
  RNAaliduplex_args_info_help[3] = RNAaliduplex_args_info_detailed_help[3];
  RNAaliduplex_args_info_help[4] = RNAaliduplex_args_info_detailed_help[4];
  RNAaliduplex_args_info_help[5] = RNAaliduplex_args_info_detailed_help[5];
  RNAaliduplex_args_info_help[6] = RNAaliduplex_args_info_detailed_help[6];
  RNAaliduplex_args_info_help[7] = RNAaliduplex_args_info_detailed_help[7];
  RNAaliduplex_args_info_help[8] = RNAaliduplex_args_info_detailed_help[8];
  RNAaliduplex_args_info_help[9] = RNAaliduplex_args_info_detailed_help[9];
  RNAaliduplex_args_info_help[10] = RNAaliduplex_args_info_detailed_help[10];
  RNAaliduplex_args_info_help[11] = RNAaliduplex_args_info_detailed_help[11];
  RNAaliduplex_args_info_help[12] = RNAaliduplex_args_info_detailed_help[15];
  RNAaliduplex_args_info_help[13] = RNAaliduplex_args_info_detailed_help[17];
  RNAaliduplex_args_info_help[14] = RNAaliduplex_args_info_detailed_help[18];
  RNAaliduplex_args_info_help[15] = RNAaliduplex_args_info_detailed_help[19];
  RNAaliduplex_args_info_help[16] = RNAaliduplex_args_info_detailed_help[21];
  RNAaliduplex_args_info_help[17] = RNAaliduplex_args_info_detailed_help[31];
  RNAaliduplex_args_info_help[18] = 0; 
  
}

const char *RNAaliduplex_args_info_help[19];
...
typedef enum {ARG_NO
  ...
  , ARG_FLOAT
  , ARG_DOUBLE
} RNAaliduplex_cmdline_parser_arg_type;

static
void clear_given (struct RNAaliduplex_args_info *args_info);
static
void clear_args (struct RNAaliduplex_args_info *args_info);

static int
RNAaliduplex_cmdline_parser_internal (int argc, char **argv, struct RNAaliduplex_args_info *args_info,
                        struct RNAaliduplex_cmdline_parser_params *params, const char *additional_error);
...
static
void init_args_info(struct RNAaliduplex_args_info *args_info)
{
  init_full_help_array(); 
  init_help_array(); 
  args_info->help_help = RNAaliduplex_args_info_detailed_help[0] ;
  args_info->detailed_help_help = RNAaliduplex_args_info_detailed_help[1] ;
  args_info->full_help_help = RNAaliduplex_args_info_detailed_help[2] ;
  args_info->version_help = RNAaliduplex_args_info_detailed_help[3] ;
  args_info->deltaEnergy_help = RNAaliduplex_args_info_detailed_help[6] ;
  args_info->sorted_help = RNAaliduplex_args_info_detailed_help[7] ;
  args_info->temp_help = RNAaliduplex_args_info_detailed_help[10] ;
  args_info->paramFile_help = RNAaliduplex_args_info_detailed_help[11] ;
  args_info->noTetra_help = RNAaliduplex_args_info_detailed_help[13] ;
  args_info->salt_help = RNAaliduplex_args_info_detailed_help[15] ;
  args_info->saltInit_help = RNAaliduplex_args_info_detailed_help[16] ;
  args_info->dangles_help = RNAaliduplex_args_info_detailed_help[19] ;
  args_info->noLP_help = RNAaliduplex_args_info_detailed_help[21] ;
  args_info->noGU_help = RNAaliduplex_args_info_detailed_help[23] ;
  args_info->noClosingGU_help = RNAaliduplex_args_info_detailed_help[24] ;
  args_info->nsp_help = RNAaliduplex_args_info_detailed_help[25] ;
  args_info->helical_rise_help = RNAaliduplex_args_info_detailed_help[27] ;
  args_info->backbone_length_help = RNAaliduplex_args_info_detailed_help[29] ;
  
}

void
RNAaliduplex_cmdline_parser_print_version (void)
{
  printf ("%s %s\n",
     (strlen(RNAALIDUPLEX_CMDLINE_PARSER_PACKAGE_NAME) ? RNAALIDUPLEX_CMDLINE_PARSER_PACKAGE_NAME : RNAALIDUPLEX_CMDLINE_PARSER_PACKAGE),
     RNAALIDUPLEX_CMDLINE_PARSER_VERSION);

  if (strlen(RNAaliduplex_args_info_versiontext) > 0)
    printf("\n%s\n", RNAaliduplex_args_info_versiontext);
}

static void print_help_common(void)
{
	size_t len_purpose = strlen(RNAaliduplex_args_info_purpose);
	size_t len_usage = strlen(RNAaliduplex_args_info_usage);
	...
	if (strlen(RNAaliduplex_args_info_description) > 0) {
		printf("%s\n\n", RNAaliduplex_args_info_description);
	}
}

void
RNAaliduplex_cmdline_parser_print_help (void)
{
  int i = 0;
  print_help_common();
  while (RNAaliduplex_args_info_help[i])
    printf("%s\n", RNAaliduplex_args_info_help[i++]);
}

void
RNAaliduplex_cmdline_parser_print_full_help (void)
{
  int i = 0;
  print_help_common();
  while (RNAaliduplex_args_info_full_help[i])
    printf("%s\n", RNAaliduplex_args_info_full_help[i++]);
}

void
RNAaliduplex_cmdline_parser_print_detailed_help (void)
{
  int i = 0;
  print_help_common();
  while (RNAaliduplex_args_info_detailed_help[i])
    printf("%s\n", RNAaliduplex_args_info_detailed_help[i++]);
}

void
RNAaliduplex_cmdline_parser_init (struct RNAaliduplex_args_info *args_info)
{
...
void
RNAaliduplex_cmdline_parser_params_init(struct RNAaliduplex_cmdline_parser_params *params)
{
  if (params)
    { 
      params->override = 0;
...
RNAaliduplex_cmdline_parser_params_create(void)
{
  struct RNAaliduplex_cmdline_parser_params *params = 
    (struct RNAaliduplex_cmdline_parser_params *)malloc(sizeof(struct RNAaliduplex_cmdline_parser_params));
  RNAaliduplex_cmdline_parser_params_init(params);  
  return params;
}
...
static void
RNAaliduplex_cmdline_parser_release (struct RNAaliduplex_args_info *args_info)
{
  unsigned int i;
  ...
  free_string_field (&(args_info->saltInit_orig));
...
int
RNAaliduplex_cmdline_parser_dump(FILE *outfile, struct RNAaliduplex_args_info *args_info)
{
  int i = 0;
  ...
  if (args_info->saltInit_given)
    write_into_file(outfile, "saltInit", args_info->saltInit_orig, 0);
...
int
RNAaliduplex_cmdline_parser_file_save(const char *filename, struct RNAaliduplex_args_info *args_info)
{
  FILE *outfile;
  int i = 0;
  ...
  i = RNAaliduplex_cmdline_parser_dump(outfile, args_info);
  fclose (outfile);
...
void
RNAaliduplex_cmdline_parser_free (struct RNAaliduplex_args_info *args_info)
{
  RNAaliduplex_cmdline_parser_release (args_info);
}
...
int
RNAaliduplex_cmdline_parser (int argc, char **argv, struct RNAaliduplex_args_info *args_info)
{
  return RNAaliduplex_cmdline_parser2 (argc, argv, args_info, 0, 1, 1);
}

int
RNAaliduplex_cmdline_parser_ext (int argc, char **argv, struct RNAaliduplex_args_info *args_info,
                   struct RNAaliduplex_cmdline_parser_params *params)
{
  int result;
  result = RNAaliduplex_cmdline_parser_internal (argc, argv, args_info, params, 0);
...
int
RNAaliduplex_cmdline_parser2 (int argc, char **argv, struct RNAaliduplex_args_info *args_info, int override, int initialize, int check_required)
{
  int result;
  struct RNAaliduplex_cmdline_parser_params params;
...
int
RNAaliduplex_cmdline_parser_required (struct RNAaliduplex_args_info *args_info, const char *prog_name)
{
  FIX_UNUSED (args_info);
 ...
 * @param check_ambiguity @see RNAaliduplex_cmdline_parser_params.check_ambiguity
 * @param override @see RNAaliduplex_cmdline_parser_params.override
...
int update_arg(void *field, char **orig_field,
               ...
               RNAaliduplex_cmdline_parser_arg_type arg_type,
...
int
RNAaliduplex_cmdline_parser_internal (
  int argc, char **argv, struct RNAaliduplex_args_info *args_info,
                        struct RNAaliduplex_cmdline_parser_params *params, const char *additional_error)
{
  int c;	/* Character of the parsed option.  */

  int error_occurred = 0;
  struct RNAaliduplex_args_info local_args_info;
  ...
  if (initialize)
    RNAaliduplex_cmdline_parser_init (args_info);

  RNAaliduplex_cmdline_parser_init (&local_args_info);
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "hVe:sT:P:4d:", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'h':	/* Print help and exit.  */
          ...
          RNAaliduplex_cmdline_parser_free (&local_args_info);
          exit (EXIT_SUCCESS);

        case 'V':	/* Print version and exit.  */
          RNAaliduplex_cmdline_parser_print_version ();
          RNAaliduplex_cmdline_parser_free (&local_args_info);
          exit (EXIT_SUCCESS);
...
.  */
          ...
          break;
        case 's':	/* Sort output by free energy.
...
.  */
        ...
        case 0:	/* Long option with no short option */
          if (strcmp (long_options[option_index].name, "detailed-help") == 0) {
            RNAaliduplex_cmdline_parser_print_detailed_help ();
            RNAaliduplex_cmdline_parser_free (&local_args_info);
            exit (EXIT_SUCCESS);
          }

          if (strcmp (long_options[option_index].name, "full-help") == 0) {
            RNAaliduplex_cmdline_parser_print_full_help ();
            RNAaliduplex_cmdline_parser_free (&local_args_info);
            exit (EXIT_SUCCESS);
          }
...
.  */
          else if (strcmp (long_options[option_index].name, "saltInit") == 0)
          {
          
          
            if (update_arg( (void *)&(args_info->saltInit_arg), 
                 &(args_info->saltInit_orig), &(args_info->saltInit_given),
                &(local_args_info.saltInit_given), optarg, 0, 0, ARG_DOUBLE,
                check_ambiguity, override, 0, 0,
                "saltInit", '-',
                additional_error))
              goto failure;
...
.  */
  ...
  RNAaliduplex_cmdline_parser_release (&local_args_info);
