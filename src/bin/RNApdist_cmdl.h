...
#ifndef RNAPDIST_CMDL_H
#define RNAPDIST_CMDL_H
...
#ifndef RNAPDIST_CMDLINE_PARSER_PACKAGE
/** @brief the program name (used for printing errors) */
#define RNAPDIST_CMDLINE_PARSER_PACKAGE "RNApdist"
#endif

#ifndef RNAPDIST_CMDLINE_PARSER_PACKAGE_NAME
/** @brief the complete program name (used for help and version) */
#define RNAPDIST_CMDLINE_PARSER_PACKAGE_NAME "RNApdist"
#endif

#ifndef RNAPDIST_CMDLINE_PARSER_VERSION
/** @brief the program version */
#define RNAPDIST_CMDLINE_PARSER_VERSION VERSION
#endif

/** @brief Where the command line options are stored */
struct RNApdist_args_info
{
 ...
 help description.  */
  char * backtrack_arg;	/**< @brief Print an \"alignment\" with gaps of the profiles. The aligned structures are written to <filename>, if specified.
 (default='none').  */
  char * backtrack_orig;	/**< @brief Print an \"alignment\" with gaps of the profiles. The aligned structures are written to <filename>, if specified.
 original value given at command line.  */
  const char *backtrack_help; /**< @brief Print an \"alignment\" with gaps of the profiles. The aligned structures are written to <filename>, if specified.
 help description.  */
...
.  */
 ...
 help description.  */
  int dangles_arg;	/**< @brief set energy model for treatment of dangling bases.
  
 (default='2').  */
  char * dangles_orig;	/**< @brief set energy model for treatment of dangling bases.
  
 original value given at command line.  */
  const char *dangles_help; /**< @brief set energy model for treatment of dangling bases.
...
struct RNApdist_cmdline_parser_params
{
  ...
  int initialize; /**< @brief whether to initialize the option structure RNApdist_args_info (default 1) */
  int check_required; /**< @brief whether to check that all required options were provided (default 1) */
  int check_ambiguity; /**< @brief whether to check for options already specified in the option structure RNApdist_args_info (default 0) */
  int print_errors; /**< @brief whether getopt_long should print an error message for a bad option (default 1) */
} ;

/** @brief the purpose string of the program */
extern const char *RNApdist_args_info_purpose;
/** @brief the usage string of the program */
extern const char *RNApdist_args_info_usage;
/** @brief the description string of the program */
extern const char *RNApdist_args_info_description;
/** @brief all the lines making the help output */
extern const char *RNApdist_args_info_help[];
/** @brief all the lines making the full help output (including hidden options) */
extern const char *RNApdist_args_info_full_help[];
/** @brief all the lines making the detailed help output (including hidden options and details) */
extern const char *RNApdist_args_info_detailed_help[];
 ...
 */
int RNApdist_cmdline_parser (int argc, char **argv,
 ...
 * @return 0 if everything went fine, NON 0 if an error took place
 * @deprecated use RNApdist_cmdline_parser_ext() instead
 */
int RNApdist_cmdline_parser2 (int argc, char **argv,
  struct RNApdist_args_info *args_info,
 ...
 * @return 0 if everything went fine, NON 0 if an error took place
 */
int RNApdist_cmdline_parser_ext (int argc, char **argv,
  struct RNApdist_args_info *args_info,
 ...
 * @return 0 if everything went fine, NON 0 if an error took place
 */
int RNApdist_cmdline_parser_dump(FILE *outfile,
  struct RNApdist_args_info *args_info);
 ...
 * @return 0 if everything went fine, NON 0 if an error took place
 */
int RNApdist_cmdline_parser_file_save(const char *filename,
  struct RNApdist_args_info *args_info);

/**
 * Print the help
 */
void RNApdist_cmdline_parser_print_help(void);
/**
 * Print the full help (including hidden options)
 */
void RNApdist_cmdline_parser_print_full_help(void);
/**
 * Print the detailed help (including hidden options and details)
 */
void RNApdist_cmdline_parser_print_detailed_help(void);
/**
 * Print the version
 */
void RNApdist_cmdline_parser_print_version(void);

/**
 * Initializes all the fields a RNApdist_cmdline_parser_params structure 
 * to their default values
 * @param params the structure to initialize
 */
void RNApdist_cmdline_parser_params_init(struct RNApdist_cmdline_parser_params *params);

/**
 * Allocates dynamically a RNApdist_cmdline_parser_params structure and initializes
 * all its fields to their default values
 * @return the created and initialized RNApdist_cmdline_parser_params structure
 */
struct RNApdist_cmdline_parser_params *RNApdist_cmdline_parser_params_create(void);

/**
 * Initializes the passed RNApdist_args_info structure's fields
 * (also set default values for options that have a default)
 * @param args_info the structure to initialize
 */
void RNApdist_cmdline_parser_init (struct RNApdist_args_info *args_info);
/**
 * Deallocates the string fields of the RNApdist_args_info structure
 * (but does not deallocate the structure itself)
 * @param args_info the structure to deallocate
 */
void RNApdist_cmdline_parser_free (struct RNApdist_args_info *args_info);
 ...
 * @return
 */
int RNApdist_cmdline_parser_required (struct RNApdist_args_info *args_info,
  const char *prog_name);

extern const char *RNApdist_cmdline_parser_dangles_values[];  /**< @brief Possible values for dangles. */


#ifdef __cplusplus
}
#endif /* __cplusplus */
#endif /* RNAPDIST_CMDL_H */
