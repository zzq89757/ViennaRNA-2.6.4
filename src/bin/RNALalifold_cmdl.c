/*
  ...
  /usr/bin/gengetopt -i RNALalifold.ggo --file-name=RNALalifold_cmdl --include-getopt --default-optional --unamed-opts --func-name=RNALalifold_cmdline_parser --arg-struct-name=RNALalifold_args_info
...
const char *RNALalifold_args_info_purpose = "calculate locally stable secondary structures for a set of aligned RNAs";

const char *RNALalifold_args_info_usage = "Usage: RNALalifold [options] <file1.aln>";

const char *RNALalifold_args_info_versiontext = "";

const char *RNALalifold_args_info_description = "reads aligned RNA sequences from stdin or file.aln and calculates locally\nstable RNA secondary structure with a maximal base pair span. For a sequence of\nlength n and a base pair span of L the algorithm uses only O(n+L*L) memory and\nO(n*L*L) CPU time. Thus it is practical to \"scan\" very large genomes for\nshort RNA\n structures.\n";

const char *RNALalifold_args_info_detailed_help[] = {
...
{
  RNALalifold_args_info_full_help[0] = RNALalifold_args_info_detailed_help[0];
  RNALalifold_args_info_full_help[1] = RNALalifold_args_info_detailed_help[1];
  RNALalifold_args_info_full_help[2] = RNALalifold_args_info_detailed_help[2];
  RNALalifold_args_info_full_help[3] = RNALalifold_args_info_detailed_help[3];
  RNALalifold_args_info_full_help[4] = RNALalifold_args_info_detailed_help[4];
  RNALalifold_args_info_full_help[5] = RNALalifold_args_info_detailed_help[5];
  RNALalifold_args_info_full_help[6] = RNALalifold_args_info_detailed_help[7];
  RNALalifold_args_info_full_help[7] = RNALalifold_args_info_detailed_help[8];
  RNALalifold_args_info_full_help[8] = RNALalifold_args_info_detailed_help[9];
  RNALalifold_args_info_full_help[9] = RNALalifold_args_info_detailed_help[11];
  RNALalifold_args_info_full_help[10] = RNALalifold_args_info_detailed_help[12];
  RNALalifold_args_info_full_help[11] = RNALalifold_args_info_detailed_help[14];
  RNALalifold_args_info_full_help[12] = RNALalifold_args_info_detailed_help[16];
  RNALalifold_args_info_full_help[13] = RNALalifold_args_info_detailed_help[17];
  RNALalifold_args_info_full_help[14] = RNALalifold_args_info_detailed_help[19];
  RNALalifold_args_info_full_help[15] = RNALalifold_args_info_detailed_help[20];
  RNALalifold_args_info_full_help[16] = RNALalifold_args_info_detailed_help[22];
  RNALalifold_args_info_full_help[17] = RNALalifold_args_info_detailed_help[24];
  RNALalifold_args_info_full_help[18] = RNALalifold_args_info_detailed_help[26];
  RNALalifold_args_info_full_help[19] = RNALalifold_args_info_detailed_help[28];
  RNALalifold_args_info_full_help[20] = RNALalifold_args_info_detailed_help[30];
  RNALalifold_args_info_full_help[21] = RNALalifold_args_info_detailed_help[32];
  RNALalifold_args_info_full_help[22] = RNALalifold_args_info_detailed_help[33];
  RNALalifold_args_info_full_help[23] = RNALalifold_args_info_detailed_help[34];
  RNALalifold_args_info_full_help[24] = RNALalifold_args_info_detailed_help[35];
  RNALalifold_args_info_full_help[25] = RNALalifold_args_info_detailed_help[36];
  RNALalifold_args_info_full_help[26] = RNALalifold_args_info_detailed_help[37];
  RNALalifold_args_info_full_help[27] = RNALalifold_args_info_detailed_help[38];
  RNALalifold_args_info_full_help[28] = RNALalifold_args_info_detailed_help[39];
  RNALalifold_args_info_full_help[29] = RNALalifold_args_info_detailed_help[41];
  RNALalifold_args_info_full_help[30] = RNALalifold_args_info_detailed_help[43];
  RNALalifold_args_info_full_help[31] = RNALalifold_args_info_detailed_help[44];
  RNALalifold_args_info_full_help[32] = RNALalifold_args_info_detailed_help[45];
  RNALalifold_args_info_full_help[33] = RNALalifold_args_info_detailed_help[46];
  RNALalifold_args_info_full_help[34] = RNALalifold_args_info_detailed_help[48];
  RNALalifold_args_info_full_help[35] = RNALalifold_args_info_detailed_help[50];
  RNALalifold_args_info_full_help[36] = RNALalifold_args_info_detailed_help[51];
  RNALalifold_args_info_full_help[37] = RNALalifold_args_info_detailed_help[52];
  RNALalifold_args_info_full_help[38] = RNALalifold_args_info_detailed_help[53];
  RNALalifold_args_info_full_help[39] = RNALalifold_args_info_detailed_help[55];
  RNALalifold_args_info_full_help[40] = RNALalifold_args_info_detailed_help[57];
  RNALalifold_args_info_full_help[41] = RNALalifold_args_info_detailed_help[58];
  RNALalifold_args_info_full_help[42] = RNALalifold_args_info_detailed_help[59];
  RNALalifold_args_info_full_help[43] = RNALalifold_args_info_detailed_help[60];
  RNALalifold_args_info_full_help[44] = RNALalifold_args_info_detailed_help[61];
  RNALalifold_args_info_full_help[45] = RNALalifold_args_info_detailed_help[63];
  RNALalifold_args_info_full_help[46] = RNALalifold_args_info_detailed_help[65];
  RNALalifold_args_info_full_help[47] = RNALalifold_args_info_detailed_help[67];
  RNALalifold_args_info_full_help[48] = RNALalifold_args_info_detailed_help[69];
  RNALalifold_args_info_full_help[49] = RNALalifold_args_info_detailed_help[71];
  RNALalifold_args_info_full_help[50] = RNALalifold_args_info_detailed_help[73];
  RNALalifold_args_info_full_help[51] = RNALalifold_args_info_detailed_help[74];
  RNALalifold_args_info_full_help[52] = RNALalifold_args_info_detailed_help[75];
  RNALalifold_args_info_full_help[53] = RNALalifold_args_info_detailed_help[77];
  RNALalifold_args_info_full_help[54] = RNALalifold_args_info_detailed_help[79];
  RNALalifold_args_info_full_help[55] = RNALalifold_args_info_detailed_help[81];
  RNALalifold_args_info_full_help[56] = 0; 
  
}

const char *RNALalifold_args_info_full_help[57];

static void
init_help_array(void)
{
  RNALalifold_args_info_help[0] = RNALalifold_args_info_detailed_help[0];
  RNALalifold_args_info_help[1] = RNALalifold_args_info_detailed_help[1];
  RNALalifold_args_info_help[2] = RNALalifold_args_info_detailed_help[2];
  RNALalifold_args_info_help[3] = RNALalifold_args_info_detailed_help[3];
  RNALalifold_args_info_help[4] = RNALalifold_args_info_detailed_help[4];
  RNALalifold_args_info_help[5] = RNALalifold_args_info_detailed_help[5];
  RNALalifold_args_info_help[6] = RNALalifold_args_info_detailed_help[7];
  RNALalifold_args_info_help[7] = RNALalifold_args_info_detailed_help[8];
  RNALalifold_args_info_help[8] = RNALalifold_args_info_detailed_help[9];
  RNALalifold_args_info_help[9] = RNALalifold_args_info_detailed_help[11];
  RNALalifold_args_info_help[10] = RNALalifold_args_info_detailed_help[12];
  RNALalifold_args_info_help[11] = RNALalifold_args_info_detailed_help[14];
  RNALalifold_args_info_help[12] = RNALalifold_args_info_detailed_help[16];
  RNALalifold_args_info_help[13] = RNALalifold_args_info_detailed_help[17];
  RNALalifold_args_info_help[14] = RNALalifold_args_info_detailed_help[19];
  RNALalifold_args_info_help[15] = RNALalifold_args_info_detailed_help[20];
  RNALalifold_args_info_help[16] = RNALalifold_args_info_detailed_help[22];
  RNALalifold_args_info_help[17] = RNALalifold_args_info_detailed_help[32];
  RNALalifold_args_info_help[18] = RNALalifold_args_info_detailed_help[33];
  RNALalifold_args_info_help[19] = RNALalifold_args_info_detailed_help[34];
  RNALalifold_args_info_help[20] = RNALalifold_args_info_detailed_help[35];
  RNALalifold_args_info_help[21] = RNALalifold_args_info_detailed_help[36];
  RNALalifold_args_info_help[22] = RNALalifold_args_info_detailed_help[37];
  RNALalifold_args_info_help[23] = RNALalifold_args_info_detailed_help[38];
  RNALalifold_args_info_help[24] = RNALalifold_args_info_detailed_help[39];
  RNALalifold_args_info_help[25] = RNALalifold_args_info_detailed_help[43];
  RNALalifold_args_info_help[26] = RNALalifold_args_info_detailed_help[44];
  RNALalifold_args_info_help[27] = RNALalifold_args_info_detailed_help[45];
  RNALalifold_args_info_help[28] = RNALalifold_args_info_detailed_help[46];
  RNALalifold_args_info_help[29] = RNALalifold_args_info_detailed_help[50];
  RNALalifold_args_info_help[30] = RNALalifold_args_info_detailed_help[51];
  RNALalifold_args_info_help[31] = RNALalifold_args_info_detailed_help[52];
  RNALalifold_args_info_help[32] = RNALalifold_args_info_detailed_help[53];
  RNALalifold_args_info_help[33] = RNALalifold_args_info_detailed_help[55];
  RNALalifold_args_info_help[34] = RNALalifold_args_info_detailed_help[59];
  RNALalifold_args_info_help[35] = RNALalifold_args_info_detailed_help[60];
  RNALalifold_args_info_help[36] = RNALalifold_args_info_detailed_help[61];
  RNALalifold_args_info_help[37] = RNALalifold_args_info_detailed_help[63];
  RNALalifold_args_info_help[38] = RNALalifold_args_info_detailed_help[73];
  RNALalifold_args_info_help[39] = RNALalifold_args_info_detailed_help[74];
  RNALalifold_args_info_help[40] = RNALalifold_args_info_detailed_help[75];
  RNALalifold_args_info_help[41] = RNALalifold_args_info_detailed_help[79];
  RNALalifold_args_info_help[42] = RNALalifold_args_info_detailed_help[81];
  RNALalifold_args_info_help[43] = 0; 
  
}

const char *RNALalifold_args_info_help[44];
...
typedef enum {ARG_NO
  ...
  , ARG_FLOAT
  , ARG_DOUBLE
} RNALalifold_cmdline_parser_arg_type;

static
void clear_given (struct RNALalifold_args_info *args_info);
static
void clear_args (struct RNALalifold_args_info *args_info);

static int
RNALalifold_cmdline_parser_internal (int argc, char **argv, struct RNALalifold_args_info *args_info,
                        struct RNALalifold_cmdline_parser_params *params, const char *additional_error);

static int
RNALalifold_cmdline_parser_required2 (struct RNALalifold_args_info *args_info, const char *prog_name, const char *additional_error);
...
void clear_given (struct RNALalifold_args_info *args_info)
{
  ...
  args_info->aln_EPS_given = 0 ;
  args_info->aln_EPS_cols_given = 0 ;
  args_info->aln_EPS_ss_given = 0 ;
}
...
void clear_args (struct RNALalifold_args_info *args_info)
{
  ...
  args_info->csv_flag = 0;
  args_info->aln_arg = NULL;
  args_info->aln_orig = NULL;
  args_info->aln_stk_arg = gengetopt_strdup ("RNALalifold_results");
  args_info->aln_stk_orig = NULL;
  args_info->mis_flag = 0;
  args_info->split_contributions_flag = 0;
  ...
  args_info->maxBPspan_arg = 70;
  args_info->maxBPspan_orig = NULL;
  args_info->threshold_arg = -0.1;
  ...
  args_info->aln_EPS_arg = NULL;
  args_info->aln_EPS_orig = NULL;
  args_info->aln_EPS_cols_arg = 60;
  args_info->aln_EPS_cols_orig = NULL;
  args_info->aln_EPS_ss_arg = NULL;
  args_info->aln_EPS_ss_orig = NULL;
  
}

static
void init_args_info(struct RNALalifold_args_info *args_info)
{
  init_full_help_array(); 
  init_help_array(); 
  args_info->help_help = RNALalifold_args_info_detailed_help[0] ;
  args_info->detailed_help_help = RNALalifold_args_info_detailed_help[1] ;
  args_info->full_help_help = RNALalifold_args_info_detailed_help[2] ;
  args_info->version_help = RNALalifold_args_info_detailed_help[3] ;
  args_info->verbose_help = RNALalifold_args_info_detailed_help[4] ;
  args_info->quiet_help = RNALalifold_args_info_detailed_help[5] ;
  args_info->input_format_help = RNALalifold_args_info_detailed_help[9] ;
  args_info->csv_help = RNALalifold_args_info_detailed_help[11] ;
  args_info->aln_help = RNALalifold_args_info_detailed_help[12] ;
  args_info->aln_stk_help = RNALalifold_args_info_detailed_help[14] ;
  args_info->mis_help = RNALalifold_args_info_detailed_help[16] ;
  args_info->split_contributions_help = RNALalifold_args_info_detailed_help[17] ;
  args_info->noconv_help = RNALalifold_args_info_detailed_help[19] ;
  args_info->auto_id_help = RNALalifold_args_info_detailed_help[20] ;
  args_info->id_prefix_help = RNALalifold_args_info_detailed_help[22] ;
  args_info->id_delim_help = RNALalifold_args_info_detailed_help[24] ;
  args_info->id_digits_help = RNALalifold_args_info_detailed_help[26] ;
  args_info->id_start_help = RNALalifold_args_info_detailed_help[28] ;
  args_info->filename_delim_help = RNALalifold_args_info_detailed_help[30] ;
  args_info->maxBPspan_help = RNALalifold_args_info_detailed_help[34] ;
  args_info->threshold_help = RNALalifold_args_info_detailed_help[35] ;
  args_info->gquad_help = RNALalifold_args_info_detailed_help[36] ;
  args_info->shape_help = RNALalifold_args_info_detailed_help[39] ;
  args_info->shape_min = 1;
  args_info->shape_max = 0;
  args_info->shapeMethod_help = RNALalifold_args_info_detailed_help[41] ;
  args_info->temp_help = RNALalifold_args_info_detailed_help[45] ;
  args_info->paramFile_help = RNALalifold_args_info_detailed_help[46] ;
  args_info->noTetra_help = RNALalifold_args_info_detailed_help[48] ;
  args_info->salt_help = RNALalifold_args_info_detailed_help[50] ;
  args_info->dangles_help = RNALalifold_args_info_detailed_help[53] ;
  args_info->noLP_help = RNALalifold_args_info_detailed_help[55] ;
  args_info->noGU_help = RNALalifold_args_info_detailed_help[57] ;
  args_info->noClosingGU_help = RNALalifold_args_info_detailed_help[58] ;
  args_info->cfactor_help = RNALalifold_args_info_detailed_help[59] ;
  args_info->nfactor_help = RNALalifold_args_info_detailed_help[60] ;
  args_info->ribosum_file_help = RNALalifold_args_info_detailed_help[61] ;
  args_info->ribosum_scoring_help = RNALalifold_args_info_detailed_help[63] ;
  args_info->nsp_help = RNALalifold_args_info_detailed_help[65] ;
  args_info->energyModel_help = RNALalifold_args_info_detailed_help[67] ;
  args_info->helical_rise_help = RNALalifold_args_info_detailed_help[69] ;
  args_info->backbone_length_help = RNALalifold_args_info_detailed_help[71] ;
  args_info->aln_EPS_help = RNALalifold_args_info_detailed_help[75] ;
  args_info->aln_EPS_cols_help = RNALalifold_args_info_detailed_help[77] ;
  args_info->aln_EPS_ss_help = RNALalifold_args_info_detailed_help[79] ;
  
}

void
RNALalifold_cmdline_parser_print_version (void)
{
  printf ("%s %s\n",
     (strlen(RNALALIFOLD_CMDLINE_PARSER_PACKAGE_NAME) ? RNALALIFOLD_CMDLINE_PARSER_PACKAGE_NAME : RNALALIFOLD_CMDLINE_PARSER_PACKAGE),
     RNALALIFOLD_CMDLINE_PARSER_VERSION);

  if (strlen(RNALalifold_args_info_versiontext) > 0)
    printf("\n%s\n", RNALalifold_args_info_versiontext);
}

static void print_help_common(void)
{
	size_t len_purpose = strlen(RNALalifold_args_info_purpose);
	size_t len_usage = strlen(RNALalifold_args_info_usage);
	...
	if (strlen(RNALalifold_args_info_description) > 0) {
		printf("%s\n\n", RNALalifold_args_info_description);
	}
}

void
RNALalifold_cmdline_parser_print_help (void)
{
  int i = 0;
  print_help_common();
  while (RNALalifold_args_info_help[i])
    printf("%s\n", RNALalifold_args_info_help[i++]);
}

void
RNALalifold_cmdline_parser_print_full_help (void)
{
  int i = 0;
  print_help_common();
  while (RNALalifold_args_info_full_help[i])
    printf("%s\n", RNALalifold_args_info_full_help[i++]);
}

void
RNALalifold_cmdline_parser_print_detailed_help (void)
{
  int i = 0;
  print_help_common();
  while (RNALalifold_args_info_detailed_help[i])
    printf("%s\n", RNALalifold_args_info_detailed_help[i++]);
}

void
RNALalifold_cmdline_parser_init (struct RNALalifold_args_info *args_info)
{
...
void
RNALalifold_cmdline_parser_params_init(struct RNALalifold_cmdline_parser_params *params)
{
  if (params)
    { 
      params->override = 0;
...
RNALalifold_cmdline_parser_params_create(void)
{
  struct RNALalifold_cmdline_parser_params *params = 
    (struct RNALalifold_cmdline_parser_params *)malloc(sizeof(struct RNALalifold_cmdline_parser_params));
  RNALalifold_cmdline_parser_params_init(params);  
  return params;
}
...
static void
RNALalifold_cmdline_parser_release (struct RNALalifold_args_info *args_info)
{
  unsigned int i;
  free_string_field (&(args_info->input_format_arg));
  free_string_field (&(args_info->input_format_orig));
  free_string_field (&(args_info->aln_arg));
  free_string_field (&(args_info->aln_orig));
  ...
  free_string_field (&(args_info->aln_EPS_arg));
  free_string_field (&(args_info->aln_EPS_orig));
  free_string_field (&(args_info->aln_EPS_cols_orig));
  free_string_field (&(args_info->aln_EPS_ss_arg));
  free_string_field (&(args_info->aln_EPS_ss_orig));
...
int
RNALalifold_cmdline_parser_dump(FILE *outfile, struct RNALalifold_args_info *args_info)
{
  int i = 0;
  ...
  if (args_info->csv_given)
    write_into_file(outfile, "csv", 0, 0 );
  if (args_info->aln_given)
    write_into_file(outfile, "aln", args_info->aln_orig, 0);
  ...
  if (args_info->split_contributions_given)
    write_into_file(outfile, "split-contributions", 0, 0 );
  ...
  if (args_info->aln_EPS_given)
    write_into_file(outfile, "aln-EPS", args_info->aln_EPS_orig, 0);
  ...
  if (args_info->aln_EPS_ss_given)
    write_into_file(outfile, "aln-EPS-ss", args_info->aln_EPS_ss_orig, 0);
...
int
RNALalifold_cmdline_parser_file_save(const char *filename, struct RNALalifold_args_info *args_info)
{
  FILE *outfile;
  int i = 0;
  ...
  i = RNALalifold_cmdline_parser_dump(outfile, args_info);
  fclose (outfile);
...
void
RNALalifold_cmdline_parser_free (struct RNALalifold_args_info *args_info)
{
  RNALalifold_cmdline_parser_release (args_info);
}
...
int
RNALalifold_cmdline_parser (int argc, char **argv, struct RNALalifold_args_info *args_info)
{
  return RNALalifold_cmdline_parser2 (argc, argv, args_info, 0, 1, 1);
}

int
RNALalifold_cmdline_parser_ext (int argc, char **argv, struct RNALalifold_args_info *args_info,
                   struct RNALalifold_cmdline_parser_params *params)
{
  int result;
  result = RNALalifold_cmdline_parser_internal (argc, argv, args_info, params, 0);
...
int
RNALalifold_cmdline_parser2 (int argc, char **argv, struct RNALalifold_args_info *args_info, int override, int initialize, int check_required)
{
  int result;
  struct RNALalifold_cmdline_parser_params params;
...
int
RNALalifold_cmdline_parser_required (struct RNALalifold_args_info *args_info, const char *prog_name)
{
  int result = EXIT_SUCCESS;

  if (RNALalifold_cmdline_parser_required2(args_info, prog_name, 0) > 0)
    result = EXIT_FAILURE;
 ...
 * @param check_ambiguity @see RNALalifold_cmdline_parser_params.check_ambiguity
 * @param override @see RNALalifold_cmdline_parser_params.override
...
int update_arg(void *field, char **orig_field,
               ...
               RNALalifold_cmdline_parser_arg_type arg_type,
...
int
RNALalifold_cmdline_parser_internal (
                        ...
                        struct RNALalifold_cmdline_parser_params *params, const char *additional_error)
{
  ...
  int error_occurred = 0;
  struct RNALalifold_args_info local_args_info;
  ...
  if (initialize)
    RNALalifold_cmdline_parser_init (args_info);

  RNALalifold_cmdline_parser_init (&local_args_info);
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "hVvqf:L:gT:P:4d:R:re:", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'h':	/* Print help and exit.  */
          ...
          RNALalifold_cmdline_parser_free (&local_args_info);
          exit (EXIT_SUCCESS);

        case 'V':	/* Print version and exit.  */
          RNALalifold_cmdline_parser_print_version ();
          RNALalifold_cmdline_parser_free (&local_args_info);
          exit (EXIT_SUCCESS);
...
.  */
          ...
          break;
        case 'L':	/* Set the maximum allowed separation of a base pair to span. I.e. no pairs (i,j) with j-i>span will be allowed.
...
.  */
          ...
          if (update_arg( (void *)&(args_info->maxBPspan_arg), 
              ...
              &(local_args_info.maxBPspan_given), optarg, 0, "70", ARG_INT,
              check_ambiguity, override, 0, 0,
              "maxBPspan", 'L',
              additional_error))
            goto failure;
...
.  */
          ...
          break;
        case 'R':	/* use specified Ribosum Matrix instead of normal energy model.
.  */
          ...
          break;
        case 'r':	/* use ribosum scoring matrix.
.  */
...
.  */
        ...
        case 0:	/* Long option with no short option */
          if (strcmp (long_options[option_index].name, "detailed-help") == 0) {
            RNALalifold_cmdline_parser_print_detailed_help ();
            RNALalifold_cmdline_parser_free (&local_args_info);
            exit (EXIT_SUCCESS);
          }

          if (strcmp (long_options[option_index].name, "full-help") == 0) {
            RNALalifold_cmdline_parser_print_full_help ();
            RNALalifold_cmdline_parser_free (&local_args_info);
            exit (EXIT_SUCCESS);
          }
...
.  */
          if (strcmp (long_options[option_index].name, "csv") == 0)
          {
          
          
            if (update_arg((void *)&(args_info->csv_flag), 0, &(args_info->csv_given),
                &(local_args_info.csv_given), optarg, 0, 0, ARG_FLAG,
                check_ambiguity, override, 1, 0, "csv", '-',
                additional_error))
              goto failure;
...
.  */
          else if (strcmp (long_options[option_index].name, "aln") == 0)
          {
            ...
            if (update_arg( (void *)&(args_info->aln_arg), 
                 &(args_info->aln_orig), &(args_info->aln_given),
                &(local_args_info.aln_given), optarg, 0, 0, ARG_STRING,
                check_ambiguity, override, 0, 0,
                "aln", '-',
                additional_error))
              goto failure;
...
.  */
          else if (strcmp (long_options[option_index].name, "aln-stk") == 0)
          {
            ...
            if (update_arg( (void *)&(args_info->aln_stk_arg), 
                ...
                &(local_args_info.aln_stk_given), optarg, 0, "RNALalifold_results", ARG_STRING,
                check_ambiguity, override, 0, 0,
                "aln-stk", '-',
                additional_error))
              goto failure;
...
.  */
          else if (strcmp (long_options[option_index].name, "split-contributions") == 0)
          {
          
          
            if (update_arg((void *)&(args_info->split_contributions_flag), 0, &(args_info->split_contributions_given),
                &(local_args_info.split_contributions_given), optarg, 0, 0, ARG_FLAG,
                check_ambiguity, override, 1, 0, "split-contributions", '-',
                additional_error))
              goto failure;
...
.  */
          else if (strcmp (long_options[option_index].name, "threshold") == 0)
          {
            ...
            if (update_arg( (void *)&(args_info->threshold_arg), 
                ...
                &(local_args_info.threshold_given), optarg, 0, "-0.1", ARG_DOUBLE,
                check_ambiguity, override, 0, 0,
                "threshold", '-',
                additional_error))
              goto failure;
...
.  */
          else if (strcmp (long_options[option_index].name, "aln-EPS") == 0)
          {
          
          
            if (update_arg( (void *)&(args_info->aln_EPS_arg), 
                 &(args_info->aln_EPS_orig), &(args_info->aln_EPS_given),
                &(local_args_info.aln_EPS_given), optarg, 0, 0, ARG_STRING,
                check_ambiguity, override, 0, 0,
                "aln-EPS", '-',
                additional_error))
              goto failure;
...
.  */
          else if (strcmp (long_options[option_index].name, "aln-EPS-ss") == 0)
          {
          
          
            if (update_arg( (void *)&(args_info->aln_EPS_ss_arg), 
                 &(args_info->aln_EPS_ss_orig), &(args_info->aln_EPS_ss_given),
                &(local_args_info.aln_EPS_ss_given), optarg, 0, 0, ARG_STRING,
                check_ambiguity, override, 0, 0,
                "aln-EPS-ss", '-',
                additional_error))
              goto failure;
  ...
  if (check_required)
    {
      error_occurred += RNALalifold_cmdline_parser_required2 (args_info, argv[0], additional_error);
    }

  RNALalifold_cmdline_parser_release (&local_args_info);
