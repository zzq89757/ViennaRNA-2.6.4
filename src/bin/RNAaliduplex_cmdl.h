...
.  */
 ...
 help description.  */
  int sorted_flag;	/**< @brief Sort output by free energy.
  
 (default=off).  */
  const char *sorted_help; /**< @brief Sort output by free energy.
...
extern const char *RNAaliduplex_args_info_full_help[];
 ...
 */
void RNAaliduplex_cmdline_parser_print_full_help(void);
/**
