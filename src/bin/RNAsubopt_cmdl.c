...
init_full_help_array(void)
{
  ...
  RNAsubopt_args_info_full_help[9] = RNAsubopt_args_info_detailed_help[11];
  ...
  RNAsubopt_args_info_full_help[20] = RNAsubopt_args_info_detailed_help[30];
  RNAsubopt_args_info_full_help[21] = RNAsubopt_args_info_detailed_help[32];
  RNAsubopt_args_info_full_help[22] = RNAsubopt_args_info_detailed_help[34];
  RNAsubopt_args_info_full_help[23] = RNAsubopt_args_info_detailed_help[36];
  RNAsubopt_args_info_full_help[24] = RNAsubopt_args_info_detailed_help[38];
  RNAsubopt_args_info_full_help[25] = RNAsubopt_args_info_detailed_help[39];
  RNAsubopt_args_info_full_help[26] = RNAsubopt_args_info_detailed_help[41];
  ...
  RNAsubopt_args_info_full_help[30] = RNAsubopt_args_info_detailed_help[47];
  RNAsubopt_args_info_full_help[31] = RNAsubopt_args_info_detailed_help[48];
  RNAsubopt_args_info_full_help[32] = RNAsubopt_args_info_detailed_help[50];
  ...
  RNAsubopt_args_info_full_help[35] = RNAsubopt_args_info_detailed_help[53];
  ...
  RNAsubopt_args_info_full_help[43] = RNAsubopt_args_info_detailed_help[66];
  RNAsubopt_args_info_full_help[44] = RNAsubopt_args_info_detailed_help[67];
  ...
  RNAsubopt_args_info_full_help[47] = RNAsubopt_args_info_detailed_help[71];
  ...
  RNAsubopt_args_info_full_help[51] = RNAsubopt_args_info_detailed_help[77];
  RNAsubopt_args_info_full_help[52] = RNAsubopt_args_info_detailed_help[78];
  RNAsubopt_args_info_full_help[53] = RNAsubopt_args_info_detailed_help[79];
  RNAsubopt_args_info_full_help[54] = RNAsubopt_args_info_detailed_help[81];
  RNAsubopt_args_info_full_help[55] = RNAsubopt_args_info_detailed_help[83];
  RNAsubopt_args_info_full_help[56] = RNAsubopt_args_info_detailed_help[84];
  ...
  RNAsubopt_args_info_full_help[59] = RNAsubopt_args_info_detailed_help[89];
  RNAsubopt_args_info_full_help[60] = RNAsubopt_args_info_detailed_help[91];
  RNAsubopt_args_info_full_help[61] = RNAsubopt_args_info_detailed_help[93];
  RNAsubopt_args_info_full_help[62] = RNAsubopt_args_info_detailed_help[95];
  RNAsubopt_args_info_full_help[63] = 0; 
  
}

const char *RNAsubopt_args_info_full_help[64];
...
init_help_array(void)
{
  ...
  RNAsubopt_args_info_help[9] = RNAsubopt_args_info_detailed_help[11];
  ...
  RNAsubopt_args_info_help[15] = RNAsubopt_args_info_detailed_help[32];
  RNAsubopt_args_info_help[16] = RNAsubopt_args_info_detailed_help[36];
  RNAsubopt_args_info_help[17] = RNAsubopt_args_info_detailed_help[41];
  RNAsubopt_args_info_help[18] = RNAsubopt_args_info_detailed_help[44];
  RNAsubopt_args_info_help[19] = RNAsubopt_args_info_detailed_help[45];
  RNAsubopt_args_info_help[20] = RNAsubopt_args_info_detailed_help[47];
  RNAsubopt_args_info_help[21] = RNAsubopt_args_info_detailed_help[48];
  RNAsubopt_args_info_help[22] = RNAsubopt_args_info_detailed_help[50];
  RNAsubopt_args_info_help[23] = RNAsubopt_args_info_detailed_help[51];
  RNAsubopt_args_info_help[24] = RNAsubopt_args_info_detailed_help[52];
  RNAsubopt_args_info_help[25] = RNAsubopt_args_info_detailed_help[53];
  RNAsubopt_args_info_help[26] = RNAsubopt_args_info_detailed_help[58];
  RNAsubopt_args_info_help[27] = RNAsubopt_args_info_detailed_help[59];
  RNAsubopt_args_info_help[28] = RNAsubopt_args_info_detailed_help[66];
  RNAsubopt_args_info_help[29] = RNAsubopt_args_info_detailed_help[67];
  RNAsubopt_args_info_help[30] = RNAsubopt_args_info_detailed_help[68];
  RNAsubopt_args_info_help[31] = RNAsubopt_args_info_detailed_help[69];
  RNAsubopt_args_info_help[32] = RNAsubopt_args_info_detailed_help[73];
  RNAsubopt_args_info_help[33] = RNAsubopt_args_info_detailed_help[74];
  RNAsubopt_args_info_help[34] = RNAsubopt_args_info_detailed_help[76];
  RNAsubopt_args_info_help[35] = RNAsubopt_args_info_detailed_help[77];
  RNAsubopt_args_info_help[36] = RNAsubopt_args_info_detailed_help[78];
  RNAsubopt_args_info_help[37] = RNAsubopt_args_info_detailed_help[79];
  RNAsubopt_args_info_help[38] = RNAsubopt_args_info_detailed_help[81];
  RNAsubopt_args_info_help[39] = RNAsubopt_args_info_detailed_help[85];
  RNAsubopt_args_info_help[40] = RNAsubopt_args_info_detailed_help[95];
  RNAsubopt_args_info_help[41] = 0; 
  
}

const char *RNAsubopt_args_info_help[42];
...
void init_args_info(struct RNAsubopt_args_info *args_info)
{
  ...
  args_info->infile_help = RNAsubopt_args_info_detailed_help[7] ;
  args_info->outfile_help = RNAsubopt_args_info_detailed_help[9] ;
  args_info->noconv_help = RNAsubopt_args_info_detailed_help[11] ;
  ...
  args_info->deltaEnergy_help = RNAsubopt_args_info_detailed_help[28] ;
  args_info->deltaEnergyPost_help = RNAsubopt_args_info_detailed_help[30] ;
  args_info->sorted_help = RNAsubopt_args_info_detailed_help[32] ;
  args_info->en_only_help = RNAsubopt_args_info_detailed_help[34] ;
  args_info->stochBT_help = RNAsubopt_args_info_detailed_help[36] ;
  args_info->stochBT_en_help = RNAsubopt_args_info_detailed_help[38] ;
  args_info->betaScale_help = RNAsubopt_args_info_detailed_help[39] ;
  args_info->nonRedundant_help = RNAsubopt_args_info_detailed_help[41] ;
  args_info->pfScale_help = RNAsubopt_args_info_detailed_help[42] ;
  args_info->circ_help = RNAsubopt_args_info_detailed_help[44] ;
  args_info->dos_help = RNAsubopt_args_info_detailed_help[45] ;
  args_info->zuker_help = RNAsubopt_args_info_detailed_help[47] ;
  args_info->gquad_help = RNAsubopt_args_info_detailed_help[48] ;
  args_info->maxBPspan_help = RNAsubopt_args_info_detailed_help[52] ;
  args_info->constraint_help = RNAsubopt_args_info_detailed_help[53] ;
  args_info->batch_help = RNAsubopt_args_info_detailed_help[55] ;
  args_info->canonicalBPonly_help = RNAsubopt_args_info_detailed_help[57] ;
  args_info->enforceConstraint_help = RNAsubopt_args_info_detailed_help[58] ;
  args_info->shape_help = RNAsubopt_args_info_detailed_help[59] ;
  args_info->shapeMethod_help = RNAsubopt_args_info_detailed_help[60] ;
  args_info->shapeConversion_help = RNAsubopt_args_info_detailed_help[62] ;
  args_info->commands_help = RNAsubopt_args_info_detailed_help[64] ;
  args_info->temp_help = RNAsubopt_args_info_detailed_help[68] ;
  args_info->paramFile_help = RNAsubopt_args_info_detailed_help[69] ;
  args_info->noTetra_help = RNAsubopt_args_info_detailed_help[71] ;
  args_info->salt_help = RNAsubopt_args_info_detailed_help[73] ;
  args_info->modifications_help = RNAsubopt_args_info_detailed_help[74] ;
  args_info->mod_file_help = RNAsubopt_args_info_detailed_help[76] ;
  args_info->mod_file_min = 0;
  args_info->mod_file_max = 0;
  args_info->dangles_help = RNAsubopt_args_info_detailed_help[79] ;
  args_info->noLP_help = RNAsubopt_args_info_detailed_help[81] ;
  args_info->noGU_help = RNAsubopt_args_info_detailed_help[83] ;
  args_info->noClosingGU_help = RNAsubopt_args_info_detailed_help[84] ;
  args_info->logML_help = RNAsubopt_args_info_detailed_help[85] ;
  args_info->nsp_help = RNAsubopt_args_info_detailed_help[87] ;
  args_info->energyModel_help = RNAsubopt_args_info_detailed_help[89] ;
  args_info->helical_rise_help = RNAsubopt_args_info_detailed_help[91] ;
  args_info->backbone_length_help = RNAsubopt_args_info_detailed_help[93] ;
