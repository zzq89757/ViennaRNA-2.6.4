...
init_full_help_array(void)
{
  ...
  RNALfold_args_info_full_help[9] = RNALfold_args_info_detailed_help[11];
  ...
  RNALfold_args_info_full_help[18] = RNALfold_args_info_detailed_help[27];
  RNALfold_args_info_full_help[19] = RNALfold_args_info_detailed_help[28];
  RNALfold_args_info_full_help[20] = RNALfold_args_info_detailed_help[30];
  ...
  RNALfold_args_info_full_help[25] = RNALfold_args_info_detailed_help[39];
  RNALfold_args_info_full_help[26] = RNALfold_args_info_detailed_help[40];
  RNALfold_args_info_full_help[27] = RNALfold_args_info_detailed_help[41];
  RNALfold_args_info_full_help[28] = RNALfold_args_info_detailed_help[42];
  RNALfold_args_info_full_help[29] = RNALfold_args_info_detailed_help[44];
  RNALfold_args_info_full_help[30] = RNALfold_args_info_detailed_help[46];
  ...
  RNALfold_args_info_full_help[34] = RNALfold_args_info_detailed_help[51];
  RNALfold_args_info_full_help[35] = RNALfold_args_info_detailed_help[53];
  ...
  RNALfold_args_info_full_help[39] = RNALfold_args_info_detailed_help[59];
  RNALfold_args_info_full_help[40] = RNALfold_args_info_detailed_help[60];
  RNALfold_args_info_full_help[41] = RNALfold_args_info_detailed_help[61];
  RNALfold_args_info_full_help[42] = RNALfold_args_info_detailed_help[63];
  RNALfold_args_info_full_help[43] = RNALfold_args_info_detailed_help[65];
  RNALfold_args_info_full_help[44] = RNALfold_args_info_detailed_help[66];
  RNALfold_args_info_full_help[45] = RNALfold_args_info_detailed_help[67];
  RNALfold_args_info_full_help[46] = RNALfold_args_info_detailed_help[69];
  RNALfold_args_info_full_help[47] = RNALfold_args_info_detailed_help[71];
  RNALfold_args_info_full_help[48] = RNALfold_args_info_detailed_help[73];
  RNALfold_args_info_full_help[49] = RNALfold_args_info_detailed_help[75];
  RNALfold_args_info_full_help[50] = 0; 
  
}

const char *RNALfold_args_info_full_help[51];
...
init_help_array(void)
{
  ...
  RNALfold_args_info_help[8] = RNALfold_args_info_detailed_help[9];
  RNALfold_args_info_help[9] = RNALfold_args_info_detailed_help[11];
  RNALfold_args_info_help[10] = RNALfold_args_info_detailed_help[12];
  RNALfold_args_info_help[11] = RNALfold_args_info_detailed_help[14];
  RNALfold_args_info_help[12] = RNALfold_args_info_detailed_help[26];
  RNALfold_args_info_help[13] = RNALfold_args_info_detailed_help[27];
  RNALfold_args_info_help[14] = RNALfold_args_info_detailed_help[28];
  RNALfold_args_info_help[15] = RNALfold_args_info_detailed_help[30];
  RNALfold_args_info_help[16] = RNALfold_args_info_detailed_help[32];
  RNALfold_args_info_help[17] = RNALfold_args_info_detailed_help[34];
  RNALfold_args_info_help[18] = RNALfold_args_info_detailed_help[36];
  RNALfold_args_info_help[19] = RNALfold_args_info_detailed_help[38];
  RNALfold_args_info_help[20] = RNALfold_args_info_detailed_help[39];
  RNALfold_args_info_help[21] = RNALfold_args_info_detailed_help[40];
  RNALfold_args_info_help[22] = RNALfold_args_info_detailed_help[41];
  RNALfold_args_info_help[23] = RNALfold_args_info_detailed_help[48];
  RNALfold_args_info_help[24] = RNALfold_args_info_detailed_help[49];
  RNALfold_args_info_help[25] = RNALfold_args_info_detailed_help[50];
  RNALfold_args_info_help[26] = RNALfold_args_info_detailed_help[51];
  RNALfold_args_info_help[27] = RNALfold_args_info_detailed_help[55];
  RNALfold_args_info_help[28] = RNALfold_args_info_detailed_help[56];
  RNALfold_args_info_help[29] = RNALfold_args_info_detailed_help[58];
  RNALfold_args_info_help[30] = RNALfold_args_info_detailed_help[59];
  RNALfold_args_info_help[31] = RNALfold_args_info_detailed_help[60];
  RNALfold_args_info_help[32] = RNALfold_args_info_detailed_help[61];
  RNALfold_args_info_help[33] = RNALfold_args_info_detailed_help[63];
  RNALfold_args_info_help[34] = RNALfold_args_info_detailed_help[75];
  RNALfold_args_info_help[35] = 0; 
  
}

const char *RNALfold_args_info_help[36];
...
void init_args_info(struct RNALfold_args_info *args_info)
{
  ...
  args_info->verbose_help = RNALfold_args_info_detailed_help[4] ;
  args_info->infile_help = RNALfold_args_info_detailed_help[7] ;
  args_info->outfile_help = RNALfold_args_info_detailed_help[9] ;
  args_info->noconv_help = RNALfold_args_info_detailed_help[11] ;
  args_info->auto_id_help = RNALfold_args_info_detailed_help[12] ;
  args_info->id_prefix_help = RNALfold_args_info_detailed_help[14] ;
  args_info->id_delim_help = RNALfold_args_info_detailed_help[16] ;
  args_info->id_digits_help = RNALfold_args_info_detailed_help[18] ;
  args_info->id_start_help = RNALfold_args_info_detailed_help[20] ;
  args_info->filename_delim_help = RNALfold_args_info_detailed_help[22] ;
  args_info->filename_full_help = RNALfold_args_info_detailed_help[24] ;
  args_info->span_help = RNALfold_args_info_detailed_help[28] ;
  args_info->zscore_help = RNALfold_args_info_detailed_help[30] ;
  args_info->zscore_pre_filter_help = RNALfold_args_info_detailed_help[32] ;
  args_info->zscore_report_subsumed_help = RNALfold_args_info_detailed_help[34] ;
  args_info->backtrack_global_help = RNALfold_args_info_detailed_help[36] ;
  args_info->gquad_help = RNALfold_args_info_detailed_help[38] ;
  ...
  args_info->commands_help = RNALfold_args_info_detailed_help[46] ;
  args_info->temp_help = RNALfold_args_info_detailed_help[50] ;
  args_info->paramFile_help = RNALfold_args_info_detailed_help[51] ;
  args_info->noTetra_help = RNALfold_args_info_detailed_help[53] ;
  args_info->salt_help = RNALfold_args_info_detailed_help[55] ;
  args_info->modifications_help = RNALfold_args_info_detailed_help[56] ;
  args_info->mod_file_help = RNALfold_args_info_detailed_help[58] ;
  args_info->mod_file_min = 0;
  args_info->mod_file_max = 0;
  args_info->dangles_help = RNALfold_args_info_detailed_help[61] ;
  args_info->noLP_help = RNALfold_args_info_detailed_help[63] ;
  args_info->noGU_help = RNALfold_args_info_detailed_help[65] ;
  args_info->noClosingGU_help = RNALfold_args_info_detailed_help[66] ;
  args_info->nsp_help = RNALfold_args_info_detailed_help[67] ;
  args_info->energyModel_help = RNALfold_args_info_detailed_help[69] ;
  args_info->helical_rise_help = RNALfold_args_info_detailed_help[71] ;
  args_info->backbone_length_help = RNALfold_args_info_detailed_help[73] ;
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "hVvi:o::L:z::bgT:P:4m::d:e:", long_options, &option_index);
