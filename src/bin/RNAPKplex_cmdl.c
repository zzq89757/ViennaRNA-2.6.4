/*
  ...
  /usr/bin/gengetopt -i RNAPKplex.ggo --file-name=RNAPKplex_cmdl --include-getopt --default-optional --func-name=PKplex_cmdline_parser --arg-struct-name=PKplex_args_info
...
const char *PKplex_args_info_purpose = "predicts RNA secondary structures including pseudoknots";

const char *PKplex_args_info_usage = "Usage: RNAPKplex [OPTION]...";

const char *PKplex_args_info_versiontext = "";

const char *PKplex_args_info_description = "Computes RNA secondary structures by first making two sequence intervals\naccessible and unpaired using the algorithm of RNAplfold and then calculating\nthe energy of the interaction of those two intervals. The algorithm uses\nO(n^2*w^4) CPU time and O(n*w^2) memory space.\nThe algorithm furthermore always considers dangle=2 model.\n";

const char *PKplex_args_info_detailed_help[] = {
...
{
  PKplex_args_info_full_help[0] = PKplex_args_info_detailed_help[0];
  PKplex_args_info_full_help[1] = PKplex_args_info_detailed_help[1];
  PKplex_args_info_full_help[2] = PKplex_args_info_detailed_help[2];
  PKplex_args_info_full_help[3] = PKplex_args_info_detailed_help[3];
  PKplex_args_info_full_help[4] = PKplex_args_info_detailed_help[4];
  PKplex_args_info_full_help[5] = PKplex_args_info_detailed_help[5];
  PKplex_args_info_full_help[6] = PKplex_args_info_detailed_help[6];
  PKplex_args_info_full_help[7] = PKplex_args_info_detailed_help[7];
  PKplex_args_info_full_help[8] = PKplex_args_info_detailed_help[8];
  PKplex_args_info_full_help[9] = PKplex_args_info_detailed_help[9];
  PKplex_args_info_full_help[10] = PKplex_args_info_detailed_help[10];
  PKplex_args_info_full_help[11] = PKplex_args_info_detailed_help[11];
  PKplex_args_info_full_help[12] = PKplex_args_info_detailed_help[12];
  PKplex_args_info_full_help[13] = PKplex_args_info_detailed_help[14];
  PKplex_args_info_full_help[14] = PKplex_args_info_detailed_help[15];
  PKplex_args_info_full_help[15] = PKplex_args_info_detailed_help[16];
  PKplex_args_info_full_help[16] = PKplex_args_info_detailed_help[17];
  PKplex_args_info_full_help[17] = PKplex_args_info_detailed_help[19];
  PKplex_args_info_full_help[18] = PKplex_args_info_detailed_help[21];
  PKplex_args_info_full_help[19] = PKplex_args_info_detailed_help[22];
  PKplex_args_info_full_help[20] = PKplex_args_info_detailed_help[23];
  PKplex_args_info_full_help[21] = PKplex_args_info_detailed_help[24];
  PKplex_args_info_full_help[22] = PKplex_args_info_detailed_help[26];
  PKplex_args_info_full_help[23] = PKplex_args_info_detailed_help[27];
  PKplex_args_info_full_help[24] = PKplex_args_info_detailed_help[28];
  PKplex_args_info_full_help[25] = PKplex_args_info_detailed_help[30];
  PKplex_args_info_full_help[26] = PKplex_args_info_detailed_help[32];
  PKplex_args_info_full_help[27] = PKplex_args_info_detailed_help[34];
  PKplex_args_info_full_help[28] = 0; 
  
}

const char *PKplex_args_info_full_help[29];

static void
init_help_array(void)
{
  PKplex_args_info_help[0] = PKplex_args_info_detailed_help[0];
  PKplex_args_info_help[1] = PKplex_args_info_detailed_help[1];
  PKplex_args_info_help[2] = PKplex_args_info_detailed_help[2];
  PKplex_args_info_help[3] = PKplex_args_info_detailed_help[3];
  PKplex_args_info_help[4] = PKplex_args_info_detailed_help[4];
  PKplex_args_info_help[5] = PKplex_args_info_detailed_help[5];
  PKplex_args_info_help[6] = PKplex_args_info_detailed_help[6];
  PKplex_args_info_help[7] = PKplex_args_info_detailed_help[7];
  PKplex_args_info_help[8] = PKplex_args_info_detailed_help[8];
  PKplex_args_info_help[9] = PKplex_args_info_detailed_help[9];
  PKplex_args_info_help[10] = PKplex_args_info_detailed_help[10];
  PKplex_args_info_help[11] = PKplex_args_info_detailed_help[11];
  PKplex_args_info_help[12] = PKplex_args_info_detailed_help[12];
  PKplex_args_info_help[13] = PKplex_args_info_detailed_help[14];
  PKplex_args_info_help[14] = PKplex_args_info_detailed_help[15];
  PKplex_args_info_help[15] = PKplex_args_info_detailed_help[16];
  PKplex_args_info_help[16] = PKplex_args_info_detailed_help[17];
  PKplex_args_info_help[17] = PKplex_args_info_detailed_help[21];
  PKplex_args_info_help[18] = PKplex_args_info_detailed_help[22];
  PKplex_args_info_help[19] = PKplex_args_info_detailed_help[23];
  PKplex_args_info_help[20] = PKplex_args_info_detailed_help[24];
  PKplex_args_info_help[21] = PKplex_args_info_detailed_help[34];
  PKplex_args_info_help[22] = 0; 
  
}

const char *PKplex_args_info_help[23];
...
typedef enum {ARG_NO
  ...
  , ARG_FLOAT
  , ARG_DOUBLE
} PKplex_cmdline_parser_arg_type;

static
void clear_given (struct PKplex_args_info *args_info);
static
void clear_args (struct PKplex_args_info *args_info);

static int
PKplex_cmdline_parser_internal (int argc, char **argv, struct PKplex_args_info *args_info,
                        struct PKplex_cmdline_parser_params *params, const char *additional_error);
...
void clear_given (struct PKplex_args_info *args_info)
{
  ...
  args_info->energyCutoff_given = 0 ;
  args_info->subopts_given = 0 ;
...
void clear_args (struct PKplex_args_info *args_info)
{
  ...
  args_info->energyCutoff_arg = -8.10;
  args_info->energyCutoff_orig = NULL;
  args_info->subopts_arg = 0.0;
  args_info->subopts_orig = NULL;
...
static
void init_args_info(struct PKplex_args_info *args_info)
{
  init_full_help_array(); 
  init_help_array(); 
  args_info->help_help = PKplex_args_info_detailed_help[0] ;
  args_info->detailed_help_help = PKplex_args_info_detailed_help[1] ;
  args_info->full_help_help = PKplex_args_info_detailed_help[2] ;
  args_info->version_help = PKplex_args_info_detailed_help[3] ;
  args_info->verbose_help = PKplex_args_info_detailed_help[4] ;
  args_info->noconv_help = PKplex_args_info_detailed_help[7] ;
  args_info->cutoff_help = PKplex_args_info_detailed_help[10] ;
  args_info->energyCutoff_help = PKplex_args_info_detailed_help[11] ;
  args_info->subopts_help = PKplex_args_info_detailed_help[12] ;
  args_info->temp_help = PKplex_args_info_detailed_help[16] ;
  args_info->paramFile_help = PKplex_args_info_detailed_help[17] ;
  args_info->noTetra_help = PKplex_args_info_detailed_help[19] ;
  args_info->salt_help = PKplex_args_info_detailed_help[21] ;
  args_info->noLP_help = PKplex_args_info_detailed_help[24] ;
  args_info->noGU_help = PKplex_args_info_detailed_help[26] ;
  args_info->noClosingGU_help = PKplex_args_info_detailed_help[27] ;
  args_info->nsp_help = PKplex_args_info_detailed_help[28] ;
  args_info->helical_rise_help = PKplex_args_info_detailed_help[30] ;
  args_info->backbone_length_help = PKplex_args_info_detailed_help[32] ;
  
}

void
PKplex_cmdline_parser_print_version (void)
{
  printf ("%s %s\n",
     (strlen(PKPLEX_CMDLINE_PARSER_PACKAGE_NAME) ? PKPLEX_CMDLINE_PARSER_PACKAGE_NAME : PKPLEX_CMDLINE_PARSER_PACKAGE),
     PKPLEX_CMDLINE_PARSER_VERSION);

  if (strlen(PKplex_args_info_versiontext) > 0)
    printf("\n%s\n", PKplex_args_info_versiontext);
}

static void print_help_common(void)
{
	size_t len_purpose = strlen(PKplex_args_info_purpose);
	size_t len_usage = strlen(PKplex_args_info_usage);
	...
	if (strlen(PKplex_args_info_description) > 0) {
		printf("%s\n\n", PKplex_args_info_description);
	}
}

void
PKplex_cmdline_parser_print_help (void)
{
  int i = 0;
  print_help_common();
  while (PKplex_args_info_help[i])
    printf("%s\n", PKplex_args_info_help[i++]);
}

void
PKplex_cmdline_parser_print_full_help (void)
{
  int i = 0;
  print_help_common();
  while (PKplex_args_info_full_help[i])
    printf("%s\n", PKplex_args_info_full_help[i++]);
}

void
PKplex_cmdline_parser_print_detailed_help (void)
{
  int i = 0;
  print_help_common();
  while (PKplex_args_info_detailed_help[i])
    printf("%s\n", PKplex_args_info_detailed_help[i++]);
}

void
PKplex_cmdline_parser_init (struct PKplex_args_info *args_info)
{
...
void
PKplex_cmdline_parser_params_init(struct PKplex_cmdline_parser_params *params)
{
  if (params)
    { 
      params->override = 0;
...
PKplex_cmdline_parser_params_create(void)
{
  struct PKplex_cmdline_parser_params *params = 
    (struct PKplex_cmdline_parser_params *)malloc(sizeof(struct PKplex_cmdline_parser_params));
  PKplex_cmdline_parser_params_init(params);  
  return params;
}
...
static void
PKplex_cmdline_parser_release (struct PKplex_args_info *args_info)
{

  free_string_field (&(args_info->cutoff_orig));
  free_string_field (&(args_info->energyCutoff_orig));
  free_string_field (&(args_info->subopts_orig));
...
int
PKplex_cmdline_parser_dump(FILE *outfile, struct PKplex_args_info *args_info)
{
  int i = 0;
  ...
  if (args_info->energyCutoff_given)
    write_into_file(outfile, "energyCutoff", args_info->energyCutoff_orig, 0);
  if (args_info->subopts_given)
    write_into_file(outfile, "subopts", args_info->subopts_orig, 0);
...
int
PKplex_cmdline_parser_file_save(const char *filename, struct PKplex_args_info *args_info)
{
  FILE *outfile;
  int i = 0;
  ...
  i = PKplex_cmdline_parser_dump(outfile, args_info);
  fclose (outfile);
...
void
PKplex_cmdline_parser_free (struct PKplex_args_info *args_info)
{
  PKplex_cmdline_parser_release (args_info);
}
...
int
PKplex_cmdline_parser (int argc, char **argv, struct PKplex_args_info *args_info)
{
  return PKplex_cmdline_parser2 (argc, argv, args_info, 0, 1, 1);
}

int
PKplex_cmdline_parser_ext (int argc, char **argv, struct PKplex_args_info *args_info,
                   struct PKplex_cmdline_parser_params *params)
{
  int result;
  result = PKplex_cmdline_parser_internal (argc, argv, args_info, params, 0);
...
int
PKplex_cmdline_parser2 (int argc, char **argv, struct PKplex_args_info *args_info, int override, int initialize, int check_required)
{
  int result;
  struct PKplex_cmdline_parser_params params;
...
int
PKplex_cmdline_parser_required (struct PKplex_args_info *args_info, const char *prog_name)
{
  FIX_UNUSED (args_info);
 ...
 * @param check_ambiguity @see PKplex_cmdline_parser_params.check_ambiguity
 * @param override @see PKplex_cmdline_parser_params.override
...
int update_arg(void *field, char **orig_field,
               ...
               PKplex_cmdline_parser_arg_type arg_type,
...
int
PKplex_cmdline_parser_internal (
  int argc, char **argv, struct PKplex_args_info *args_info,
                        struct PKplex_cmdline_parser_params *params, const char *additional_error)
{
  int c;	/* Character of the parsed option.  */

  int error_occurred = 0;
  struct PKplex_args_info local_args_info;
  ...
  if (initialize)
    PKplex_cmdline_parser_init (args_info);

  PKplex_cmdline_parser_init (&local_args_info);
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "hVvc:e:s:T:P:4", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'h':	/* Print help and exit.  */
          PKplex_cmdline_parser_print_help ();
          PKplex_cmdline_parser_free (&local_args_info);
          exit (EXIT_SUCCESS);

        case 'V':	/* Print version and exit.  */
          PKplex_cmdline_parser_print_version ();
          PKplex_cmdline_parser_free (&local_args_info);
          exit (EXIT_SUCCESS);
...
.  */
          ...
          break;
        case 'c':	/* Report only base pairs with an average probability > cutoff in the dot plot.
...
.  */
          ...
          break;
        case 'e':	/* Energy cutoff or pseudoknot initiation cost. Minimum energy gain of a pseudoknot interaction for it to be returned. Pseudoknots with smaller energy gains are rejected.
        
.  */
        
        
          if (update_arg( (void *)&(args_info->energyCutoff_arg), 
               &(args_info->energyCutoff_orig), &(args_info->energyCutoff_given),
              &(local_args_info.energyCutoff_given), optarg, 0, "-8.10", ARG_DOUBLE,
              check_ambiguity, override, 0, 0,
              "energyCutoff", 'e',
              additional_error))
            goto failure;
          ...
          break;
        case 's':	/* print suboptimal structures whose energy difference of the pseudoknot to the optimum pseudoknot is smaller than the given value.
.  */
        
        
          if (update_arg( (void *)&(args_info->subopts_arg), 
               &(args_info->subopts_orig), &(args_info->subopts_given),
              &(local_args_info.subopts_given), optarg, 0, "0.0", ARG_DOUBLE,
              check_ambiguity, override, 0, 0,
              "subopts", 's',
              additional_error))
            goto failure;
...
.  */
        ...
        case 0:	/* Long option with no short option */
          if (strcmp (long_options[option_index].name, "detailed-help") == 0) {
            PKplex_cmdline_parser_print_detailed_help ();
            PKplex_cmdline_parser_free (&local_args_info);
            exit (EXIT_SUCCESS);
          }

          if (strcmp (long_options[option_index].name, "full-help") == 0) {
            PKplex_cmdline_parser_print_full_help ();
            PKplex_cmdline_parser_free (&local_args_info);
            exit (EXIT_SUCCESS);
          }
...
.  */
  ...
  PKplex_cmdline_parser_release (&local_args_info);
