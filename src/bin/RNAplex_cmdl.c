/*
  ...
  /usr/bin/gengetopt -i RNAplex.ggo --file-name=RNAplex_cmdl --include-getopt --default-optional --func-name=RNAplex_cmdline_parser --arg-struct-name=RNAplex_args_info
...
const char *RNAplex_args_info_versiontext = "";
...
{
  RNAplex_args_info_full_help[0] = RNAplex_args_info_detailed_help[0];
  RNAplex_args_info_full_help[1] = RNAplex_args_info_detailed_help[1];
  RNAplex_args_info_full_help[2] = RNAplex_args_info_detailed_help[2];
  RNAplex_args_info_full_help[3] = RNAplex_args_info_detailed_help[3];
  RNAplex_args_info_full_help[4] = RNAplex_args_info_detailed_help[4];
  RNAplex_args_info_full_help[5] = RNAplex_args_info_detailed_help[5];
  RNAplex_args_info_full_help[6] = RNAplex_args_info_detailed_help[6];
  RNAplex_args_info_full_help[7] = RNAplex_args_info_detailed_help[8];
  RNAplex_args_info_full_help[8] = RNAplex_args_info_detailed_help[10];
  RNAplex_args_info_full_help[9] = RNAplex_args_info_detailed_help[12];
  RNAplex_args_info_full_help[10] = RNAplex_args_info_detailed_help[14];
  RNAplex_args_info_full_help[11] = RNAplex_args_info_detailed_help[15];
  RNAplex_args_info_full_help[12] = RNAplex_args_info_detailed_help[16];
  RNAplex_args_info_full_help[13] = RNAplex_args_info_detailed_help[18];
  RNAplex_args_info_full_help[14] = RNAplex_args_info_detailed_help[20];
  RNAplex_args_info_full_help[15] = RNAplex_args_info_detailed_help[22];
  RNAplex_args_info_full_help[16] = RNAplex_args_info_detailed_help[23];
  RNAplex_args_info_full_help[17] = RNAplex_args_info_detailed_help[24];
  RNAplex_args_info_full_help[18] = RNAplex_args_info_detailed_help[25];
  RNAplex_args_info_full_help[19] = RNAplex_args_info_detailed_help[26];
  RNAplex_args_info_full_help[20] = RNAplex_args_info_detailed_help[27];
  RNAplex_args_info_full_help[21] = RNAplex_args_info_detailed_help[29];
  RNAplex_args_info_full_help[22] = RNAplex_args_info_detailed_help[31];
  RNAplex_args_info_full_help[23] = RNAplex_args_info_detailed_help[33];
  RNAplex_args_info_full_help[24] = RNAplex_args_info_detailed_help[35];
  RNAplex_args_info_full_help[25] = RNAplex_args_info_detailed_help[37];
  RNAplex_args_info_full_help[26] = RNAplex_args_info_detailed_help[39];
  RNAplex_args_info_full_help[27] = RNAplex_args_info_detailed_help[41];
  RNAplex_args_info_full_help[28] = RNAplex_args_info_detailed_help[42];
  RNAplex_args_info_full_help[29] = RNAplex_args_info_detailed_help[43];
  RNAplex_args_info_full_help[30] = RNAplex_args_info_detailed_help[45];
  RNAplex_args_info_full_help[31] = RNAplex_args_info_detailed_help[46];
  RNAplex_args_info_full_help[32] = RNAplex_args_info_detailed_help[47];
  RNAplex_args_info_full_help[33] = RNAplex_args_info_detailed_help[48];
  RNAplex_args_info_full_help[34] = RNAplex_args_info_detailed_help[50];
  RNAplex_args_info_full_help[35] = RNAplex_args_info_detailed_help[52];
  RNAplex_args_info_full_help[36] = RNAplex_args_info_detailed_help[53];
  RNAplex_args_info_full_help[37] = RNAplex_args_info_detailed_help[54];
  RNAplex_args_info_full_help[38] = RNAplex_args_info_detailed_help[55];
  RNAplex_args_info_full_help[39] = RNAplex_args_info_detailed_help[56];
  RNAplex_args_info_full_help[40] = RNAplex_args_info_detailed_help[58];
  RNAplex_args_info_full_help[41] = RNAplex_args_info_detailed_help[60];
  RNAplex_args_info_full_help[42] = RNAplex_args_info_detailed_help[61];
  RNAplex_args_info_full_help[43] = RNAplex_args_info_detailed_help[62];
  RNAplex_args_info_full_help[44] = RNAplex_args_info_detailed_help[64];
  RNAplex_args_info_full_help[45] = 0; 
  
}

const char *RNAplex_args_info_full_help[46];
...
init_help_array(void)
{
  ...
  RNAplex_args_info_help[6] = RNAplex_args_info_detailed_help[6];
  RNAplex_args_info_help[7] = RNAplex_args_info_detailed_help[8];
  RNAplex_args_info_help[8] = RNAplex_args_info_detailed_help[10];
  RNAplex_args_info_help[9] = RNAplex_args_info_detailed_help[12];
  RNAplex_args_info_help[10] = RNAplex_args_info_detailed_help[14];
  RNAplex_args_info_help[11] = RNAplex_args_info_detailed_help[15];
  RNAplex_args_info_help[12] = RNAplex_args_info_detailed_help[16];
  ...
  RNAplex_args_info_help[16] = RNAplex_args_info_detailed_help[27];
  RNAplex_args_info_help[17] = RNAplex_args_info_detailed_help[29];
  RNAplex_args_info_help[18] = RNAplex_args_info_detailed_help[31];
  RNAplex_args_info_help[19] = RNAplex_args_info_detailed_help[33];
  RNAplex_args_info_help[20] = RNAplex_args_info_detailed_help[35];
  RNAplex_args_info_help[21] = RNAplex_args_info_detailed_help[37];
  RNAplex_args_info_help[22] = RNAplex_args_info_detailed_help[39];
  RNAplex_args_info_help[23] = RNAplex_args_info_detailed_help[41];
  RNAplex_args_info_help[24] = RNAplex_args_info_detailed_help[42];
  RNAplex_args_info_help[25] = RNAplex_args_info_detailed_help[43];
  RNAplex_args_info_help[26] = RNAplex_args_info_detailed_help[45];
  RNAplex_args_info_help[27] = RNAplex_args_info_detailed_help[46];
  RNAplex_args_info_help[28] = RNAplex_args_info_detailed_help[47];
  RNAplex_args_info_help[29] = RNAplex_args_info_detailed_help[48];
  RNAplex_args_info_help[30] = RNAplex_args_info_detailed_help[52];
  RNAplex_args_info_help[31] = RNAplex_args_info_detailed_help[60];
  RNAplex_args_info_help[32] = RNAplex_args_info_detailed_help[61];
  RNAplex_args_info_help[33] = RNAplex_args_info_detailed_help[62];
  RNAplex_args_info_help[34] = RNAplex_args_info_detailed_help[64];
  RNAplex_args_info_help[35] = 0; 
  
}

const char *RNAplex_args_info_help[36];
...
void init_args_info(struct RNAplex_args_info *args_info)
{
  ...
  args_info->full_help_help = RNAplex_args_info_detailed_help[2] ;
  args_info->version_help = RNAplex_args_info_detailed_help[3] ;
  args_info->query_help = RNAplex_args_info_detailed_help[6] ;
  args_info->target_help = RNAplex_args_info_detailed_help[8] ;
  args_info->accessibility_dir_help = RNAplex_args_info_detailed_help[10] ;
  args_info->binary_help = RNAplex_args_info_detailed_help[12] ;
  args_info->interaction_length_help = RNAplex_args_info_detailed_help[16] ;
  args_info->extension_cost_help = RNAplex_args_info_detailed_help[18] ;
  args_info->probe_mode_help = RNAplex_args_info_detailed_help[20] ;
  args_info->probe_concentration_help = RNAplex_args_info_detailed_help[22] ;
  args_info->na_concentration_help = RNAplex_args_info_detailed_help[23] ;
  args_info->mg_concentration_help = RNAplex_args_info_detailed_help[24] ;
  args_info->k_concentration_help = RNAplex_args_info_detailed_help[25] ;
  args_info->tris_concentration_help = RNAplex_args_info_detailed_help[26] ;
  args_info->fast_folding_help = RNAplex_args_info_detailed_help[27] ;
  args_info->scale_accessibility_help = RNAplex_args_info_detailed_help[29] ;
  args_info->alignment_mode_help = RNAplex_args_info_detailed_help[31] ;
  args_info->convert_to_bin_help = RNAplex_args_info_detailed_help[33] ;
  args_info->duplex_distance_help = RNAplex_args_info_detailed_help[35] ;
  args_info->energy_threshold_help = RNAplex_args_info_detailed_help[37] ;
  args_info->WindowLength_help = RNAplex_args_info_detailed_help[39] ;
  args_info->constraint_help = RNAplex_args_info_detailed_help[43] ;
  args_info->temp_help = RNAplex_args_info_detailed_help[47] ;
  args_info->paramFile_help = RNAplex_args_info_detailed_help[48] ;
  args_info->noTetra_help = RNAplex_args_info_detailed_help[50] ;
  args_info->salt_help = RNAplex_args_info_detailed_help[52] ;
  args_info->saltInit_help = RNAplex_args_info_detailed_help[53] ;
  args_info->helical_rise_help = RNAplex_args_info_detailed_help[56] ;
  args_info->backbone_length_help = RNAplex_args_info_detailed_help[58] ;
  args_info->produce_ps_help = RNAplex_args_info_detailed_help[62] ;
...
RNAplex_cmdline_parser_print_version (void)
{
  ...
  if (strlen(RNAplex_args_info_versiontext) > 0)
    printf("\n%s\n", RNAplex_args_info_versiontext);
}

static void print_help_common(void)
{
	size_t len_purpose = strlen(RNAplex_args_info_purpose);
	size_t len_usage = strlen(RNAplex_args_info_usage);
...
void
RNAplex_cmdline_parser_print_full_help (void)
{
  int i = 0;
  print_help_common();
  while (RNAplex_args_info_full_help[i])
    printf("%s\n", RNAplex_args_info_full_help[i++]);
}
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "hq:t:a:bl:c:pQ:N:M:K:U:f:V:Akz:e:L:CT:P:4I:", long_options, &option_index);
...
.  */
        ...
        case 0:	/* Long option with no short option */
          ...
          if (strcmp (long_options[option_index].name, "full-help") == 0) {
            RNAplex_cmdline_parser_print_full_help ();
            RNAplex_cmdline_parser_free (&local_args_info);
            exit (EXIT_SUCCESS);
          }
