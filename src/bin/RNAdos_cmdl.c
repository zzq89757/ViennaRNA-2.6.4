/*
  ...
  /usr/bin/gengetopt -i RNAdos.ggo --file-name=RNAdos_cmdl --include-getopt --default-optional --unamed-opts --func-name=RNAdos_cmdline_parser --arg-struct-name=RNAdos_args_info
...
const char *RNAdos_args_info_purpose = "Calculate the density of states for each energy band of an RNA";

const char *RNAdos_args_info_usage = "Usage: RNAdos [OPTIONS]";

const char *RNAdos_args_info_versiontext = "";

const char *RNAdos_args_info_description = "The program reads an RNA sequence and computes the density of states for each\nenergy band.\n\n";

const char *RNAdos_args_info_detailed_help[] = {
...
{
  RNAdos_args_info_full_help[0] = RNAdos_args_info_detailed_help[0];
  RNAdos_args_info_full_help[1] = RNAdos_args_info_detailed_help[1];
  RNAdos_args_info_full_help[2] = RNAdos_args_info_detailed_help[2];
  RNAdos_args_info_full_help[3] = RNAdos_args_info_detailed_help[3];
  RNAdos_args_info_full_help[4] = RNAdos_args_info_detailed_help[4];
  RNAdos_args_info_full_help[5] = RNAdos_args_info_detailed_help[5];
  RNAdos_args_info_full_help[6] = RNAdos_args_info_detailed_help[6];
  RNAdos_args_info_full_help[7] = RNAdos_args_info_detailed_help[7];
  RNAdos_args_info_full_help[8] = RNAdos_args_info_detailed_help[8];
  RNAdos_args_info_full_help[9] = RNAdos_args_info_detailed_help[9];
  RNAdos_args_info_full_help[10] = RNAdos_args_info_detailed_help[10];
  RNAdos_args_info_full_help[11] = RNAdos_args_info_detailed_help[11];
  RNAdos_args_info_full_help[12] = RNAdos_args_info_detailed_help[12];
  RNAdos_args_info_full_help[13] = RNAdos_args_info_detailed_help[13];
  RNAdos_args_info_full_help[14] = RNAdos_args_info_detailed_help[14];
  RNAdos_args_info_full_help[15] = RNAdos_args_info_detailed_help[15];
  RNAdos_args_info_full_help[16] = RNAdos_args_info_detailed_help[16];
  RNAdos_args_info_full_help[17] = RNAdos_args_info_detailed_help[18];
  RNAdos_args_info_full_help[18] = RNAdos_args_info_detailed_help[19];
  RNAdos_args_info_full_help[19] = RNAdos_args_info_detailed_help[20];
  RNAdos_args_info_full_help[20] = RNAdos_args_info_detailed_help[21];
  RNAdos_args_info_full_help[21] = RNAdos_args_info_detailed_help[23];
  RNAdos_args_info_full_help[22] = RNAdos_args_info_detailed_help[25];
  RNAdos_args_info_full_help[23] = RNAdos_args_info_detailed_help[27];
  RNAdos_args_info_full_help[24] = 0; 
  
}

const char *RNAdos_args_info_full_help[25];

static void
init_help_array(void)
{
  RNAdos_args_info_help[0] = RNAdos_args_info_detailed_help[0];
  RNAdos_args_info_help[1] = RNAdos_args_info_detailed_help[1];
  RNAdos_args_info_help[2] = RNAdos_args_info_detailed_help[2];
  RNAdos_args_info_help[3] = RNAdos_args_info_detailed_help[3];
  RNAdos_args_info_help[4] = RNAdos_args_info_detailed_help[4];
  RNAdos_args_info_help[5] = RNAdos_args_info_detailed_help[5];
  RNAdos_args_info_help[6] = RNAdos_args_info_detailed_help[6];
  RNAdos_args_info_help[7] = RNAdos_args_info_detailed_help[7];
  RNAdos_args_info_help[8] = RNAdos_args_info_detailed_help[8];
  RNAdos_args_info_help[9] = RNAdos_args_info_detailed_help[9];
  RNAdos_args_info_help[10] = RNAdos_args_info_detailed_help[10];
  RNAdos_args_info_help[11] = RNAdos_args_info_detailed_help[11];
  RNAdos_args_info_help[12] = RNAdos_args_info_detailed_help[13];
  RNAdos_args_info_help[13] = RNAdos_args_info_detailed_help[14];
  RNAdos_args_info_help[14] = RNAdos_args_info_detailed_help[15];
  RNAdos_args_info_help[15] = RNAdos_args_info_detailed_help[16];
  RNAdos_args_info_help[16] = RNAdos_args_info_detailed_help[18];
  RNAdos_args_info_help[17] = RNAdos_args_info_detailed_help[19];
  RNAdos_args_info_help[18] = RNAdos_args_info_detailed_help[20];
  RNAdos_args_info_help[19] = RNAdos_args_info_detailed_help[21];
  RNAdos_args_info_help[20] = RNAdos_args_info_detailed_help[27];
  RNAdos_args_info_help[21] = 0; 
  
}

const char *RNAdos_args_info_help[22];
...
typedef enum {ARG_NO
  ...
  , ARG_FLOAT
  , ARG_DOUBLE
} RNAdos_cmdline_parser_arg_type;

static
void clear_given (struct RNAdos_args_info *args_info);
static
void clear_args (struct RNAdos_args_info *args_info);

static int
RNAdos_cmdline_parser_internal (int argc, char **argv, struct RNAdos_args_info *args_info,
                        struct RNAdos_cmdline_parser_params *params, const char *additional_error);
...
void clear_given (struct RNAdos_args_info *args_info)
{
  ...
  args_info->max_energy_given = 0 ;
  args_info->hashtable_bits_given = 0 ;
...
void clear_args (struct RNAdos_args_info *args_info)
{
  ...
  args_info->max_energy_arg = 0;
  args_info->max_energy_orig = NULL;
  args_info->hashtable_bits_arg = 20;
  args_info->hashtable_bits_orig = NULL;
...
static
void init_args_info(struct RNAdos_args_info *args_info)
{
  init_full_help_array(); 
  init_help_array(); 
  args_info->help_help = RNAdos_args_info_detailed_help[0] ;
  args_info->detailed_help_help = RNAdos_args_info_detailed_help[1] ;
  args_info->full_help_help = RNAdos_args_info_detailed_help[2] ;
  args_info->version_help = RNAdos_args_info_detailed_help[3] ;
  args_info->verbose_help = RNAdos_args_info_detailed_help[4] ;
  args_info->sequence_help = RNAdos_args_info_detailed_help[7] ;
  args_info->numThreads_help = RNAdos_args_info_detailed_help[8] ;
  args_info->max_energy_help = RNAdos_args_info_detailed_help[11] ;
  args_info->hashtable_bits_help = RNAdos_args_info_detailed_help[12] ;
  args_info->temp_help = RNAdos_args_info_detailed_help[15] ;
  args_info->paramFile_help = RNAdos_args_info_detailed_help[16] ;
  args_info->salt_help = RNAdos_args_info_detailed_help[18] ;
  args_info->dangles_help = RNAdos_args_info_detailed_help[21] ;
  args_info->helical_rise_help = RNAdos_args_info_detailed_help[23] ;
  args_info->backbone_length_help = RNAdos_args_info_detailed_help[25] ;
  
}

void
RNAdos_cmdline_parser_print_version (void)
{
  printf ("%s %s\n",
     (strlen(RNADOS_CMDLINE_PARSER_PACKAGE_NAME) ? RNADOS_CMDLINE_PARSER_PACKAGE_NAME : RNADOS_CMDLINE_PARSER_PACKAGE),
     RNADOS_CMDLINE_PARSER_VERSION);

  if (strlen(RNAdos_args_info_versiontext) > 0)
    printf("\n%s\n", RNAdos_args_info_versiontext);
}

static void print_help_common(void)
{
	size_t len_purpose = strlen(RNAdos_args_info_purpose);
	size_t len_usage = strlen(RNAdos_args_info_usage);

	if (len_usage > 0) {
		printf("%s\n", RNAdos_args_info_usage);
	}
	if (len_purpose > 0) {
		printf("%s\n", RNAdos_args_info_purpose);
	}
	...
	if (strlen(RNAdos_args_info_description) > 0) {
		printf("%s\n\n", RNAdos_args_info_description);
	}
}

void
RNAdos_cmdline_parser_print_help (void)
{
  int i = 0;
  print_help_common();
  while (RNAdos_args_info_help[i])
    printf("%s\n", RNAdos_args_info_help[i++]);
}

void
RNAdos_cmdline_parser_print_full_help (void)
{
  int i = 0;
  print_help_common();
  while (RNAdos_args_info_full_help[i])
    printf("%s\n", RNAdos_args_info_full_help[i++]);
}

void
RNAdos_cmdline_parser_print_detailed_help (void)
{
  int i = 0;
  print_help_common();
  while (RNAdos_args_info_detailed_help[i])
    printf("%s\n", RNAdos_args_info_detailed_help[i++]);
}

void
RNAdos_cmdline_parser_init (struct RNAdos_args_info *args_info)
{
...
void
RNAdos_cmdline_parser_params_init(struct RNAdos_cmdline_parser_params *params)
{
  if (params)
    { 
      params->override = 0;
...
RNAdos_cmdline_parser_params_create(void)
{
  struct RNAdos_cmdline_parser_params *params = 
    (struct RNAdos_cmdline_parser_params *)malloc(sizeof(struct RNAdos_cmdline_parser_params));
  RNAdos_cmdline_parser_params_init(params);  
  return params;
}
...
static void
RNAdos_cmdline_parser_release (struct RNAdos_args_info *args_info)
{
  unsigned int i;
  ...
  free_string_field (&(args_info->max_energy_orig));
  free_string_field (&(args_info->hashtable_bits_orig));
...
int
RNAdos_cmdline_parser_dump(FILE *outfile, struct RNAdos_args_info *args_info)
{
  int i = 0;

  if (!outfile)
    {
      fprintf (stderr, "%s: cannot dump options to stream\n", RNADOS_CMDLINE_PARSER_PACKAGE);
      return EXIT_FAILURE;
    }
  ...
  if (args_info->max_energy_given)
    write_into_file(outfile, "max-energy", args_info->max_energy_orig, 0);
  if (args_info->hashtable_bits_given)
    write_into_file(outfile, "hashtable-bits", args_info->hashtable_bits_orig, 0);
...
int
RNAdos_cmdline_parser_file_save(const char *filename, struct RNAdos_args_info *args_info)
{
  FILE *outfile;
  int i = 0;
  ...
  if (!outfile)
    {
      fprintf (stderr, "%s: cannot open file for writing: %s\n", RNADOS_CMDLINE_PARSER_PACKAGE, filename);
      return EXIT_FAILURE;
    }

  i = RNAdos_cmdline_parser_dump(outfile, args_info);
  fclose (outfile);
...
void
RNAdos_cmdline_parser_free (struct RNAdos_args_info *args_info)
{
  RNAdos_cmdline_parser_release (args_info);
}
...
int
RNAdos_cmdline_parser (int argc, char **argv, struct RNAdos_args_info *args_info)
{
  return RNAdos_cmdline_parser2 (argc, argv, args_info, 0, 1, 1);
}

int
RNAdos_cmdline_parser_ext (int argc, char **argv, struct RNAdos_args_info *args_info,
                   struct RNAdos_cmdline_parser_params *params)
{
  int result;
  result = RNAdos_cmdline_parser_internal (argc, argv, args_info, params, 0);
...
int
RNAdos_cmdline_parser2 (int argc, char **argv, struct RNAdos_args_info *args_info, int override, int initialize, int check_required)
{
  int result;
  struct RNAdos_cmdline_parser_params params;
...
int
RNAdos_cmdline_parser_required (struct RNAdos_args_info *args_info, const char *prog_name)
{
  FIX_UNUSED (args_info);
 ...
 * @param check_ambiguity @see RNAdos_cmdline_parser_params.check_ambiguity
 * @param override @see RNAdos_cmdline_parser_params.override
...
int update_arg(void *field, char **orig_field,
               ...
               RNAdos_cmdline_parser_arg_type arg_type,
...
int
RNAdos_cmdline_parser_internal (
  int argc, char **argv, struct RNAdos_args_info *args_info,
                        struct RNAdos_cmdline_parser_params *params, const char *additional_error)
{
  int c;	/* Character of the parsed option.  */

  int error_occurred = 0;
  struct RNAdos_args_info local_args_info;
  ...
  if (initialize)
    RNAdos_cmdline_parser_init (args_info);

  RNAdos_cmdline_parser_init (&local_args_info);
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "hVvs:j:e:b:T:P:d:", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'h':	/* Print help and exit.  */
          RNAdos_cmdline_parser_print_help ();
          RNAdos_cmdline_parser_free (&local_args_info);
          exit (EXIT_SUCCESS);

        case 'V':	/* Print version and exit.  */
          RNAdos_cmdline_parser_print_version ();
          RNAdos_cmdline_parser_free (&local_args_info);
          exit (EXIT_SUCCESS);
...
.  */
          ...
          break;
        case 'e':	/* Structures are only counted until this threshold is reached. Default is 0 kcal/mol.
.  */
        
        
          if (update_arg( (void *)&(args_info->max_energy_arg), 
               &(args_info->max_energy_orig), &(args_info->max_energy_given),
              &(local_args_info.max_energy_given), optarg, 0, "0", ARG_INT,
              check_ambiguity, override, 0, 0,
              "max-energy", 'e',
              additional_error))
            goto failure;
          ...
          break;
        case 'b':	/* Set the size of the hash table for each cell in the dp-matrices.
        
.  */
        
        
          if (update_arg( (void *)&(args_info->hashtable_bits_arg), 
               &(args_info->hashtable_bits_orig), &(args_info->hashtable_bits_given),
              &(local_args_info.hashtable_bits_given), optarg, 0, "20", ARG_INT,
              check_ambiguity, override, 0, 0,
              "hashtable-bits", 'b',
              additional_error))
            goto failure;
...
.  */
        ...
        case 0:	/* Long option with no short option */
          if (strcmp (long_options[option_index].name, "detailed-help") == 0) {
            RNAdos_cmdline_parser_print_detailed_help ();
            RNAdos_cmdline_parser_free (&local_args_info);
            exit (EXIT_SUCCESS);
          }

          if (strcmp (long_options[option_index].name, "full-help") == 0) {
            RNAdos_cmdline_parser_print_full_help ();
            RNAdos_cmdline_parser_free (&local_args_info);
            exit (EXIT_SUCCESS);
          }
...
.  */
        ...
        default:	/* bug: option not considered.  */
          fprintf (stderr, "%s: option unknown: %c%s\n", RNADOS_CMDLINE_PARSER_PACKAGE, c, (additional_error ? additional_error : ""));
          abort ();
        } /* switch */
    } /* while */
  ...
  RNAdos_cmdline_parser_release (&local_args_info);
