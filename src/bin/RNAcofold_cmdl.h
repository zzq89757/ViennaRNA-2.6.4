...
.  */
  char * concfile_orig;	/**< @brief Specify a file with initial concentrations for the two sequences.
 original value given at command line.  */
  const char *concfile_help; /**< @brief Specify a file with initial concentrations for the two sequences.
 help description.  */
